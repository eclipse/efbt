...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.CombinationModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CombinationModuleItemProvider extends ModuleItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(openregspecs_smcubes_extra_extensionPackage.Literals.COMBINATION_MODULE__COMBINATIONS);
			childrenFeatures.add(openregspecs_smcubes_extra_extensionPackage.Literals.COMBINATION_MODULE__COMBINATION_ITEMS);
			childrenFeatures.add(openregspecs_smcubes_extra_extensionPackage.Literals.COMBINATION_MODULE__CUBE_TO_COMBINATION_LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(openregspecs_smcubes_extra_extensionPackage.Literals.COMBINATION_MODULE__COMBINATIONS,
				 Data_definitionFactory.eINSTANCE.createCOMBINATION()));

		newChildDescriptors.add
			(createChildParameter
				(openregspecs_smcubes_extra_extensionPackage.Literals.COMBINATION_MODULE__COMBINATION_ITEMS,
				 Data_definitionFactory.eINSTANCE.createCOMBINATION_ITEM()));

		newChildDescriptors.add
			(createChildParameter
				(openregspecs_smcubes_extra_extensionPackage.Literals.COMBINATION_MODULE__CUBE_TO_COMBINATION_LINKS,
