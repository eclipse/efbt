...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.openregspecs.model.requirements_text.Tag} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_displayName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_displayName_feature", "_UI_Tag_type"),
				 Requirements_textPackage.Literals.TAG__DISPLAY_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Requirements_textPackage.Literals.TAG__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRequirementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_requirements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_requirements_feature", "_UI_Tag_type"),
				 Requirements_textPackage.Literals.TAG__REQUIREMENTS,
				 true,
				 false,
				 true,
				 null,
