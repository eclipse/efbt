...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.CubeModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CubeModuleItemProvider extends ModuleItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(openregspecs_smcubes_extra_extensionPackage.Literals.CUBE_MODULE__CUBES);
			childrenFeatures.add(openregspecs_smcubes_extra_extensionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURES);
			childrenFeatures.add(openregspecs_smcubes_extra_extensionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURE_ITEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(openregspecs_smcubes_extra_extensionPackage.Literals.CUBE_MODULE__CUBES,
				 Data_definitionFactory.eINSTANCE.createCUBE()));

		newChildDescriptors.add
			(createChildParameter
				(openregspecs_smcubes_extra_extensionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURES,
				 Data_definitionFactory.eINSTANCE.createCUBE_STRUCTURE()));

		newChildDescriptors.add
			(createChildParameter
				(openregspecs_smcubes_extra_extensionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURE_ITEMS,
