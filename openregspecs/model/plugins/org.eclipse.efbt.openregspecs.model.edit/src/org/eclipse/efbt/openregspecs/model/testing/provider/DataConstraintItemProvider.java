...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.openregspecs.model.testing.DataConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestingPackage.Literals.DATA_CONSTRAINT__ATTR1,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestingPackage.Literals.DATA_CONSTRAINT__ATTR2,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestingPackage.Literals.DATA_CONSTRAINT__COMPARISON,
				 true,
				 false,
				 false,
