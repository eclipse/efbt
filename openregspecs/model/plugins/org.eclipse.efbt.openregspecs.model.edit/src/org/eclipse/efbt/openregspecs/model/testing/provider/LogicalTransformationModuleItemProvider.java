...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.openregspecs.model.testing.LogicalTransformationModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogicalTransformationModuleItemProvider extends ModuleItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__TEST_MODULES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__TASK_TAGS);
			childrenFeatures.add(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__SCENARIO_TAGS);
			childrenFeatures.add(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__SUB_PROCESS);
			childrenFeatures.add(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__REQUIREMENTS);
			childrenFeatures.add(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__SELECTION_LAYERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__TASK_TAGS,
				 TestingFactory.eINSTANCE.createActivityTag()));

		newChildDescriptors.add
			(createChildParameter
				(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__SCENARIO_TAGS,
				 TestingFactory.eINSTANCE.createScenarioTag()));

		newChildDescriptors.add
			(createChildParameter
				(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__SUB_PROCESS,
				 Bpmn_liteFactory.eINSTANCE.createSubProcess()));

		newChildDescriptors.add
			(createChildParameter
				(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__REQUIREMENTS,
				 Requirements_textFactory.eINSTANCE.createRequirementsModule()));

		newChildDescriptors.add
			(createChildParameter
				(TestingPackage.Literals.LOGICAL_TRANSFORMATION_MODULE__SELECTION_LAYERS,
				 TestingFactory.eINSTANCE.createSelectionLayer()));
	}
