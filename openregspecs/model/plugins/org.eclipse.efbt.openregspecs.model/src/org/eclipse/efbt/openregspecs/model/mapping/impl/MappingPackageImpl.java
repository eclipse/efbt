...
public class MappingPackageImpl extends EPackageImpl implements MappingPackage {
	 ...
	 * @see org.eclipse.efbt.openregspecs.model.mapping.MappingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(cubE_MAPPINGEClass, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, "CUBE_MAPPING", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCUBE_MAPPING_Cube_mapping_id(), ecorePackage.getEString(), "cube_mapping_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCUBE_MAPPING_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCUBE_MAPPING_Source_cube(), theData_definitionPackage.getCUBE(), null, "source_cube", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCUBE_MAPPING_Target_cube(), theData_definitionPackage.getCUBE(), null, "target_cube", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCUBE_MAPPING_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCUBE_MAPPING_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCUBE_MAPPING_Maintenance_agency_id(), ecorePackage.getEString(), "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCUBE_MAPPING_MappingsToCube(), this.getMAPPING_TO_CUBE(), null, "mappingsToCube", null, 0, -1, org.eclipse.efbt.openregspecs.model.mapping.CUBE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(membeR_MAPPINGEClass, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING.class, "MEMBER_MAPPING", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMEMBER_MAPPING_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_MAPPING_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_MAPPING_Maintenance_agency_id(), ecorePackage.getEString(), "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_MAPPING_Member_mapping_id(), ecorePackage.getEString(), "member_mapping_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_MAPPING_MemberMappingItems(), this.getMEMBER_MAPPING_ITEM(), null, "memberMappingItems", null, 0, -1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(membeR_MAPPING_ITEMEClass, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING_ITEM.class, "MEMBER_MAPPING_ITEM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMEMBER_MAPPING_ITEM_IsSource(), ecorePackage.getEString(), "isSource", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_MAPPING_ITEM_Member(), theCorePackage.getMEMBER(), null, "member", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_MAPPING_ITEM_Variable(), theCorePackage.getVARIABLE(), null, "variable", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MEMBER_MAPPING_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variablE_MAPPING_ITEMEClass, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING_ITEM.class, "VARIABLE_MAPPING_ITEM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVARIABLE_MAPPING_ITEM_IsSource(), ecorePackage.getEString(), "isSource", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_MAPPING_ITEM_Variable(), theCorePackage.getVARIABLE(), null, "variable", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variablE_MAPPINGEClass, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING.class, "VARIABLE_MAPPING", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVARIABLE_MAPPING_VaraibleMappingItems(), this.getVARIABLE_MAPPING_ITEM(), null, "varaibleMappingItems", null, 0, -1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_MAPPING_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_MAPPING_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_MAPPING_Maintenance_agency_id(), ecorePackage.getEString(), "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_MAPPING_Variable_mapping_id(), ecorePackage.getEString(), "variable_mapping_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(mappinG_TO_CUBEEClass, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_TO_CUBE.class, "MAPPING_TO_CUBE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMAPPING_TO_CUBE_Mapping(), this.getMAPPING_DEFINITION(), null, "mapping", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_TO_CUBE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variablE_SET_MAPPINGEClass, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_SET_MAPPING.class, "VARIABLE_SET_MAPPING", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVARIABLE_SET_MAPPING_SourceMapping(), this.getMAPPING_DEFINITION(), null, "sourceMapping", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_SET_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_SET_MAPPING_TargetMapping(), this.getMAPPING_DEFINITION(), null, "targetMapping", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.VARIABLE_SET_MAPPING.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(mappinG_DEFINITIONEClass, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, "MAPPING_DEFINITION", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMAPPING_DEFINITION_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMAPPING_DEFINITION_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMAPPING_DEFINITION_Maintenance_agency_id(), ecorePackage.getEString(), "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMAPPING_DEFINITION_Mapping_id(), ecorePackage.getEString(), "mapping_id", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMAPPING_DEFINITION_Mapping_type(), ecorePackage.getEString(), "mapping_type", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMAPPING_DEFINITION_MemberMapping(), this.getMEMBER_MAPPING(), null, "memberMapping", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMAPPING_DEFINITION_VariableMapping(), this.getVARIABLE_MAPPING(), null, "variableMapping", null, 0, 1, org.eclipse.efbt.openregspecs.model.mapping.MAPPING_DEFINITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
