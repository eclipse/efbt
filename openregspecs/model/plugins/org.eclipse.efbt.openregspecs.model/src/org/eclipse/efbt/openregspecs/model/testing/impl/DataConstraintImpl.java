 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.testing.impl.DataConstraintImpl#getAttr1 <em>Attr1</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.testing.impl.DataConstraintImpl#getAttr2 <em>Attr2</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.testing.impl.DataConstraintImpl#getComparison <em>Comparison</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataConstraintImpl extends MinimalEObjectImpl.Container implements DataConstraint {
	...
	protected EClass eStaticClass() {
		return TestingPackage.Literals.DATA_CONSTRAINT;
	}
		...
		if (attr1 != null && attr1.eIsProxy()) {
			...
			if (attr1 != oldAttr1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestingPackage.DATA_CONSTRAINT__ATTR1, oldAttr1, attr1));
			}
		}
		return attr1;
	}
	...
	public void setAttr1(Attribute newAttr1) {
		...
		attr1 = newAttr1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.DATA_CONSTRAINT__ATTR1, oldAttr1, attr1));
	}
	...
	public Attribute getAttr2() {
		if (attr2 != null && attr2.eIsProxy()) {
			...
			if (attr2 != oldAttr2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestingPackage.DATA_CONSTRAINT__ATTR2, oldAttr2, attr2));
			}
		}
		return attr2;
	}
	...
	public void setAttr2(Attribute newAttr2) {
		...
		attr2 = newAttr2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.DATA_CONSTRAINT__ATTR2, oldAttr2, attr2));
	}
	...
	public void setComparison(AttrComparison newComparison) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.DATA_CONSTRAINT__COMPARISON, oldComparison, comparison));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestingPackage.DATA_CONSTRAINT__ATTR1:
				if (resolve) return getAttr1();
				return basicGetAttr1();
			case TestingPackage.DATA_CONSTRAINT__ATTR2:
				if (resolve) return getAttr2();
				return basicGetAttr2();
			case TestingPackage.DATA_CONSTRAINT__COMPARISON:
