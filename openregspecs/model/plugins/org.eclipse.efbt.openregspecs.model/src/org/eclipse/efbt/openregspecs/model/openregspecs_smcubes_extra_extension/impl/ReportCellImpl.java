 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.ReportCellImpl#getCombination <em>Combination</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.ReportCellImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportCellImpl extends MinimalEObjectImpl.Container implements ReportCell {
	...
	protected EClass eStaticClass() {
		return openregspecs_smcubes_extra_extensionPackage.Literals.REPORT_CELL;
	}
		...
		if (combination != null && combination.eIsProxy()) {
			...
			if (combination != oldCombination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, openregspecs_smcubes_extra_extensionPackage.REPORT_CELL__COMBINATION, oldCombination, combination));
			}
		}
		return combination;
	}
	...
	public void setCombination(COMBINATION newCombination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, openregspecs_smcubes_extra_extensionPackage.REPORT_CELL__COMBINATION, oldCombination, combination));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, openregspecs_smcubes_extra_extensionPackage.REPORT_CELL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case openregspecs_smcubes_extra_extensionPackage.REPORT_CELL__COMBINATION:
