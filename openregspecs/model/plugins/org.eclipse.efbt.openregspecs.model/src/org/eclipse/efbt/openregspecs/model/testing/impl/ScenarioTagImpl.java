 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.testing.impl.ScenarioTagImpl#getScenario <em>Scenario</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScenarioTagImpl extends TagImpl implements ScenarioTag {
	...
	protected EClass eStaticClass() {
		return TestingPackage.Literals.SCENARIO_TAG;
	}
		...
		if (scenario != null && scenario.eIsProxy()) {
			...
			if (scenario != oldScenario) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestingPackage.SCENARIO_TAG__SCENARIO, oldScenario, scenario));
			}
		}
		return scenario;
	}
	...
	public void setScenario(Scenario newScenario) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.SCENARIO_TAG__SCENARIO, oldScenario, scenario));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestingPackage.SCENARIO_TAG__SCENARIO:
