 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.MemberMappingModuleImpl#getMemberMappings <em>Member Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberMappingModuleImpl extends ModuleImpl implements MemberMappingModule {
	...
	protected EClass eStaticClass() {
		return openregspecs_smcubes_extra_extensionPackage.Literals.MEMBER_MAPPING_MODULE;
	}
	...
	public EList<MEMBER_MAPPING> getMemberMappings() {
		if (memberMappings == null) {
			memberMappings = new EObjectContainmentEList<MEMBER_MAPPING>(MEMBER_MAPPING.class, this, openregspecs_smcubes_extra_extensionPackage.MEMBER_MAPPING_MODULE__MEMBER_MAPPINGS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case openregspecs_smcubes_extra_extensionPackage.MEMBER_MAPPING_MODULE__MEMBER_MAPPINGS:
