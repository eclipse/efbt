 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.ReportCellValueImpl#getReportCell <em>Report Cell</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.ReportCellValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportCellValueImpl extends MinimalEObjectImpl.Container implements ReportCellValue {
	...
	protected EClass eStaticClass() {
		return openregspecs_smcubes_extra_extensionPackage.Literals.REPORT_CELL_VALUE;
	}
		...
		if (reportCell != null && reportCell.eIsProxy()) {
			...
			if (reportCell != oldReportCell) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, openregspecs_smcubes_extra_extensionPackage.REPORT_CELL_VALUE__REPORT_CELL, oldReportCell, reportCell));
			}
		}
		return reportCell;
	}
	...
	public void setReportCell(ReportCell newReportCell) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, openregspecs_smcubes_extra_extensionPackage.REPORT_CELL_VALUE__REPORT_CELL, oldReportCell, reportCell));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, openregspecs_smcubes_extra_extensionPackage.REPORT_CELL_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case openregspecs_smcubes_extra_extensionPackage.REPORT_CELL_VALUE__REPORT_CELL:
