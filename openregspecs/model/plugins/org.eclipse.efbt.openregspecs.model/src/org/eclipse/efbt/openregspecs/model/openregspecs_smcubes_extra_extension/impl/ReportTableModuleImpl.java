 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.ReportTableModuleImpl#getReportTables <em>Report Tables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportTableModuleImpl extends ModuleImpl implements ReportTableModule {
	...
	protected EClass eStaticClass() {
		return openregspecs_smcubes_extra_extensionPackage.Literals.REPORT_TABLE_MODULE;
	}
	...
	public EList<TABLE> getReportTables() {
		if (reportTables == null) {
			reportTables = new EObjectContainmentEList<TABLE>(TABLE.class, this, openregspecs_smcubes_extra_extensionPackage.REPORT_TABLE_MODULE__REPORT_TABLES);
		}
		return reportTables;
	}
