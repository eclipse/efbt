 ...
 * @generated
 */
public class openregspecs_smcubes_extra_extensionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public openregspecs_smcubes_extra_extensionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case openregspecs_smcubes_extra_extensionPackage.SMCUBES_EXTRA_MODEL: {
				SmcubesExtraModel smcubesExtraModel = (SmcubesExtraModel)theEObject;
				T result = caseSmcubesExtraModel(smcubesExtraModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case openregspecs_smcubes_extra_extensionPackage.COMBINATION_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.CUBE_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.MAPPING_DEFINITION_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.CUBE_MAPPING_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.MEMBER_MAPPING_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.VARIABLE_MAPPING_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.AXIS_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.AXIS_ORDINATE_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.CELL_POSITION_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.ORDINATE_ITEM_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.REPORT_CELL: {
				ReportCell reportCell = (ReportCell)theEObject;
				T result = caseReportCell(reportCell);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case openregspecs_smcubes_extra_extensionPackage.REPORT_CELL_VALUE: {
				ReportCellValue reportCellValue = (ReportCellValue)theEObject;
				T result = caseReportCellValue(reportCellValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case openregspecs_smcubes_extra_extensionPackage.REPORT_TABLE_MODULE: {
			...
			case openregspecs_smcubes_extra_extensionPackage.TABLE_CELL_MODULE: {
...
} //openregspecs_smcubes_extra_extensionSwitch
