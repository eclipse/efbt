 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_core_extension.impl.MemberHierarchyModuleImpl#getMemberHierarchies <em>Member Hierarchies</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_core_extension.impl.MemberHierarchyModuleImpl#getMemberHierarchiesNodes <em>Member Hierarchies Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberHierarchyModuleImpl extends ModuleImpl implements MemberHierarchyModule {
	...
	protected EClass eStaticClass() {
		return openregspecs_smcubes_core_extensionPackage.Literals.MEMBER_HIERARCHY_MODULE;
	}
	...
	public EList<MEMBER_HIERARCHY> getMemberHierarchies() {
		if (memberHierarchies == null) {
			memberHierarchies = new EObjectContainmentEList<MEMBER_HIERARCHY>(MEMBER_HIERARCHY.class, this, openregspecs_smcubes_core_extensionPackage.MEMBER_HIERARCHY_MODULE__MEMBER_HIERARCHIES);
		}
	...
	public EList<MEMBER_HIERARCHY_NODE> getMemberHierarchiesNodes() {
		if (memberHierarchiesNodes == null) {
			memberHierarchiesNodes = new EObjectContainmentEList<MEMBER_HIERARCHY_NODE>(MEMBER_HIERARCHY_NODE.class, this, openregspecs_smcubes_core_extensionPackage.MEMBER_HIERARCHY_MODULE__MEMBER_HIERARCHIES_NODES);
		}
