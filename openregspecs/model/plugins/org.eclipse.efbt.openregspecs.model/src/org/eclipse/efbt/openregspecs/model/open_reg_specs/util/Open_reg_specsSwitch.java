...
public class Open_reg_specsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Open_reg_specsPackage.OPEN_REG_SPECS: {
				OpenRegSpecs openRegSpecs = (OpenRegSpecs)theEObject;
				T result = caseOpenRegSpecs(openRegSpecs);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Open Reg Specs</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Open Reg Specs</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOpenRegSpecs(OpenRegSpecs object) {
		return null;
	}
