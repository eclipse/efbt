 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.CombinationModuleImpl#getCombinations <em>Combinations</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.CombinationModuleImpl#getCombination_items <em>Combination items</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.model.openregspecs_smcubes_extra_extension.impl.CombinationModuleImpl#getCubeToCombinationLinks <em>Cube To Combination Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CombinationModuleImpl extends ModuleImpl implements CombinationModule {
	...
	protected EClass eStaticClass() {
		return openregspecs_smcubes_extra_extensionPackage.Literals.COMBINATION_MODULE;
	}
	...
	public EList<COMBINATION> getCombinations() {
		if (combinations == null) {
			combinations = new EObjectContainmentEList<COMBINATION>(COMBINATION.class, this, openregspecs_smcubes_extra_extensionPackage.COMBINATION_MODULE__COMBINATIONS);
		}
		return combinations;
	}
	...
	public EList<COMBINATION_ITEM> getCombination_items() {
		if (combination_items == null) {
			combination_items = new EObjectContainmentEList<COMBINATION_ITEM>(COMBINATION_ITEM.class, this, openregspecs_smcubes_extra_extensionPackage.COMBINATION_MODULE__COMBINATION_ITEMS);
		}
	...
	public EList<CUBE_TO_COMBINATION> getCubeToCombinationLinks() {
		if (cubeToCombinationLinks == null) {
			cubeToCombinationLinks = new EObjectContainmentEList<CUBE_TO_COMBINATION>(CUBE_TO_COMBINATION.class, this, openregspecs_smcubes_extra_extensionPackage.COMBINATION_MODULE__CUBE_TO_COMBINATION_LINKS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case openregspecs_smcubes_extra_extensionPackage.COMBINATION_MODULE__COMBINATIONS:
				return ((InternalEList<?>)getCombinations()).basicRemove(otherEnd, msgs);
			case openregspecs_smcubes_extra_extensionPackage.COMBINATION_MODULE__COMBINATION_ITEMS:
				return ((InternalEList<?>)getCombination_items()).basicRemove(otherEnd, msgs);
			case openregspecs_smcubes_extra_extensionPackage.COMBINATION_MODULE__CUBE_TO_COMBINATION_LINKS:
