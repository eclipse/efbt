...
import org.eclipse.efbt.openregspecs.model.bpmn_lite.BaseElement;
...
import org.eclipse.efbt.openregspecs.model.bpmn_lite.Gateway;
...
public class Bpmn_litePackageImpl extends EPackageImpl implements Bpmn_litePackage {
	 ...
	 * @see org.eclipse.efbt.openregspecs.model.bpmn_lite.Bpmn_litePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static Bpmn_litePackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(Data_meta_modelPackage.eNS_URI);
	...
	public void initializePackageContents() {
		...
		initEReference(getServiceTask_Scenarios(), theTestingPackage.getScenario(), null, "scenarios", null, 0, -1, ServiceTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScriptTask_SelectionLayers(), theTestingPackage.getSelectionLayer(), null, "selectionLayers", null, 0, -1, ScriptTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
