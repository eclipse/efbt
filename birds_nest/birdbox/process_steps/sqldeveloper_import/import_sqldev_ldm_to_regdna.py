...
from birdbox.regdna import ELAttribute, ELClass, ELEnum
from birdbox.regdna import ELEnumLiteral, ELReference
from birdbox.regdna import ELAnnotation, ELStringToStringMapEntry
