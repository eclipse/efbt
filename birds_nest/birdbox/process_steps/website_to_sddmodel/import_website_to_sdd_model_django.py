...
from birdbox.context.csv_column_index_context import ColumnIndexes
...
class ImportWebsiteToSDDModel(object):
    ...
    def get_domain_with_id(self, context, domain_id_string):
        ...
        '''
        try:
            return context.nonref_domain_dictionary[domain_id_string]
        except KeyError:
            return None
    ...
    def get_subdomain_with_id(self, context, subdomain_id_string):
        ...
        '''
        return context.subnonref_domain_dictionary[subdomain_id_string]
