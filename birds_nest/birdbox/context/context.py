...
from birdbox.regdna import  ELPackage, ModuleList, GenerationRulesModule, ReportModule, ELAnnotationDirective
from birdbox.context.ecore_lite_types import EcoreLiteTypes
