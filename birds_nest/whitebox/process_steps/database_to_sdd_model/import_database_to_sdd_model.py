...
class ImportDatabaseToSDDModel(object):
    ...
    def import_sdd(self,sdd_context):
        ...
        ImportDatabaseToSDDModel.create_all_subdomains(self, sdd_context)
        ImportDatabaseToSDDModel.create_all_subdomain_enumerations(self, sdd_context)
        ImportDatabaseToSDDModel.create_all_variables(self, sdd_context)
        ImportDatabaseToSDDModel.create_all_variable_sets(self, sdd_context)

        ImportDatabaseToSDDModel.create_all_member_hierarchies(self, sdd_context)
        ImportDatabaseToSDDModel.create_all_member_hierarchies_nodes(self, sdd_context)
        ...
        ImportDatabaseToSDDModel.create_all_variable_set_mapping(self, sdd_context)
    ...
    def create_all_variable_set_mapping(self, context):
        '''
        import all the variable set mappings
        '''
        for variable_set_mapping in VARIABLE_SET_MAPPING.objects.all():
    ...
    def create_all_subdomains(self, context):
        ...
        for subdomain in SUBDOMAIN.objects.all():
            context.subdomain_dictionary[subdomain.subdomain_id] = subdomain
