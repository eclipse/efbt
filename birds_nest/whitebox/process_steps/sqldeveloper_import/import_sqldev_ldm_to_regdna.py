...
from whitebox.regdna import ELEnumLiteral, ELReference
from whitebox.regdna import ELAnnotation, ELStringToStringMapEntry
        ...
        with open(file_location,  encoding='utf-8') as csvfile:
            ...
            for row in filereader:
                if not header_skipped:
                    ...
                    enum_name = row[1]
                    synonym = row[3]
                    adapted_enum_name = Utils.make_valid_id(synonym)+"_domain"
                    the_enum = ELEnum()
