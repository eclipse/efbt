...
from birdai.process_steps.sqldeveloper_import.import_sqldev_ldm_to_regdna import (
    SQLDevLDMImport,
)
from birdai.process_steps.sqldeveloper_import.import_sqldev_il_to_regdna import (
    SQLDeveloperILImport,
)
from birdai.process_steps.sqldeveloper_import.import_sqldev_ldm_to_django import (
    RegDNAToDJango,
)
...
if __name__ == '__main__':
    django.setup()
    RunCreateDjangoModels('birdai', 'birds_nest').ready()
