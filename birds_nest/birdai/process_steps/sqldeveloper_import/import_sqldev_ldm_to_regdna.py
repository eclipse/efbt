...
from birdai.regdna import ELAttribute, ELClass, ELEnum
from birdai.regdna import ELEnumLiteral, ELReference
from birdai.regdna import ELAnnotation, ELStringToStringMapEntry
