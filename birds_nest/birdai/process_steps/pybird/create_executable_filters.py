...
class CreateExecutableFilters:
    def create_executable_filters(self,context, sdd_context):
        ...
        for cube_id, combination_list in sdd_context.combination_to_rol_cube_map.items():
            report_html_file.write("<tr><td><a href=\"{% url 'birdai:show_report' '" + cube_id +'.html' + "'%}\">" +cube_id + "</a></td></tr>\n")   
            ...
            for combination in combination_list:
                if combination.combination_id.metric:
                    filter_html_file.write("<tr><td><a href=\"{% url 'birdai:execute_data_point' '" + cube_id + "_" + combination.combination_id.combination_id + "'%}\">" + cube_id + "_" + combination.combination_id.combination_id + "</a></td></tr>\n")
