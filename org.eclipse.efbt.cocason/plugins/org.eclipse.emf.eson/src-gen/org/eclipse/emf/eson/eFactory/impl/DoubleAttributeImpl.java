 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.eson.eFactory.impl.DoubleAttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleAttributeImpl extends AttributeImpl implements DoubleAttribute
{
  ...
  {
    return EFactoryPackage.Literals.DOUBLE_ATTRIBUTE;
  }
  ...
  public void setValue(double newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EFactoryPackage.DOUBLE_ATTRIBUTE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EFactoryPackage.DOUBLE_ATTRIBUTE__VALUE:
        return getValue();
    }
