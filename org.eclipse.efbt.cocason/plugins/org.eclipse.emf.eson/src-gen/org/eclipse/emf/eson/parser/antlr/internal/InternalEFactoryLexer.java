...
public class InternalEFactoryLexer extends Lexer {
    ...
    public final void mT__14() throws RecognitionException {
        try {
            int _type = T__14;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:12:7: ( 'import' )
            // InternalEFactory.g:12:9: 'import'
            {
            match("import"); 
    ...
    public final void mT__15() throws RecognitionException {
        try {
            int _type = T__15;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:13:7: ( '@Name' )
            // InternalEFactory.g:13:9: '@Name'
            {
            match("@Name"); 
    ...
    public final void mT__22() throws RecognitionException {
        try {
            int _type = T__22;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:20:7: ( 'NULL' )
            // InternalEFactory.g:20:9: 'NULL'
            {
            match("NULL"); 
    ...
    public final void mRULE_LONG_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1399:14: ( RULE_LONG_UNSIGNED RULE_ID )
            // InternalEFactory.g:1399:16: RULE_LONG_UNSIGNED RULE_ID
            {
            mRULE_LONG_UNSIGNED(); 
            mRULE_ID(); 
    ...
    public final void mRULE_LONG_UNSIGNED() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1401:20: ( ( '0' .. '9' )+ )
            // InternalEFactory.g:1401:22: ( '0' .. '9' )+
            {
            // InternalEFactory.g:1401:22: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalEFactory.g:1401:23: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1403:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | ',' | '-' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | ',' | '-' | '0' .. '9' )* )
            // InternalEFactory.g:1403:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | ',' | '-' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | ',' | '-' | '0' .. '9' )*
            {
            // InternalEFactory.g:1403:11: ( '^' )?
            int alt2=2;
            ...
            // InternalEFactory.g:1403:48: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | ',' | '-' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1405:10: ( ( '0' .. '9' )+ )
            // InternalEFactory.g:1405:12: ( '0' .. '9' )+
            {
            // InternalEFactory.g:1405:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalEFactory.g:1405:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1407:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalEFactory.g:1407:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalEFactory.g:1407:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalEFactory.g:1407:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalEFactory.g:1407:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // InternalEFactory.g:1407:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalEFactory.g:1407:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1409:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalEFactory.g:1409:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalEFactory.g:1409:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1411:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalEFactory.g:1411:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalEFactory.g:1411:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1413:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalEFactory.g:1413:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalEFactory.g:1413:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEFactory.g:1415:16: ( . )
            // InternalEFactory.g:1415:18: .
            {
            matchAny(); 
