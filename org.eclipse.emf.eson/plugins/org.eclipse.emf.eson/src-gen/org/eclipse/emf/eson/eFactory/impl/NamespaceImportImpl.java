...
public class NamespaceImportImpl extends MinimalEObjectImpl.Container implements NamespaceImport
{
  ...
  {
    return EFactoryPackage.Literals.NAMESPACE_IMPORT;
  }
  ...
  public void setImportedNamespace(String newImportedNamespace)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EFactoryPackage.NAMESPACE_IMPORT__IMPORTED_NAMESPACE, oldImportedNamespace, importedNamespace));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EFactoryPackage.NAMESPACE_IMPORT__IMPORTED_NAMESPACE:
