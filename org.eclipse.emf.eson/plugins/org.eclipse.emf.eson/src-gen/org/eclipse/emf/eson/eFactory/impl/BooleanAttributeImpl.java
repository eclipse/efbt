...
public class BooleanAttributeImpl extends AttributeImpl implements BooleanAttribute
{
  ...
  {
    return EFactoryPackage.Literals.BOOLEAN_ATTRIBUTE;
  }
  ...
  public void setValue(boolean newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EFactoryPackage.BOOLEAN_ATTRIBUTE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EFactoryPackage.BOOLEAN_ATTRIBUTE__VALUE:
        return isValue();
    }
