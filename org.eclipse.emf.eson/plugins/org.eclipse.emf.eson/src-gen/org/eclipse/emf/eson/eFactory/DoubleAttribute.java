...
public interface DoubleAttribute extends Attribute
{
   ...
   * @see #setValue(double)
   * @see org.eclipse.emf.eson.eFactory.EFactoryPackage#getDoubleAttribute_Value()
   * @model
   * @generated
   */
  double getValue();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.eson.eFactory.DoubleAttribute#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
