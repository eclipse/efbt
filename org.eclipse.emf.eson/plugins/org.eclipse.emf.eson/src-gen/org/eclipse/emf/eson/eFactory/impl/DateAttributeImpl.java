 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.eson.eFactory.impl.DateAttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateAttributeImpl extends AttributeImpl implements DateAttribute
{
  ...
  {
    return EFactoryPackage.Literals.DATE_ATTRIBUTE;
  }
  ...
  public void setValue(Date newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EFactoryPackage.DATE_ATTRIBUTE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EFactoryPackage.DATE_ATTRIBUTE__VALUE:
        return getValue();
    }
