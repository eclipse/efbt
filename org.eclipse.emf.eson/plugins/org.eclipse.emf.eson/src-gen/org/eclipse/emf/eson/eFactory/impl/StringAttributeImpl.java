 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.eson.eFactory.impl.StringAttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringAttributeImpl extends AttributeImpl implements StringAttribute
{
  ...
  {
    return EFactoryPackage.Literals.STRING_ATTRIBUTE;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EFactoryPackage.STRING_ATTRIBUTE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EFactoryPackage.STRING_ATTRIBUTE__VALUE:
        return getValue();
    }
