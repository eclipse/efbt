 ...
 * 
 * <!-- end-model-doc -->
 * @see cube_schema.Cube_schemaFactory
 * @model kind="package"
...
public interface Cube_schemaPackage extends EPackage
{
	 ...
	 * @generated
	 */
	Cube_schemaPackage eINSTANCE = cube_schema.impl.Cube_schemaPackageImpl.init();

	/**
	 * The meta object id for the '{@link cube_schema.impl.CubeSchemaImpl <em>Cube Schema</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see cube_schema.impl.CubeSchemaImpl
	 * @see cube_schema.impl.Cube_schemaPackageImpl#getCubeSchema()
	 * @generated
	 */
	int CUBE_SCHEMA = 0;
	...
	/**
	 * Returns the meta object for class '{@link cube_schema.CubeSchema <em>Cube Schema</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Cube Schema</em>'.
	 * @see cube_schema.CubeSchema
	 * @generated
	 */
	EClass getCubeSchema();

	/**
	 * Returns the meta object for the reference '{@link cube_schema.CubeSchema#getCube <em>Cube</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Cube</em>'.
	 * @see cube_schema.CubeSchema#getCube()
	 * @see #getCubeSchema()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link cube_schema.CubeSchema#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see cube_schema.CubeSchema#getName()
	 * @see #getCubeSchema()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link cube_schema.CubeSchema#getBaseCube <em>Base Cube</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Base Cube</em>'.
	 * @see cube_schema.CubeSchema#getBaseCube()
	 * @see #getCubeSchema()
	 * @generated
	 */
	...
	{
		/**
		 * The meta object literal for the '{@link cube_schema.impl.CubeSchemaImpl <em>Cube Schema</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see cube_schema.impl.CubeSchemaImpl
		 * @see cube_schema.impl.Cube_schemaPackageImpl#getCubeSchema()
