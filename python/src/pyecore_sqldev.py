...
@author: Neil
'''
from pyecore.ecore import EClass, EAttribute, EReference, EString, EPackage,EEnum,EEnumLiteral,EDate,EDouble,EInt
from pyecore.resources import ResourceSet, URI
import csv
class SQLDeveloperImport(object):
        
    def convert (self,fileDirectory,outputDirectory):   
        birdpackage = EPackage('bird', nsURI='"http://www.eclipse.org/bird"', nsPrefix='bird')
        classesMap = {}
        ...
        with open(fileLocation) as csvfile:
            ...
            for row in filereader:
                ...
                if (not headerSkipped):
                    ...
                    eclass = EClass(alteredClassName)
                    birdpackage.eClassifiers.extend([eclass])
            ...
            for row in filereader:
                ...
                if (not headerSkipped):
                    ...
                    if ( not (len(superclassID.strip()) == 0)):
                        ...
                        theclass.eSuperTypes.append(superclass)
                        #print("theclass")
                        print(theclass)
...
if __name__ == '__main__':
    SQLDeveloperImport().convert('C:\\Users\\Neil\\LDM1_Export','C:\\Users\\Neil\\freebirdtools-developdec21\\git\\efbt\\python\\')
