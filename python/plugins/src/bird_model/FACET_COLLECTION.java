 ...
 * </p>
 * <ul>
 *   <li>{@link bird_model.FACET_COLLECTION#getCode <em>Code</em>}</li>
 *   <li>{@link bird_model.FACET_COLLECTION#getFacet_id <em>Facet id</em>}</li>
 *   <li>{@link bird_model.FACET_COLLECTION#getFacet_value_type <em>Facet value type</em>}</li>
 *   <li>{@link bird_model.FACET_COLLECTION#getMaintenance_agency_id <em>Maintenance agency id</em>}</li>
 *   <li>{@link bird_model.FACET_COLLECTION#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see bird_model.Bird_modelPackage#getFACET_COLLECTION()
...
public interface FACET_COLLECTION extends EObject {
	 ...
	 * @see #setCode(String)
	 * @see bird_model.Bird_modelPackage#getFACET_COLLECTION_Code()
	...
	/**
	 * Sets the value of the '{@link bird_model.FACET_COLLECTION#getCode <em>Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see bird_model.Bird_modelPackage#getFACET_COLLECTION_Facet_id()
	 * @model id="true"
	...
	/**
	 * Sets the value of the '{@link bird_model.FACET_COLLECTION#getFacet_id <em>Facet id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see bird_model.Bird_modelPackage#getFACET_COLLECTION_Facet_value_type()
	...
	/**
	 * Sets the value of the '{@link bird_model.FACET_COLLECTION#getFacet_value_type <em>Facet value type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see bird_model.Bird_modelPackage#getFACET_COLLECTION_Maintenance_agency_id()
	...
	/**
	 * Sets the value of the '{@link bird_model.FACET_COLLECTION#getMaintenance_agency_id <em>Maintenance agency id</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see bird_model.Bird_modelPackage#getFACET_COLLECTION_Name()
	...
	/**
	 * Sets the value of the '{@link bird_model.FACET_COLLECTION#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
