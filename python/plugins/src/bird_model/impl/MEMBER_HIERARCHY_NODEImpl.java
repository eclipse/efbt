 ...
 * </p>
 * <ul>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getComparator <em>Comparator</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getMember_hierarchy_id <em>Member hierarchy id</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getMember_id <em>Member id</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getParent_member_id <em>Parent member id</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getValid_from <em>Valid from</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHY_NODEImpl#getValid_to <em>Valid to</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MEMBER_HIERARCHY_NODEImpl extends MinimalEObjectImpl.Container implements MEMBER_HIERARCHY_NODE {
	...
	protected EClass eStaticClass() {
		return Bird_modelPackage.Literals.MEMBER_HIERARCHY_NODE;
	}
	...
	public void setComparator(String newComparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__COMPARATOR, oldComparator, comparator));
	}
	...
	public void setLevel(int newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__LEVEL, oldLevel, level));
	}
	...
	public MEMBER_HIERARCHY getMember_hierarchy_id() {
		if (member_hierarchy_id != null && member_hierarchy_id.eIsProxy()) {
			...
			if (member_hierarchy_id != oldMember_hierarchy_id) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bird_modelPackage.MEMBER_HIERARCHY_NODE__MEMBER_HIERARCHY_ID, oldMember_hierarchy_id, member_hierarchy_id));
			}
		}
	...
	public void setMember_hierarchy_id(MEMBER_HIERARCHY newMember_hierarchy_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__MEMBER_HIERARCHY_ID, oldMember_hierarchy_id, member_hierarchy_id));
	}
	...
	public MEMBER getMember_id() {
		if (member_id != null && member_id.eIsProxy()) {
			...
			if (member_id != oldMember_id) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bird_modelPackage.MEMBER_HIERARCHY_NODE__MEMBER_ID, oldMember_id, member_id));
			}
		}
		return member_id;
	}
	...
	public void setMember_id(MEMBER newMember_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__MEMBER_ID, oldMember_id, member_id));
	}
	...
	public void setOperator(String newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__OPERATOR, oldOperator, operator));
	}
	...
	public MEMBER getParent_member_id() {
		if (parent_member_id != null && parent_member_id.eIsProxy()) {
			...
			if (parent_member_id != oldParent_member_id) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bird_modelPackage.MEMBER_HIERARCHY_NODE__PARENT_MEMBER_ID, oldParent_member_id, parent_member_id));
			}
		}
	...
	public void setParent_member_id(MEMBER newParent_member_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__PARENT_MEMBER_ID, oldParent_member_id, parent_member_id));
	}
	...
	public void setValid_from(Date newValid_from) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__VALID_FROM, oldValid_from, valid_from));
	}
	...
	public void setValid_to(Date newValid_to) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY_NODE__VALID_TO, oldValid_to, valid_to));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__COMPARATOR:
				return getComparator();
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__LEVEL:
				return getLevel();
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__MEMBER_HIERARCHY_ID:
				if (resolve) return getMember_hierarchy_id();
				return basicGetMember_hierarchy_id();
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__MEMBER_ID:
				if (resolve) return getMember_id();
				return basicGetMember_id();
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__OPERATOR:
				return getOperator();
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__PARENT_MEMBER_ID:
				if (resolve) return getParent_member_id();
				return basicGetParent_member_id();
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__VALID_FROM:
				return getValid_from();
			case Bird_modelPackage.MEMBER_HIERARCHY_NODE__VALID_TO:
				return getValid_to();
		}
