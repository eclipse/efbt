 ...
 * </p>
 * <ul>
 *   <li>{@link bird_model.impl.VariableModuleImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableModuleImpl extends ModuleImpl implements VariableModule {
	...
	protected EClass eStaticClass() {
		return Bird_modelPackage.Literals.VARIABLE_MODULE;
	}
	...
	public EList<VARIABLE> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentEList<VARIABLE>(VARIABLE.class, this, Bird_modelPackage.VARIABLE_MODULE__VARIABLES);
		}
		return variables;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Bird_modelPackage.VARIABLE_MODULE__VARIABLES:
