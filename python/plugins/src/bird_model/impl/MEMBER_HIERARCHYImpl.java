 ...
 * </p>
 * <ul>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHYImpl#getCode <em>Code</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHYImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHYImpl#getDomain_id <em>Domain id</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHYImpl#getMaintenance_agency_id <em>Maintenance agency id</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHYImpl#getMember_hierarchy_id <em>Member hierarchy id</em>}</li>
 *   <li>{@link bird_model.impl.MEMBER_HIERARCHYImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MEMBER_HIERARCHYImpl extends MinimalEObjectImpl.Container implements MEMBER_HIERARCHY {
	...
	protected EClass eStaticClass() {
		return Bird_modelPackage.Literals.MEMBER_HIERARCHY;
	}
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY__CODE, oldCode, code));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY__DESCRIPTION, oldDescription, description));
	}
	...
	public DOMAIN getDomain_id() {
		if (domain_id != null && domain_id.eIsProxy()) {
			...
			if (domain_id != oldDomain_id) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bird_modelPackage.MEMBER_HIERARCHY__DOMAIN_ID, oldDomain_id, domain_id));
			}
		}
		return domain_id;
	}
	...
	public void setDomain_id(DOMAIN newDomain_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY__DOMAIN_ID, oldDomain_id, domain_id));
	}
	...
	public MAINTENANCE_AGENCY getMaintenance_agency_id() {
		if (maintenance_agency_id != null && maintenance_agency_id.eIsProxy()) {
			...
			if (maintenance_agency_id != oldMaintenance_agency_id) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bird_modelPackage.MEMBER_HIERARCHY__MAINTENANCE_AGENCY_ID, oldMaintenance_agency_id, maintenance_agency_id));
			}
		}
	...
	public void setMaintenance_agency_id(MAINTENANCE_AGENCY newMaintenance_agency_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY__MAINTENANCE_AGENCY_ID, oldMaintenance_agency_id, maintenance_agency_id));
	}
	...
	public void setMember_hierarchy_id(String newMember_hierarchy_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY__MEMBER_HIERARCHY_ID, oldMember_hierarchy_id, member_hierarchy_id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.MEMBER_HIERARCHY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bird_modelPackage.MEMBER_HIERARCHY__CODE:
				return getCode();
			case Bird_modelPackage.MEMBER_HIERARCHY__DESCRIPTION:
				return getDescription();
			case Bird_modelPackage.MEMBER_HIERARCHY__DOMAIN_ID:
				if (resolve) return getDomain_id();
				return basicGetDomain_id();
			case Bird_modelPackage.MEMBER_HIERARCHY__MAINTENANCE_AGENCY_ID:
				if (resolve) return getMaintenance_agency_id();
				return basicGetMaintenance_agency_id();
			case Bird_modelPackage.MEMBER_HIERARCHY__MEMBER_HIERARCHY_ID:
				return getMember_hierarchy_id();
			case Bird_modelPackage.MEMBER_HIERARCHY__NAME:
				return getName();
		}
