 ...
 * </p>
 * <ul>
 *   <li>{@link bird_model.impl.facet_typeImpl#getDecimals <em>Decimals</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getEndValue <em>End Value</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getInterval <em>Interval</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getIsSequence <em>Is Sequence</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getStartValue <em>Start Value</em>}</li>
 *   <li>{@link bird_model.impl.facet_typeImpl#getTimeInterval <em>Time Interval</em>}</li>
 * </ul>
 *
 * @generated
 */
public class facet_typeImpl extends MinimalEObjectImpl.Container implements facet_type {
	...
	protected EClass eStaticClass() {
		return Bird_modelPackage.Literals.FACET_TYPE;
	}
	...
	public void setDecimals(int newDecimals) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__DECIMALS, oldDecimals, decimals));
	}
	...
	public void setEndTime(String newEndTime) {
		...
		endTime = newEndTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__END_TIME, oldEndTime, endTime));
	}
	...
	public void setEndValue(int newEndValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__END_VALUE, oldEndValue, endValue));
	}
	...
	public void setInterval(String newInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__INTERVAL, oldInterval, interval));
	}
	...
	public void setIsSequence(String newIsSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__IS_SEQUENCE, oldIsSequence, isSequence));
	}
	...
	public void setMaxLength(int newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setMaxValue(int newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__MAX_VALUE, oldMaxValue, maxValue));
	}
	...
	public void setMinLength(int newMinLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__MIN_LENGTH, oldMinLength, minLength));
	}
	...
	public void setMinValue(int newMinValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__MIN_VALUE, oldMinValue, minValue));
	}
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__PATTERN, oldPattern, pattern));
	}
	...
	public void setStartTime(String newStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__START_TIME, oldStartTime, startTime));
	}
	...
	public void setStartValue(int newStartValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__START_VALUE, oldStartValue, startValue));
	}
	...
	public void setTimeInterval(String newTimeInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.FACET_TYPE__TIME_INTERVAL, oldTimeInterval, timeInterval));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bird_modelPackage.FACET_TYPE__DECIMALS:
				return getDecimals();
			case Bird_modelPackage.FACET_TYPE__END_TIME:
				return getEndTime();
			case Bird_modelPackage.FACET_TYPE__END_VALUE:
				return getEndValue();
			case Bird_modelPackage.FACET_TYPE__INTERVAL:
				return getInterval();
			case Bird_modelPackage.FACET_TYPE__IS_SEQUENCE:
				return getIsSequence();
			case Bird_modelPackage.FACET_TYPE__MAX_LENGTH:
				return getMaxLength();
			case Bird_modelPackage.FACET_TYPE__MAX_VALUE:
				return getMaxValue();
			case Bird_modelPackage.FACET_TYPE__MIN_LENGTH:
				return getMinLength();
			case Bird_modelPackage.FACET_TYPE__MIN_VALUE:
				return getMinValue();
			case Bird_modelPackage.FACET_TYPE__PATTERN:
				return getPattern();
			case Bird_modelPackage.FACET_TYPE__START_TIME:
				return getStartTime();
			case Bird_modelPackage.FACET_TYPE__START_VALUE:
				return getStartValue();
			case Bird_modelPackage.FACET_TYPE__TIME_INTERVAL:
