 ...
 * </p>
 * <ul>
 *   <li>{@link bird_model.impl.MemberModuleImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberModuleImpl extends ModuleImpl implements MemberModule {
	...
	protected EClass eStaticClass() {
		return Bird_modelPackage.Literals.MEMBER_MODULE;
	}
	...
	public EList<MEMBER> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<MEMBER>(MEMBER.class, this, Bird_modelPackage.MEMBER_MODULE__MEMBERS);
		}
		return members;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Bird_modelPackage.MEMBER_MODULE__MEMBERS:
