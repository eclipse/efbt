 ...
 * </p>
 * <ul>
 *   <li>{@link bird_model.impl.ConceptImpl#getConceptName <em>Concept Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConceptImpl extends MinimalEObjectImpl.Container implements Concept {
	...
	protected EClass eStaticClass() {
		return Bird_modelPackage.Literals.CONCEPT;
	}
	...
	public void setConceptName(String newConceptName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bird_modelPackage.CONCEPT__CONCEPT_NAME, oldConceptName, conceptName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bird_modelPackage.CONCEPT__CONCEPT_NAME:
