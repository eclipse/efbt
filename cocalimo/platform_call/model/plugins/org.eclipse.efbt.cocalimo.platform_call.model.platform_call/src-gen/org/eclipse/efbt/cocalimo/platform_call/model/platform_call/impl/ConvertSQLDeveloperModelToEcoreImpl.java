 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.platform_call.model.platform_call.impl.ConvertSQLDeveloperModelToEcoreImpl#getInputDirectory <em>Input Directory</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.platform_call.model.platform_call.impl.ConvertSQLDeveloperModelToEcoreImpl#getOutputDirectory <em>Output Directory</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConvertSQLDeveloperModelToEcoreImpl extends PlatformCallImpl implements ConvertSQLDeveloperModelToEcore {
	...
	public void setOutputDirectory(String newOutputDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Platform_callPackage.CONVERT_SQL_DEVELOPER_MODEL_TO_ECORE__OUTPUT_DIRECTORY, oldOutputDirectory, outputDirectory));
	}
