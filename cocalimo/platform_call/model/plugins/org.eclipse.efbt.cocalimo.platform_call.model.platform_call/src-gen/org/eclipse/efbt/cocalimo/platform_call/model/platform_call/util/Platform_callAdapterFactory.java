...
import org.eclipse.efbt.cocalimo.platform_call.model.platform_call.*;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.efbt.cocalimo.platform_call.model.platform_call.Platform_callPackage
 * @generated
 */
public class Platform_callAdapterFactory extends AdapterFactoryImpl {
	...
	protected Platform_callSwitch<Adapter> modelSwitch =
		new Platform_callSwitch<Adapter>() {
			...
			@Override
			public Adapter caseConvertDataMetaModelToEcore(ConvertDataMetaModelToEcore object) {
				return createConvertDataMetaModelToEcoreAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.cocalimo.platform_call.model.platform_call.PlatformCall <em>Platform Call</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.cocalimo.platform_call.model.platform_call.PlatformCallModule <em>Platform Call Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.cocalimo.platform_call.model.platform_call.ImportBIRDFromMSAccess <em>Import BIRD From MS Access</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.cocalimo.platform_call.model.platform_call.CreateLogicalTransformationViewForScope <em>Create Logical Transformation View For Scope</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.cocalimo.platform_call.model.platform_call.ConvertDataMetaModelToEcore <em>Convert Data Meta Model To Ecore</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConvertDataMetaModelToEcoreAdapter() {
		return null;
	}
