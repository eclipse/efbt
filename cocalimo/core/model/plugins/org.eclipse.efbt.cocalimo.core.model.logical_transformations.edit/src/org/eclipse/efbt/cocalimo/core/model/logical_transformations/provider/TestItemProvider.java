		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Test_scenarios_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Test_scenarios_feature", "_UI_Test_type"),
				 Logical_transformationsPackage.Literals.TEST__SCENARIOS,
				 true,
				 false,
				 true,
				 null,
