...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.core.model.task.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TaskPackage.Literals.TASK__SCENARIO,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUsedInSubsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_usedInSubset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_usedInSubset_feature", "_UI_Task_type"),
				 TaskPackage.Literals.TASK__USED_IN_SUBSET,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TaskPackage.Literals.TASK__SCENARIO_SET);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TaskPackage.Literals.TASK__SCENARIO_SET,
