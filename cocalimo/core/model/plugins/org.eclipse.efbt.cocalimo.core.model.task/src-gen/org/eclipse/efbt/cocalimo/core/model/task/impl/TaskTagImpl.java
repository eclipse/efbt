 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.core.model.task.impl.TaskTagImpl#getTask <em>Task</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskTagImpl extends TagImpl implements TaskTag {
		...
		if (task != null && task.eIsProxy()) {
			...
			if (task != oldTask) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaskPackage.TASK_TAG__TASK, oldTask, task));
			}
		}
		return task;
	}
	...
	public void setTask(Task newTask) {
		...
		task = newTask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.TASK_TAG__TASK, oldTask, task));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaskPackage.TASK_TAG__TASK:
