/**
 */
package org.eclipse.efbt.cocalimo.core.model.test.util;
...
public class TestSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID) {
			...
			case TestPackage.BDD_TEST: {
				BDDTest bddTest = (BDDTest)theEObject;
				T result = caseBDDTest(bddTest);
				if (result == null) result = caseTest(bddTest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestPackage.REG_FUNCTIONALITY_TEST: {
				RegFunctionalityTest regFunctionalityTest = (RegFunctionalityTest)theEObject;
				T result = caseRegFunctionalityTest(regFunctionalityTest);
				if (result == null) result = caseTest(regFunctionalityTest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
