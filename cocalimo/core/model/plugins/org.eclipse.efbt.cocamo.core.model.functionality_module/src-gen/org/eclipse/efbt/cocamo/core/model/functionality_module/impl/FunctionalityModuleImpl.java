 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocamo.core.model.functionality_module.impl.FunctionalityModuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocamo.core.model.functionality_module.impl.FunctionalityModuleImpl#getUsedTransformationOrScheme <em>Used Transformation Or Scheme</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocamo.core.model.functionality_module.impl.FunctionalityModuleImpl#getScenario <em>Scenario</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocamo.core.model.functionality_module.impl.FunctionalityModuleImpl#getScenarioSet <em>Scenario Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FunctionalityModuleImpl extends MinimalEObjectImpl.Container implements FunctionalityModule
{
	...
	/**
	 * The cached value of the '{@link #getUsedTransformationOrScheme() <em>Used Transformation Or Scheme</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected FunctionalityModule usedTransformationOrScheme;
	 ...
	 */
	@Override
	public FunctionalityModule getUsedTransformationOrScheme()
	{
		if (usedTransformationOrScheme != null && usedTransformationOrScheme.eIsProxy())
		{
			InternalEObject oldUsedTransformationOrScheme = (InternalEObject)usedTransformationOrScheme;
			usedTransformationOrScheme = (FunctionalityModule)eResolveProxy(oldUsedTransformationOrScheme);
			if (usedTransformationOrScheme != oldUsedTransformationOrScheme)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Functionality_modulePackage.FUNCTIONALITY_MODULE__USED_TRANSFORMATION_OR_SCHEME, oldUsedTransformationOrScheme, usedTransformationOrScheme));
			}
		}
		return usedTransformationOrScheme;
	}
	 ...
	 * @generated
	 */
	public FunctionalityModule basicGetUsedTransformationOrScheme()
	{
		return usedTransformationOrScheme;
	}
	 ...
	 */
	@Override
	public void setUsedTransformationOrScheme(FunctionalityModule newUsedTransformationOrScheme)
	{
		FunctionalityModule oldUsedTransformationOrScheme = usedTransformationOrScheme;
		usedTransformationOrScheme = newUsedTransformationOrScheme;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Functionality_modulePackage.FUNCTIONALITY_MODULE__USED_TRANSFORMATION_OR_SCHEME, oldUsedTransformationOrScheme, usedTransformationOrScheme));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__NAME:
				return getName();
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__USED_TRANSFORMATION_OR_SCHEME:
				if (resolve) return getUsedTransformationOrScheme();
				return basicGetUsedTransformationOrScheme();
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__NAME:
				...
				return;
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__USED_TRANSFORMATION_OR_SCHEME:
				setUsedTransformationOrScheme((FunctionalityModule)newValue);
				return;
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__SCENARIO:
	...
	public void eUnset(int featureID)
	{
		switch (featureID)
		{
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__NAME:
				...
				return;
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__USED_TRANSFORMATION_OR_SCHEME:
				setUsedTransformationOrScheme((FunctionalityModule)null);
				return;
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__SCENARIO:
	...
	public boolean eIsSet(int featureID)
	{
		switch (featureID)
		{
			...
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__USED_TRANSFORMATION_OR_SCHEME:
				return usedTransformationOrScheme != null;
			case Functionality_modulePackage.FUNCTIONALITY_MODULE__SCENARIO:
