...
import org.eclipse.efbt.cocamo.core.model.functionality_module.DataProcessingFunctionalityModule;
...
import org.eclipse.efbt.cocamo.core.model.functionality_module.ParallelFunctionalityModule;
import org.eclipse.efbt.cocamo.core.model.functionality_module.ReadDataSourceFunctionalityModule;
...
import org.eclipse.efbt.cocamo.core.model.functionality_module.ValidationFunctionalityModule;
...
import org.eclipse.efbt.cocamo.core.model.scenarios.impl.ScenariosPackageImpl;
...
public class Functionality_modulePackageImpl extends EPackageImpl implements Functionality_modulePackage
{
	 ...
	 * @see org.eclipse.efbt.cocamo.core.model.functionality_module.Functionality_modulePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getFunctionalityModuleSet_SubTransformationsAndSchemes()
	{
	 ...
	 */
	@Override
	public EReference getFunctionalityModule_UsedTransformationOrScheme()
	{
	...
	public void createPackageContents()
	{
		...
		createEReference(functionalityModuleSetEClass, FUNCTIONALITY_MODULE_SET__SUB_TRANSFORMATIONS_AND_SCHEMES);
		...
		createEReference(functionalityModuleEClass, FUNCTIONALITY_MODULE__USED_TRANSFORMATION_OR_SCHEME);
	...
	public void initializePackageContents()
	{
		...
		initEReference(getFunctionalityModuleSet_SubTransformationsAndSchemes(), this.getFunctionalityModule(), null, "subTransformationsAndSchemes", null, 0, -1, FunctionalityModuleSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFunctionalityModule_UsedTransformationOrScheme(), this.getFunctionalityModule(), null, "usedTransformationOrScheme", null, 0, 1, FunctionalityModule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations()
	{
		...
		addAnnotation
		  (getFunctionalityModuleSet_SubTransformationsAndSchemes(),
		   source,
		   new String[]
		   {
			   "kind", "element",
			   "name", "subTransformationsAndSchemes"
		   });
		addAnnotation
