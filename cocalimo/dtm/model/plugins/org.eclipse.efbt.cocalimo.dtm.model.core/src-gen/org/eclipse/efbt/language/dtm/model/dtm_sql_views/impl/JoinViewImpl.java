 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.JoinViewImpl#getWhereClause <em>Where Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.JoinViewImpl#getRenames <em>Renames</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.JoinViewImpl#getIgnores <em>Ignores</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinViewImpl extends SQLViewImpl implements JoinView
{
	/**
	...
	{
		return dtm_sql_viewsPackage.Literals.JOIN_VIEW;
	}
	...
	public NotificationChain basicSetWhereClause(WhereClause newWhereClause, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, oldWhereClause, newWhereClause);
	...
	public void setWhereClause(WhereClause newWhereClause)
	{
		if (newWhereClause != whereClause) {
			...
			if (whereClause != null)
				msgs = ((InternalEObject)whereClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - dtm_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, null, msgs);
			if (newWhereClause != null)
				msgs = ((InternalEObject)newWhereClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - dtm_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, null, msgs);
			msgs = basicSetWhereClause(newWhereClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, newWhereClause, newWhereClause));
	}
	...
	{
		if (renames == null) {
			renames = new EObjectContainmentEList<RenameAs>(RenameAs.class, this, dtm_sql_viewsPackage.JOIN_VIEW__RENAMES);
		}
		return renames;
	}
	...
	{
		if (ignores == null) {
			ignores = new EObjectContainmentEList<IgnoreColumn>(IgnoreColumn.class, this, dtm_sql_viewsPackage.JOIN_VIEW__IGNORES);
		}
		return ignores;
	}
	...
	{
		switch (featureID) {
			case dtm_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE:
				return basicSetWhereClause(null, msgs);
			case dtm_sql_viewsPackage.JOIN_VIEW__RENAMES:
				return ((InternalEList<?>)getRenames()).basicRemove(otherEnd, msgs);
			case dtm_sql_viewsPackage.JOIN_VIEW__IGNORES:
