 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.EnrichmentViewImpl#getFunctions <em>Functions</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.EnrichmentViewImpl#getRenames <em>Renames</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.EnrichmentViewImpl#getIgnores <em>Ignores</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnrichmentViewImpl extends SQLViewImpl implements EnrichmentView
{
	...
	{
		return dtm_sql_viewsPackage.Literals.ENRICHMENT_VIEW;
	}
	...
	{
		if (functions == null) {
			functions = new EObjectContainmentEList<BasicColumnFunction>(BasicColumnFunction.class, this, dtm_sql_viewsPackage.ENRICHMENT_VIEW__FUNCTIONS);
		}
		return functions;
	}
	...
	{
		if (renames == null) {
			renames = new EObjectContainmentEList<RenameAs>(RenameAs.class, this, dtm_sql_viewsPackage.ENRICHMENT_VIEW__RENAMES);
		}
		return renames;
	}
	...
	{
		if (ignores == null) {
			ignores = new EObjectContainmentEList<IgnoreColumn>(IgnoreColumn.class, this, dtm_sql_viewsPackage.ENRICHMENT_VIEW__IGNORES);
		}
		return ignores;
	}
