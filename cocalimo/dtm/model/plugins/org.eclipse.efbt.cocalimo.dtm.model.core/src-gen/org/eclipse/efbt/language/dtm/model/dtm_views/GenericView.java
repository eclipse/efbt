 ...
 *
 * <!-- begin-model-doc -->
 * An DTMView which represents a custom transformation.
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.GenericView#getSelectClause <em>Select Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.GenericView#getWhereClause <em>Where Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.GenericView#getGroupByClause <em>Group By Clause</em>}</li>
 * </ul>
 *
 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getGenericView()
 * @model extendedMetaData="name='GenericView' kind='elementOnly'"
 * @generated
 */
public interface GenericView extends DTMView {
	/**
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getGenericView_SelectClause()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.dtm.model.dtm_views.GenericView#getSelectClause <em>Select Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getGenericView_WhereClause()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.dtm.model.dtm_views.GenericView#getWhereClause <em>Where Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getGenericView_GroupByClause()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.dtm.model.dtm_views.GenericView#getGroupByClause <em>Group By Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
