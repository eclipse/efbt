...
public interface dtm_report_cell_viewsPackage extends EPackage
{
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW__CUBE = dtm_sql_viewsPackage.SQL_VIEW__CUBE;
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW__NAME = dtm_sql_viewsPackage.SQL_VIEW__NAME;
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW__VTL_CODE = dtm_sql_viewsPackage.SQL_VIEW__VTL_CODE;
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW__REPORT_CELL = dtm_sql_viewsPackage.SQL_VIEW_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW__STRUCT_COLUMN_HOLDING_DIMENSION = dtm_sql_viewsPackage.SQL_VIEW_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW__STRUCT_COLUMN_HOLDING_MEASURE = dtm_sql_viewsPackage.SQL_VIEW_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW_FEATURE_COUNT = dtm_sql_viewsPackage.SQL_VIEW_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int REPORT_CELL_VIEW_OPERATION_COUNT = dtm_sql_viewsPackage.SQL_VIEW_OPERATION_COUNT + 0;
