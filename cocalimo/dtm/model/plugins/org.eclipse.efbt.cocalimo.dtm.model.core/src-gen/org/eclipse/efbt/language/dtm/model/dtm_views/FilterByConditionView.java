 ...
 *
 * <!-- begin-model-doc -->
 * An DTMView which represents a Copy of all rows  of the single source cube of the associated cube IF they meet a filter condition.
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.FilterByConditionView#getWhereClause <em>Where Clause</em>}</li>
 * </ul>
 *
 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getFilterByConditionView()
 * @model extendedMetaData="name='FilterByConditionView' kind='elementOnly'"
 * @generated
 */
public interface FilterByConditionView extends DTMView {
	/**
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getFilterByConditionView_WhereClause()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.dtm.model.dtm_views.FilterByConditionView#getWhereClause <em>Where Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
