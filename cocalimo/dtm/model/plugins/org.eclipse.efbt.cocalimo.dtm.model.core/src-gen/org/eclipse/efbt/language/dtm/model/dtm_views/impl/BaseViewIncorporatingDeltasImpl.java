 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.BaseViewIncorporatingDeltasImpl#getUltimateSourceCube <em>Ultimate Source Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseViewIncorporatingDeltasImpl extends DTMViewImpl implements BaseViewIncorporatingDeltas {
	/**
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.BASE_VIEW_INCORPORATING_DELTAS;
	}
		...
		if (ultimateSourceCube != null && ultimateSourceCube.eIsProxy()) {
			...
			if (ultimateSourceCube != oldUltimateSourceCube) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.BASE_VIEW_INCORPORATING_DELTAS__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
			}
		}
	...
	public void setUltimateSourceCube(FreeBirdToolsCube newUltimateSourceCube) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.BASE_VIEW_INCORPORATING_DELTAS__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.BASE_VIEW_INCORPORATING_DELTAS__ULTIMATE_SOURCE_CUBE:
