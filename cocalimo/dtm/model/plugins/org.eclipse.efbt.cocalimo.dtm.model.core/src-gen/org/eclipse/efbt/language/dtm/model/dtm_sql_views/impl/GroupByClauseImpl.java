 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.GroupByClauseImpl#getGroupByColumns <em>Group By Columns</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupByClauseImpl extends MinimalEObjectImpl.Container implements GroupByClause
{
	...
	{
		return dtm_sql_viewsPackage.Literals.GROUP_BY_CLAUSE;
	}
	...
	public EList<VARIABLE> getGroupByColumns()
	{
		if (groupByColumns == null) {
			groupByColumns = new EObjectResolvingEList<VARIABLE>(VARIABLE.class, this, dtm_sql_viewsPackage.GROUP_BY_CLAUSE__GROUP_BY_COLUMNS);
		}
	...
	{
		switch (featureID) {
			case dtm_sql_viewsPackage.GROUP_BY_CLAUSE__GROUP_BY_COLUMNS:
