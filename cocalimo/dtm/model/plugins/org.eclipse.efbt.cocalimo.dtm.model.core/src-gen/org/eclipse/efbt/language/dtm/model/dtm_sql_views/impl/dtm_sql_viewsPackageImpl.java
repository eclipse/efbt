...
import org.eclipse.efbt.language.dtm.model.dtm_sql_views.CopyView;
import org.eclipse.efbt.language.dtm.model.dtm_sql_views.DeltaAccumulation;
...
import org.eclipse.efbt.language.dtm.model.dtm_sql_views.FilterByConditionView;
...
import org.eclipse.efbt.language.dtm.model.dtm_sql_views.IgnoreColumn;
...
import org.eclipse.efbt.language.dtm.model.dtm_sql_views.MakeStructView;
...
import org.eclipse.efbt.language.dtm.model.dtm_sql_views.UnionView;
 ...
 * @generated
 */
public class dtm_sql_viewsPackageImpl extends EPackageImpl implements dtm_sql_viewsPackage
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_sql_views.dtm_sql_viewsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private dtm_sql_viewsPackageImpl()
	{
		super(eNS_URI, dtm_sql_viewsFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link dtm_sql_viewsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static dtm_sql_viewsPackage init()
	{
		if (isInited) return (dtm_sql_viewsPackage)EPackage.Registry.INSTANCE.getEPackage(dtm_sql_viewsPackage.eNS_URI);

		// Obtain or create and register package
		Object registereddtm_sql_viewsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		dtm_sql_viewsPackageImpl thedtm_sql_viewsPackage = registereddtm_sql_viewsPackage instanceof dtm_sql_viewsPackageImpl ? (dtm_sql_viewsPackageImpl)registereddtm_sql_viewsPackage : new dtm_sql_viewsPackageImpl();
		...
		thedtm_sql_viewsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(dtm_sql_viewsPackage.eNS_URI, thedtm_sql_viewsPackage);
		return thedtm_sql_viewsPackage;
	}
	 ...
	 */
	@Override
	public dtm_sql_viewsFactory getdtm_sql_viewsFactory()
	{
		return (dtm_sql_viewsFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents()
	{
		...
		castColumnViewEClass.getESuperTypes().add(this.getSQLView());
		explodeArrayOfStructsViewEClass.getESuperTypes().add(this.getSQLView());
		explodeStructViewEClass.getESuperTypes().add(this.getSQLView());
		filterByStructClassColumnViewEClass.getESuperTypes().add(this.getSQLView());
		makeArrayOfStructsViewEClass.getESuperTypes().add(this.getSQLView());
		makeStructViewEClass.getESuperTypes().add(this.getSQLView());
		aggregateEnrichmentViewAndOrderByEClass.getESuperTypes().add(this.getSQLView());
		...
		initEReference(getAggregateEnrichmentViewAndOrderBy_Functions(), theColumn_transformation_logicPackage.getAggregateColumnFunction(), null, "functions", null, 0, -1, AggregateEnrichmentViewAndOrderBy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
