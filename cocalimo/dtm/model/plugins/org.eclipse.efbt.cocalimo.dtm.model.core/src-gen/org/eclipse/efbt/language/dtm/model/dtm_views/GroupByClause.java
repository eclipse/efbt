 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.GroupByClause#getGroupByColumns <em>Group By Columns</em>}</li>
 * </ul>
 *
 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getGroupByClause()
...
public interface GroupByClause extends EObject {
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getGroupByClause_GroupByColumns()
