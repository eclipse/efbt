 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.FilterByStructClassColumnViewImpl#getRenameAsStructColumn <em>Rename As Struct Column</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.FilterByStructClassColumnViewImpl#getStructClass <em>Struct Class</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.FilterByStructClassColumnViewImpl#getStructColumn <em>Struct Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FilterByStructClassColumnViewImpl extends DTMViewImpl implements FilterByStructClassColumnView {
	/**
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW;
	}
		...
		if (renameAsStructColumn != null && renameAsStructColumn.eIsProxy()) {
			...
			if (renameAsStructColumn != oldRenameAsStructColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__RENAME_AS_STRUCT_COLUMN, oldRenameAsStructColumn, renameAsStructColumn));
			}
		}
	...
	public void setRenameAsStructColumn(StructTypedVariable newRenameAsStructColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__RENAME_AS_STRUCT_COLUMN, oldRenameAsStructColumn, renameAsStructColumn));
	}
	...
	public FreeBirdToolsCube getStructClass() {
		if (structClass != null && structClass.eIsProxy()) {
			...
			if (structClass != oldStructClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__STRUCT_CLASS, oldStructClass, structClass));
			}
		}
		return structClass;
	}
	...
	public void setStructClass(FreeBirdToolsCube newStructClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__STRUCT_CLASS, oldStructClass, structClass));
	}
	...
	public StructTypedVariable getStructColumn() {
		if (structColumn != null && structColumn.eIsProxy()) {
			...
			if (structColumn != oldStructColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__STRUCT_COLUMN, oldStructColumn, structColumn));
			}
		}
		return structColumn;
	}
	...
	public void setStructColumn(StructTypedVariable newStructColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__STRUCT_COLUMN, oldStructColumn, structColumn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__RENAME_AS_STRUCT_COLUMN:
				if (resolve) return getRenameAsStructColumn();
				return basicGetRenameAsStructColumn();
			case dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__STRUCT_CLASS:
				if (resolve) return getStructClass();
				return basicGetStructClass();
			case dtm_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW__STRUCT_COLUMN:
