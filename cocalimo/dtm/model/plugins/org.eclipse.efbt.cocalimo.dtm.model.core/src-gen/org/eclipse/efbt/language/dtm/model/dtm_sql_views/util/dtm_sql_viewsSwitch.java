 ...
 * @generated
 */
public class dtm_sql_viewsSwitch<T> extends Switch<T>
{
	/**
	...
	{
		switch (classifierID) {
			case dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW: {
			...
			case dtm_sql_viewsPackage.COPY_VIEW: {
			...
			case dtm_sql_viewsPackage.ENRICHMENT_VIEW: {
			...
			case dtm_sql_viewsPackage.FILTER_BY_CONDITION_VIEW: {
			...
			case dtm_sql_viewsPackage.GENERIC_VIEW: {
			...
			case dtm_sql_viewsPackage.UNION_VIEW: {
			...
			case dtm_sql_viewsPackage.VERSIONED_SQL_VIEWS_MODULE: {
			...
			case dtm_sql_viewsPackage.WHERE_CLAUSE: {
				WhereClause whereClause = (WhereClause)theEObject;
				T result = caseWhereClause(whereClause);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case dtm_sql_viewsPackage.BASE_VIEW_INCORPORATING_DELTAS: {
			...
			case dtm_sql_viewsPackage.DELTA_ACCUMULATION: {
			...
			case dtm_sql_viewsPackage.FILTER_BY_STRUCT_CLASS_COLUMN_VIEW: {
				...
				if (result == null) result = caseSQLView(filterByStructClassColumnView);
				if (result == null) result = caseDataSetTransformation(filterByStructClassColumnView);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case dtm_sql_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW: {
			...
			case dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY: {
				...
				if (result == null) result = caseSQLView(aggregateEnrichmentViewAndOrderBy);
