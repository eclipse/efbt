 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.RenameAsImpl#getFromCube <em>From Cube</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.RenameAsImpl#getFromVariable <em>From Variable</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.RenameAsImpl#getToVariable <em>To Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RenameAsImpl extends MinimalEObjectImpl.Container implements RenameAs {
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.RENAME_AS;
	}
		...
		if (fromCube != null && fromCube.eIsProxy()) {
			...
			if (fromCube != oldFromCube) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.RENAME_AS__FROM_CUBE, oldFromCube, fromCube));
			}
		}
		return fromCube;
	}
	...
	public void setFromCube(FreeBirdToolsCube newFromCube) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.RENAME_AS__FROM_CUBE, oldFromCube, fromCube));
	}
	...
	public VARIABLE getFromVariable() {
		if (fromVariable != null && fromVariable.eIsProxy()) {
			...
			if (fromVariable != oldFromVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.RENAME_AS__FROM_VARIABLE, oldFromVariable, fromVariable));
			}
		}
		return fromVariable;
	}
	...
	public void setFromVariable(VARIABLE newFromVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.RENAME_AS__FROM_VARIABLE, oldFromVariable, fromVariable));
	}
	...
	public VARIABLE getToVariable() {
		if (toVariable != null && toVariable.eIsProxy()) {
			...
			if (toVariable != oldToVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.RENAME_AS__TO_VARIABLE, oldToVariable, toVariable));
			}
		}
		return toVariable;
	}
	...
	public void setToVariable(VARIABLE newToVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.RENAME_AS__TO_VARIABLE, oldToVariable, toVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.RENAME_AS__FROM_CUBE:
				if (resolve) return getFromCube();
				return basicGetFromCube();
			case dtm_viewsPackage.RENAME_AS__FROM_VARIABLE:
				if (resolve) return getFromVariable();
				return basicGetFromVariable();
			case dtm_viewsPackage.RENAME_AS__TO_VARIABLE:
