 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.CastColumnViewImpl#getSourceStructVariable <em>Source Struct Variable</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.CastColumnViewImpl#getTargetStructVariable <em>Target Struct Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CastColumnViewImpl extends DTMViewImpl implements CastColumnView {
	/**
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.CAST_COLUMN_VIEW;
	}
		...
		if (sourceStructVariable != null && sourceStructVariable.eIsProxy()) {
			...
			if (sourceStructVariable != oldSourceStructVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.CAST_COLUMN_VIEW__SOURCE_STRUCT_VARIABLE, oldSourceStructVariable, sourceStructVariable));
			}
		}
	...
	public void setSourceStructVariable(StructTypedVariable newSourceStructVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.CAST_COLUMN_VIEW__SOURCE_STRUCT_VARIABLE, oldSourceStructVariable, sourceStructVariable));
	}
	...
	public StructTypedVariable getTargetStructVariable() {
		if (targetStructVariable != null && targetStructVariable.eIsProxy()) {
			...
			if (targetStructVariable != oldTargetStructVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.CAST_COLUMN_VIEW__TARGET_STRUCT_VARIABLE, oldTargetStructVariable, targetStructVariable));
			}
		}
	...
	public void setTargetStructVariable(StructTypedVariable newTargetStructVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.CAST_COLUMN_VIEW__TARGET_STRUCT_VARIABLE, oldTargetStructVariable, targetStructVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.CAST_COLUMN_VIEW__SOURCE_STRUCT_VARIABLE:
				if (resolve) return getSourceStructVariable();
				return basicGetSourceStructVariable();
			case dtm_viewsPackage.CAST_COLUMN_VIEW__TARGET_STRUCT_VARIABLE:
