 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.MakeStructViewImpl#getTargetVariable <em>Target Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MakeStructViewImpl extends SQLViewImpl implements MakeStructView
{
	/**
	...
	{
		return dtm_sql_viewsPackage.Literals.MAKE_STRUCT_VIEW;
	}
		...
		if (targetVariable != null && targetVariable.eIsProxy()) {
			...
			if (targetVariable != oldTargetVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_sql_viewsPackage.MAKE_STRUCT_VIEW__TARGET_VARIABLE, oldTargetVariable, targetVariable));
			}
		}
	...
	public void setTargetVariable(StructTypedVariable newTargetVariable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.MAKE_STRUCT_VIEW__TARGET_VARIABLE, oldTargetVariable, targetVariable));
	}
	...
	{
		switch (featureID) {
			case dtm_sql_viewsPackage.MAKE_STRUCT_VIEW__TARGET_VARIABLE:
