 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.SelectClauseImpl#getAggregateFunctions <em>Aggregate Functions</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.SelectClauseImpl#getBasicFunctions <em>Basic Functions</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.SelectClauseImpl#getVaraibles <em>Varaibles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectClauseImpl extends MinimalEObjectImpl.Container implements SelectClause {
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.SELECT_CLAUSE;
	}
	...
	public EList<AggregateFunction> getAggregateFunctions() {
		if (aggregateFunctions == null) {
			aggregateFunctions = new EObjectResolvingEList<AggregateFunction>(AggregateFunction.class, this, dtm_viewsPackage.SELECT_CLAUSE__AGGREGATE_FUNCTIONS);
		}
		...
		if (basicFunctions != null && basicFunctions.eIsProxy()) {
			...
			if (basicFunctions != oldBasicFunctions) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.SELECT_CLAUSE__BASIC_FUNCTIONS, oldBasicFunctions, basicFunctions));
			}
		}
	...
	public void setBasicFunctions(BasicFunction newBasicFunctions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.SELECT_CLAUSE__BASIC_FUNCTIONS, oldBasicFunctions, basicFunctions));
	}
	...
	public EList<VARIABLE> getVaraibles() {
		if (varaibles == null) {
			varaibles = new EObjectResolvingEList<VARIABLE>(VARIABLE.class, this, dtm_viewsPackage.SELECT_CLAUSE__VARAIBLES);
		}
		return varaibles;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.SELECT_CLAUSE__AGGREGATE_FUNCTIONS:
				return getAggregateFunctions();
			case dtm_viewsPackage.SELECT_CLAUSE__BASIC_FUNCTIONS:
				if (resolve) return getBasicFunctions();
				return basicGetBasicFunctions();
			case dtm_viewsPackage.SELECT_CLAUSE__VARAIBLES:
				return getVaraibles();
		}
