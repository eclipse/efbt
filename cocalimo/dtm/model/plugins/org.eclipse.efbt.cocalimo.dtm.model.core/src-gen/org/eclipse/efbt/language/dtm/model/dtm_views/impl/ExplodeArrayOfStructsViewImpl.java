 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.ExplodeArrayOfStructsViewImpl#getArraySourceColumn <em>Array Source Column</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.ExplodeArrayOfStructsViewImpl#getIndexColumn <em>Index Column</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.ExplodeArrayOfStructsViewImpl#getTargetStructColumn <em>Target Struct Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplodeArrayOfStructsViewImpl extends DTMViewImpl implements ExplodeArrayOfStructsView {
	/**
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.EXPLODE_ARRAY_OF_STRUCTS_VIEW;
	}
		...
		if (arraySourceColumn != null && arraySourceColumn.eIsProxy()) {
			...
			if (arraySourceColumn != oldArraySourceColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__ARRAY_SOURCE_COLUMN, oldArraySourceColumn, arraySourceColumn));
			}
		}
	...
	public void setArraySourceColumn(ArrayTypedVariable newArraySourceColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__ARRAY_SOURCE_COLUMN, oldArraySourceColumn, arraySourceColumn));
	}
	...
	public VARIABLE getIndexColumn() {
		if (indexColumn != null && indexColumn.eIsProxy()) {
			...
			if (indexColumn != oldIndexColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__INDEX_COLUMN, oldIndexColumn, indexColumn));
			}
		}
		return indexColumn;
	}
	...
	public void setIndexColumn(VARIABLE newIndexColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__INDEX_COLUMN, oldIndexColumn, indexColumn));
	}
	...
	public StructTypedVariable getTargetStructColumn() {
		if (targetStructColumn != null && targetStructColumn.eIsProxy()) {
			...
			if (targetStructColumn != oldTargetStructColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__TARGET_STRUCT_COLUMN, oldTargetStructColumn, targetStructColumn));
			}
		}
	...
	public void setTargetStructColumn(StructTypedVariable newTargetStructColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__TARGET_STRUCT_COLUMN, oldTargetStructColumn, targetStructColumn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__ARRAY_SOURCE_COLUMN:
				if (resolve) return getArraySourceColumn();
				return basicGetArraySourceColumn();
			case dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__INDEX_COLUMN:
				if (resolve) return getIndexColumn();
				return basicGetIndexColumn();
			case dtm_viewsPackage.EXPLODE_ARRAY_OF_STRUCTS_VIEW__TARGET_STRUCT_COLUMN:
