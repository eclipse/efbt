 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.SelectClauseImpl#getAggregateFunctions <em>Aggregate Functions</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.SelectClauseImpl#getBasicFunctions <em>Basic Functions</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.SelectClauseImpl#getVaraibles <em>Varaibles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectClauseImpl extends MinimalEObjectImpl.Container implements SelectClause
{
	...
	{
		return dtm_sql_viewsPackage.Literals.SELECT_CLAUSE;
	}
	...
	public EList<AggregateFunction> getAggregateFunctions()
	{
		if (aggregateFunctions == null) {
			aggregateFunctions = new EObjectResolvingEList<AggregateFunction>(AggregateFunction.class, this, dtm_sql_viewsPackage.SELECT_CLAUSE__AGGREGATE_FUNCTIONS);
		}
		...
		if (basicFunctions != null && basicFunctions.eIsProxy()) {
			...
			if (basicFunctions != oldBasicFunctions) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_sql_viewsPackage.SELECT_CLAUSE__BASIC_FUNCTIONS, oldBasicFunctions, basicFunctions));
			}
		}
	...
	public void setBasicFunctions(BasicFunction newBasicFunctions)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.SELECT_CLAUSE__BASIC_FUNCTIONS, oldBasicFunctions, basicFunctions));
	}
	...
	{
		if (varaibles == null) {
			varaibles = new EObjectResolvingEList<VARIABLE>(VARIABLE.class, this, dtm_sql_viewsPackage.SELECT_CLAUSE__VARAIBLES);
		}
		return varaibles;
	}
	...
	{
		switch (featureID) {
			case dtm_sql_viewsPackage.SELECT_CLAUSE__AGGREGATE_FUNCTIONS:
				return getAggregateFunctions();
			case dtm_sql_viewsPackage.SELECT_CLAUSE__BASIC_FUNCTIONS:
				if (resolve) return getBasicFunctions();
				return basicGetBasicFunctions();
			case dtm_sql_viewsPackage.SELECT_CLAUSE__VARAIBLES:
				return getVaraibles();
		}
