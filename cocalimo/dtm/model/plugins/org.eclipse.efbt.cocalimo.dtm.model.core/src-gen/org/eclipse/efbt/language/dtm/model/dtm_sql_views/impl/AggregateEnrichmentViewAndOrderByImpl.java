 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.AggregateEnrichmentViewAndOrderByImpl#getFunctions <em>Functions</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.AggregateEnrichmentViewAndOrderByImpl#getGroupByClause <em>Group By Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.AggregateEnrichmentViewAndOrderByImpl#getOrderByVariable <em>Order By Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregateEnrichmentViewAndOrderByImpl extends SQLViewImpl implements AggregateEnrichmentViewAndOrderBy
{
	/**
	...
	{
		return dtm_sql_viewsPackage.Literals.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY;
	}
	...
	{
		if (functions == null) {
			functions = new EObjectContainmentEList<AggregateColumnFunction>(AggregateColumnFunction.class, this, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__FUNCTIONS);
		}
		return functions;
	}
	...
	public NotificationChain basicSetGroupByClause(GroupByClause newGroupByClause, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__GROUP_BY_CLAUSE, oldGroupByClause, newGroupByClause);
	...
	public void setGroupByClause(GroupByClause newGroupByClause)
	{
		if (newGroupByClause != groupByClause) {
			...
			if (groupByClause != null)
				msgs = ((InternalEObject)groupByClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__GROUP_BY_CLAUSE, null, msgs);
			if (newGroupByClause != null)
				msgs = ((InternalEObject)newGroupByClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__GROUP_BY_CLAUSE, null, msgs);
			msgs = basicSetGroupByClause(newGroupByClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__GROUP_BY_CLAUSE, newGroupByClause, newGroupByClause));
	}
	...
	public VARIABLE getOrderByVariable()
	{
		if (orderByVariable != null && orderByVariable.eIsProxy()) {
			...
			if (orderByVariable != oldOrderByVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__ORDER_BY_VARIABLE, oldOrderByVariable, orderByVariable));
			}
		}
	...
	public void setOrderByVariable(VARIABLE newOrderByVariable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__ORDER_BY_VARIABLE, oldOrderByVariable, orderByVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__ORDER_BY_VARIABLE:
