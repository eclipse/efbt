 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.AggregateEnrichmentViewImpl#getFunctions <em>Functions</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.AggregateEnrichmentViewImpl#getGroupByClause <em>Group By Clause</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregateEnrichmentViewImpl extends SQLViewImpl implements AggregateEnrichmentView
{
	...
	{
		return dtm_sql_viewsPackage.Literals.AGGREGATE_ENRICHMENT_VIEW;
	}
	...
	{
		if (functions == null) {
			functions = new EObjectContainmentEList<AggregateColumnFunction>(AggregateColumnFunction.class, this, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW__FUNCTIONS);
		}
		return functions;
	}
	...
	public NotificationChain basicSetGroupByClause(GroupByClause newGroupByClause, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW__GROUP_BY_CLAUSE, oldGroupByClause, newGroupByClause);
	...
	public void setGroupByClause(GroupByClause newGroupByClause)
	{
		if (newGroupByClause != groupByClause) {
			...
			if (groupByClause != null)
				msgs = ((InternalEObject)groupByClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW__GROUP_BY_CLAUSE, null, msgs);
			if (newGroupByClause != null)
				msgs = ((InternalEObject)newGroupByClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW__GROUP_BY_CLAUSE, null, msgs);
			msgs = basicSetGroupByClause(newGroupByClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.AGGREGATE_ENRICHMENT_VIEW__GROUP_BY_CLAUSE, newGroupByClause, newGroupByClause));
	}
