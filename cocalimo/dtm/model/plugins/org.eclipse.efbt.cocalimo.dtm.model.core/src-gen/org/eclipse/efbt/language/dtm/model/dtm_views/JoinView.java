 ...
 *
 * <!-- begin-model-doc -->
 * An DTMView which represents a join of  rows of  two source cubes of the associated table,  according to a join condition.
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.JoinView#getWhereClause <em>Where Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.JoinView#getRenames <em>Renames</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.JoinView#getIgnores <em>Ignores</em>}</li>
 * </ul>
 *
 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getJoinView()
 * @model extendedMetaData="name='JoinView' kind='elementOnly'"
 * @generated
 */
public interface JoinView extends DTMView {
	/**
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getJoinView_WhereClause()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.dtm.model.dtm_views.JoinView#getWhereClause <em>Where Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getJoinView_Renames()
	 * @model containment="true"
	 ...
	 * @see org.eclipse.efbt.language.dtm.model.dtm_views.dtm_viewsPackage#getJoinView_Ignores()
	 * @model containment="true"
