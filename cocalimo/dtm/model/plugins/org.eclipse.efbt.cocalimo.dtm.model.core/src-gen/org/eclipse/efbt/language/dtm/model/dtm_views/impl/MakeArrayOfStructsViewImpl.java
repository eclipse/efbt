 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.MakeArrayOfStructsViewImpl#getGroupingVariable <em>Grouping Variable</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.MakeArrayOfStructsViewImpl#getSourceStructVariable <em>Source Struct Variable</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.MakeArrayOfStructsViewImpl#getTargetArrayVariable <em>Target Array Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MakeArrayOfStructsViewImpl extends DTMViewImpl implements MakeArrayOfStructsView {
	/**
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.MAKE_ARRAY_OF_STRUCTS_VIEW;
	}
		...
		if (groupingVariable != null && groupingVariable.eIsProxy()) {
			...
			if (groupingVariable != oldGroupingVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__GROUPING_VARIABLE, oldGroupingVariable, groupingVariable));
			}
		}
	...
	public void setGroupingVariable(VARIABLE newGroupingVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__GROUPING_VARIABLE, oldGroupingVariable, groupingVariable));
	}
	...
	public StructTypedVariable getSourceStructVariable() {
		if (sourceStructVariable != null && sourceStructVariable.eIsProxy()) {
			...
			if (sourceStructVariable != oldSourceStructVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__SOURCE_STRUCT_VARIABLE, oldSourceStructVariable, sourceStructVariable));
			}
		}
	...
	public void setSourceStructVariable(StructTypedVariable newSourceStructVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__SOURCE_STRUCT_VARIABLE, oldSourceStructVariable, sourceStructVariable));
	}
	...
	public ArrayTypedVariable getTargetArrayVariable() {
		if (targetArrayVariable != null && targetArrayVariable.eIsProxy()) {
			...
			if (targetArrayVariable != oldTargetArrayVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__TARGET_ARRAY_VARIABLE, oldTargetArrayVariable, targetArrayVariable));
			}
		}
	...
	public void setTargetArrayVariable(ArrayTypedVariable newTargetArrayVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__TARGET_ARRAY_VARIABLE, oldTargetArrayVariable, targetArrayVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__GROUPING_VARIABLE:
				if (resolve) return getGroupingVariable();
				return basicGetGroupingVariable();
			case dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__SOURCE_STRUCT_VARIABLE:
				if (resolve) return getSourceStructVariable();
				return basicGetSourceStructVariable();
			case dtm_viewsPackage.MAKE_ARRAY_OF_STRUCTS_VIEW__TARGET_ARRAY_VARIABLE:
