 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_views.impl.ExplodeStructViewImpl#getColumnToUnpack <em>Column To Unpack</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplodeStructViewImpl extends DTMViewImpl implements ExplodeStructView {
	/**
	...
	protected EClass eStaticClass() {
		return dtm_viewsPackage.Literals.EXPLODE_STRUCT_VIEW;
	}
		...
		if (columnToUnpack != null && columnToUnpack.eIsProxy()) {
			...
			if (columnToUnpack != oldColumnToUnpack) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_viewsPackage.EXPLODE_STRUCT_VIEW__COLUMN_TO_UNPACK, oldColumnToUnpack, columnToUnpack));
			}
		}
	...
	public void setColumnToUnpack(StructTypedVariable newColumnToUnpack) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_viewsPackage.EXPLODE_STRUCT_VIEW__COLUMN_TO_UNPACK, oldColumnToUnpack, columnToUnpack));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case dtm_viewsPackage.EXPLODE_STRUCT_VIEW__COLUMN_TO_UNPACK:
