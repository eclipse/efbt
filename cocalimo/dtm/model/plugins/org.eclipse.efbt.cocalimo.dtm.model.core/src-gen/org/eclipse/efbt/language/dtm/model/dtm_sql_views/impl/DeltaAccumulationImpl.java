 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.impl.DeltaAccumulationImpl#getUltimateSourceCube <em>Ultimate Source Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeltaAccumulationImpl extends SQLViewImpl implements DeltaAccumulation
{
	/**
	...
	{
		return dtm_sql_viewsPackage.Literals.DELTA_ACCUMULATION;
	}
		...
		if (ultimateSourceCube != null && ultimateSourceCube.eIsProxy()) {
			...
			if (ultimateSourceCube != oldUltimateSourceCube) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, dtm_sql_viewsPackage.DELTA_ACCUMULATION__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
			}
		}
	...
	public void setUltimateSourceCube(FreeBirdToolsCube newUltimateSourceCube)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, dtm_sql_viewsPackage.DELTA_ACCUMULATION__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
	}
	...
	{
		switch (featureID) {
			case dtm_sql_viewsPackage.DELTA_ACCUMULATION__ULTIMATE_SOURCE_CUBE:
