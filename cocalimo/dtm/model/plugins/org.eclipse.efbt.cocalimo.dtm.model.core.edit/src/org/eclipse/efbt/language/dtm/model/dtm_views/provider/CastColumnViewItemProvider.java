...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.language.dtm.model.dtm_views.CastColumnView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CastColumnViewItemProvider extends DTMViewItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_viewsPackage.Literals.CAST_COLUMN_VIEW__SOURCE_STRUCT_VARIABLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_viewsPackage.Literals.CAST_COLUMN_VIEW__TARGET_STRUCT_VARIABLE,
				 true,
				 false,
				 true,
				 null,
