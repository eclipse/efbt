...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.language.dtm.model.dtm_views.AggregateEnrichmentViewAndOrderBy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AggregateEnrichmentViewAndOrderByItemProvider extends DTMViewItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_viewsPackage.Literals.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__ORDER_BY_VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(dtm_viewsPackage.Literals.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__FUNCTIONS);
			childrenFeatures.add(dtm_viewsPackage.Literals.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__GROUP_BY_CLAUSE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(dtm_viewsPackage.Literals.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__FUNCTIONS,
				 FunctionsFactory.eINSTANCE.createAggregateColumnFunction()));

		newChildDescriptors.add
			(createChildParameter
				(dtm_viewsPackage.Literals.AGGREGATE_ENRICHMENT_VIEW_AND_ORDER_BY__GROUP_BY_CLAUSE,
