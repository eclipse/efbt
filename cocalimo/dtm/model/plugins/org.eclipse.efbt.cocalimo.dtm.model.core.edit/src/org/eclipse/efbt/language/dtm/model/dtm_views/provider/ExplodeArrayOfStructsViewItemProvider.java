...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.language.dtm.model.dtm_views.ExplodeArrayOfStructsView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExplodeArrayOfStructsViewItemProvider extends DTMViewItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_viewsPackage.Literals.EXPLODE_ARRAY_OF_STRUCTS_VIEW__ARRAY_SOURCE_COLUMN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_viewsPackage.Literals.EXPLODE_ARRAY_OF_STRUCTS_VIEW__INDEX_COLUMN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_viewsPackage.Literals.EXPLODE_ARRAY_OF_STRUCTS_VIEW__TARGET_STRUCT_COLUMN,
				 true,
				 false,
				 true,
				 null,
