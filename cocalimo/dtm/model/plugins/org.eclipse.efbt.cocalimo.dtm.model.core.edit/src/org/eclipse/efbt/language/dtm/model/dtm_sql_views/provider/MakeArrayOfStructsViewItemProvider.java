...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.language.dtm.model.dtm_sql_views.MakeArrayOfStructsView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MakeArrayOfStructsViewItemProvider extends SQLViewItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_sql_viewsPackage.Literals.MAKE_ARRAY_OF_STRUCTS_VIEW__GROUPING_VARIABLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_sql_viewsPackage.Literals.MAKE_ARRAY_OF_STRUCTS_VIEW__SOURCE_STRUCT_VARIABLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dtm_sql_viewsPackage.Literals.MAKE_ARRAY_OF_STRUCTS_VIEW__TARGET_ARRAY_VARIABLE,
				 true,
				 false,
				 true,
				 null,
