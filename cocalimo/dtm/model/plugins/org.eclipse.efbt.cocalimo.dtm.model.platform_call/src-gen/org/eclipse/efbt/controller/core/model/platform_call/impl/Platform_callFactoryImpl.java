...
public class Platform_callFactoryImpl extends EFactoryImpl implements Platform_callFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Platform_callPackage.PROGRAM_AND_CALLS: return createProgramAndCalls();
			default:
	 ...
	 */
	@Override
	public ProgramAndCalls createProgramAndCalls() {
		ProgramAndCallsImpl programAndCalls = new ProgramAndCallsImpl();
		return programAndCalls;
	}
