...
public class Platform_callSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID) {
			...
			case Platform_callPackage.PROGRAM_AND_CALLS: {
				ProgramAndCalls programAndCalls = (ProgramAndCalls)theEObject;
				T result = caseProgramAndCalls(programAndCalls);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Program And Calls</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Program And Calls</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgramAndCalls(ProgramAndCalls object)
	{
		return null;
	}
