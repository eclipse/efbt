...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.CellsParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CellsParameterItemProvider extends ParameterItemProvider {
	...
	public String getText(Object object) {
		String label = ((CellsParameter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CellsParameter_type") :
			getString("_UI_CellsParameter_type") + " " + label;
	}
