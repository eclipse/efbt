...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.OperationParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationParameterItemProvider extends ParameterItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationParameter_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationParameter_operation_feature", "_UI_OperationParameter_type"),
				 Ecore_plus_logicPackage.Literals.OPERATION_PARAMETER__OPERATION,
				 true,
				 false,
				 true,
				 null,
