 ...
 * </p>
 * <ul>
 *   <li>{@link row_transformation_logic.impl.RowCreationApproachImpl#getDependantCubeColumns <em>Dependant Cube Columns</em>}</li>
 *   <li>{@link row_transformation_logic.impl.RowCreationApproachImpl#getCreatedCubeColumns <em>Created Cube Columns</em>}</li>
 *   <li>{@link row_transformation_logic.impl.RowCreationApproachImpl#getDependantStructItemColumns <em>Dependant Struct Item Columns</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RowCreationApproachImpl extends MinimalEObjectImpl.Container implements RowCreationApproach {
	...
	public EList<EStructuralFeature> getDependantCubeColumns() {
		if (dependantCubeColumns == null) {
			dependantCubeColumns = new EObjectContainmentEList<EStructuralFeature>(EStructuralFeature.class, this, Row_transformation_logicPackage.ROW_CREATION_APPROACH__DEPENDANT_CUBE_COLUMNS);
		}
	...
	public EList<EAttribute> getCreatedCubeColumns() {
		if (createdCubeColumns == null) {
			createdCubeColumns = new EObjectContainmentEList<EAttribute>(EAttribute.class, this, Row_transformation_logicPackage.ROW_CREATION_APPROACH__CREATED_CUBE_COLUMNS);
		}
	...
	public EList<EStructuralFeature> getDependantStructItemColumns() {
		if (dependantStructItemColumns == null) {
			dependantStructItemColumns = new EObjectContainmentEList<EStructuralFeature>(EStructuralFeature.class, this, Row_transformation_logicPackage.ROW_CREATION_APPROACH__DEPENDANT_STRUCT_ITEM_COLUMNS);
		}
