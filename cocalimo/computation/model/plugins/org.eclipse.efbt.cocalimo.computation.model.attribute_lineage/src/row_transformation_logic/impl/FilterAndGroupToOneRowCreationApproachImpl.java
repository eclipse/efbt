 ...
 * </p>
 * <ul>
 *   <li>{@link row_transformation_logic.impl.FilterAndGroupToOneRowCreationApproachImpl#getFilterFunction <em>Filter Function</em>}</li>
 *   <li>{@link row_transformation_logic.impl.FilterAndGroupToOneRowCreationApproachImpl#getGroupByVariables <em>Group By Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FilterAndGroupToOneRowCreationApproachImpl extends RowCreationApproachImpl implements FilterAndGroupToOneRowCreationApproach {
	...
	public EList<EAttribute> getGroupByVariables() {
		if (groupByVariables == null) {
			groupByVariables = new EObjectResolvingEList<EAttribute>(EAttribute.class, this, Row_transformation_logicPackage.FILTER_AND_GROUP_TO_ONE_ROW_CREATION_APPROACH__GROUP_BY_VARIABLES);
		}
