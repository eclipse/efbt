 ...
 * </p>
 * <ul>
 *   <li>{@link row_transformation_logic.FilterRowCreationApproach#getFilterFunction <em>Filter Function</em>}</li>
 * </ul>
 *
 * @see row_transformation_logic.Row_transformation_logicPackage#getFilterRowCreationApproach()
...
public interface FilterRowCreationApproach extends RowCreationApproach {
	 ...
	 * @see row_transformation_logic.Row_transformation_logicPackage#getFilterRowCreationApproach_FilterFunction()
	...
	/**
	 * Sets the value of the '{@link row_transformation_logic.FilterRowCreationApproach#getFilterFunction <em>Filter Function</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
