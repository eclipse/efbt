...
public class EntitiesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EntitiesPackage.BASE_ENTITY: {
			...
			case EntitiesPackage.DERIVED_ENTITY: {
