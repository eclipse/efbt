 ...
 * </p>
 * <ul>
 *   <li>{@link entities.impl.CellImpl#getRow <em>Row</em>}</li>
 *   <li>{@link entities.impl.CellImpl#getColumn <em>Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellImpl extends MinimalEObjectImpl.Container implements Cell {
	...
	protected EClass eStaticClass() {
		return EntitiesPackage.Literals.CELL;
	}
		...
		if (row != null && row.eIsProxy()) {
			...
			if (row != oldRow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntitiesPackage.CELL__ROW, oldRow, row));
			}
		}
		return row;
	}
	...
	public void setRow(EObject newRow) {
		...
		row = newRow;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitiesPackage.CELL__ROW, oldRow, row));
	}
	...
	public EStructuralFeature getColumn() {
		if (column != null && column.eIsProxy()) {
			...
			if (column != oldColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntitiesPackage.CELL__COLUMN, oldColumn, column));
			}
		}
		return column;
	}
	...
	public void setColumn(EStructuralFeature newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitiesPackage.CELL__COLUMN, oldColumn, column));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EntitiesPackage.CELL__ROW:
				if (resolve) return getRow();
				return basicGetRow();
			case EntitiesPackage.CELL__COLUMN:
