 ...
 * <!-- end-model-doc -->
 * @see data_lineage_functions.Data_lineage_functionsFactory
 * @model kind="package"
...
public interface Data_lineage_functionsPackage extends EPackage {
	 ...
	 * @generated
	 */
	Data_lineage_functionsPackage eINSTANCE = data_lineage_functions.impl.Data_lineage_functionsPackageImpl.init();

	/**
	 * The meta object id for the '{@link data_lineage_functions.impl.CellsParameterImpl <em>Cells Parameter</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see data_lineage_functions.impl.CellsParameterImpl
	 * @see data_lineage_functions.impl.Data_lineage_functionsPackageImpl#getCellsParameter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link data_lineage_functions.CellsParameter <em>Cells Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Cells Parameter</em>'.
	 * @see data_lineage_functions.CellsParameter
	 * @generated
	 */
	EClass getCellsParameter();

	/**
	 * Returns the meta object for the reference '{@link data_lineage_functions.CellsParameter#getCells <em>Cells</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Cells</em>'.
	 * @see data_lineage_functions.CellsParameter#getCells()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link data_lineage_functions.impl.CellsParameterImpl <em>Cells Parameter</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see data_lineage_functions.impl.CellsParameterImpl
		 * @see data_lineage_functions.impl.Data_lineage_functionsPackageImpl#getCellsParameter()
