 ...
 * <!-- end-user-doc -->
 * @see data_lineage_functions.Data_lineage_functionsPackage
 * @generated
 */
public class Data_lineage_functionsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Data_lineage_functionsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Data_lineage_functionsPackage.CELLS_PARAMETER: {
