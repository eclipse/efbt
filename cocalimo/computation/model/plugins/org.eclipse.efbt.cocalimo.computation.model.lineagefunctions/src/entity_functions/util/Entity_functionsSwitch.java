 ...
 * @generated
 */
public class Entity_functionsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Entity_functionsPackage modelPackage;
	 ...
	 * @generated
	 */
	public Entity_functionsSwitch() {
		if (modelPackage == null) {
			modelPackage = Entity_functionsPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Entity_functionsPackage.MEMBER_PARAMETER: {
			...
			case Entity_functionsPackage.VALUE_PARAMETER: {
