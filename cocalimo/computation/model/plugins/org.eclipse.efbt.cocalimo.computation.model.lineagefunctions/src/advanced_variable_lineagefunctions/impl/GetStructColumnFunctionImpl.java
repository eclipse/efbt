...
import column_transformation_logic.impl.ColumnFunctionImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link advanced_variable_lineagefunctions.impl.GetStructColumnFunctionImpl#getColumnInStruct <em>Column In Struct</em>}</li>
 *   <li>{@link advanced_variable_lineagefunctions.impl.GetStructColumnFunctionImpl#getCubeColumn <em>Cube Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetStructColumnFunctionImpl extends ColumnFunctionImpl implements GetStructColumnFunction {
	 ...
	 * @ordered
	 */
	protected EAttribute columnInStruct;
	 ...
	 * @generated
	 */
	public EAttribute basicGetColumnInStruct() {
		return columnInStruct;
	}
	 ...
	 * @generated
	 */
	public void setColumnInStruct(EAttribute newColumnInStruct) {
		EAttribute oldColumnInStruct = columnInStruct;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Advanced_variable_lineagefunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__COLUMN_IN_STRUCT:
				setColumnInStruct((EAttribute)newValue);
				return;
			case Advanced_variable_lineagefunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__CUBE_COLUMN:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Advanced_variable_lineagefunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__COLUMN_IN_STRUCT:
				setColumnInStruct((EAttribute)null);
				return;
			case Advanced_variable_lineagefunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__CUBE_COLUMN:
