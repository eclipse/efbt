	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Advanced_variable_lineagefunctionsPackage.GET_STRUCT_COLUMN_FUNCTION: {
				...
				if (result == null) result = caseEStructuralFeature(getStructColumnFunction);
				if (result == null) result = caseETypedElement(getStructColumnFunction);
				if (result == null) result = caseENamedElement(getStructColumnFunction);
				if (result == null) result = caseEModelElement(getStructColumnFunction);
			...
			case Advanced_variable_lineagefunctionsPackage.RESOLVED_STRUCT_COLUMN_PARAMETER: {
				...
				if (result == null) result = caseEParameter(resolvedStructColumnParameter);
				if (result == null) result = caseETypedElement(resolvedStructColumnParameter);
				if (result == null) result = caseENamedElement(resolvedStructColumnParameter);
				if (result == null) result = caseEModelElement(resolvedStructColumnParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
