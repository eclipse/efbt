...
import sql_lite.Column;
import sql_lite.ColumnAsFunction;
import sql_lite.FromClause;
import sql_lite.GeneratedEntitySQL;
import sql_lite.SQLEntity;
import sql_lite.SQLEntityModule;
import sql_lite.SelectClause;
import sql_lite.SelectColumn;
import sql_lite.Sql_liteFactory;
import sql_lite.Sql_litePackage;
import sql_lite.Table;
...
public class Sql_litePackageImpl extends EPackageImpl implements Sql_litePackage {
	 ...
	 * @see sql_lite.Sql_litePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getColumnAsFunction_Column(), theColumn_transformation_logicPackage.getColumnFunction(), null, "column", null, 0, 1, ColumnAsFunction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWhereClause_Where_function(), theFunctionsPackage.getBooleanFunction(), null, "where_function", null, 0, 1, WhereClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tableEClass, Table.class, "Table", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTable_Entity(), theEcorePackage.getEClass(), null, "entity", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGeneratedEntitySQL_GeneratedEntity(), theEntitiesPackage.getGeneratedEntity(), null, "generatedEntity", null, 0, 1, GeneratedEntitySQL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
