 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.BasicOperationImpl#getFunctionSpec <em>Function Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicOperationImpl extends OperationImpl implements BasicOperation {
	/**
	...
	protected EClass eStaticClass() {
		return Ecore_plus_logicPackage.Literals.BASIC_OPERATION;
	}
		...
		if (functionSpec != null && functionSpec.eIsProxy()) {
			...
			if (functionSpec != oldFunctionSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore_plus_logicPackage.BASIC_OPERATION__FUNCTION_SPEC, oldFunctionSpec, functionSpec));
			}
		}
		return functionSpec;
	}
	...
	public void setFunctionSpec(BasicFunctionSpec newFunctionSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.BASIC_OPERATION__FUNCTION_SPEC, oldFunctionSpec, functionSpec));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ecore_plus_logicPackage.BASIC_OPERATION__FUNCTION_SPEC:
