...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Attribute From Entity Derived Feature</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.GetAttributeFromEntityDerivedFeatureImpl#getAttributeInEntity <em>Attribute In Entity</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.GetAttributeFromEntityDerivedFeatureImpl#getEntityFeature <em>Entity Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetAttributeFromEntityDerivedFeatureImpl extends DerivedAttributeImpl implements GetAttributeFromEntityDerivedFeature {
	/**
	 ...
	 * @generated
	 */
	protected GetAttributeFromEntityDerivedFeatureImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ecore_plus_logicPackage.Literals.GET_ATTRIBUTE_FROM_ENTITY_DERIVED_FEATURE;
	}
		...
		if (attributeInEntity != null && attributeInEntity.eIsProxy()) {
			...
			if (attributeInEntity != oldAttributeInEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore_plus_logicPackage.GET_ATTRIBUTE_FROM_ENTITY_DERIVED_FEATURE__ATTRIBUTE_IN_ENTITY, oldAttributeInEntity, attributeInEntity));
			}
		}
	...
	public void setAttributeInEntity(EAttribute newAttributeInEntity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.GET_ATTRIBUTE_FROM_ENTITY_DERIVED_FEATURE__ATTRIBUTE_IN_ENTITY, oldAttributeInEntity, attributeInEntity));
	}
	...
	public EStructuralFeature getEntityFeature() {
		if (entityFeature != null && entityFeature.eIsProxy()) {
			...
			if (entityFeature != oldEntityFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore_plus_logicPackage.GET_ATTRIBUTE_FROM_ENTITY_DERIVED_FEATURE__ENTITY_FEATURE, oldEntityFeature, entityFeature));
			}
		}
	...
	public void setEntityFeature(EStructuralFeature newEntityFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.GET_ATTRIBUTE_FROM_ENTITY_DERIVED_FEATURE__ENTITY_FEATURE, oldEntityFeature, entityFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ecore_plus_logicPackage.GET_ATTRIBUTE_FROM_ENTITY_DERIVED_FEATURE__ATTRIBUTE_IN_ENTITY:
				if (resolve) return getAttributeInEntity();
				return basicGetAttributeInEntity();
			case Ecore_plus_logicPackage.GET_ATTRIBUTE_FROM_ENTITY_DERIVED_FEATURE__ENTITY_FEATURE:
...
} //GetAttributeFromEntityDerivedFeatureImpl
