 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.RowCreationApproachForEntityImpl#getRowCreationApproach <em>Row Creation Approach</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.RowCreationApproachForEntityImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.RowCreationApproachForEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RowCreationApproachForEntityImpl extends MinimalEObjectImpl.Container implements RowCreationApproachForEntity {
	...
	protected EClass eStaticClass() {
		return Ecore_plus_logicPackage.Literals.ROW_CREATION_APPROACH_FOR_ENTITY;
	}
	...
	public NotificationChain basicSetRowCreationApproach(RowCreationApproach newRowCreationApproach, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__ROW_CREATION_APPROACH, oldRowCreationApproach, newRowCreationApproach);
	...
	public void setRowCreationApproach(RowCreationApproach newRowCreationApproach) {
		if (newRowCreationApproach != rowCreationApproach) {
			...
			if (rowCreationApproach != null)
				msgs = ((InternalEObject)rowCreationApproach).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__ROW_CREATION_APPROACH, null, msgs);
			if (newRowCreationApproach != null)
				msgs = ((InternalEObject)newRowCreationApproach).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__ROW_CREATION_APPROACH, null, msgs);
			msgs = basicSetRowCreationApproach(newRowCreationApproach, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__ROW_CREATION_APPROACH, newRowCreationApproach, newRowCreationApproach));
	}
	...
	public EClass getEntity() {
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(EClass newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__ENTITY, oldEntity, entity));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Ecore_plus_logicPackage.ROW_CREATION_APPROACH_FOR_ENTITY__ENTITY:
