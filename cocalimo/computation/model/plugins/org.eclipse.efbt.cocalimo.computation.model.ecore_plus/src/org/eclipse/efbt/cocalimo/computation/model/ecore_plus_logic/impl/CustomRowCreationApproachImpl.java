 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.CustomRowCreationApproachImpl#getDependantVariables <em>Dependant Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomRowCreationApproachImpl extends RowCreationApproachImpl implements CustomRowCreationApproach {
	...
	protected EClass eStaticClass() {
		return Ecore_plus_logicPackage.Literals.CUSTOM_ROW_CREATION_APPROACH;
	}
	...
	public EList<EAttribute> getDependantVariables() {
		if (dependantVariables == null) {
			dependantVariables = new EObjectResolvingEList<EAttribute>(EAttribute.class, this, Ecore_plus_logicPackage.CUSTOM_ROW_CREATION_APPROACH__DEPENDANT_VARIABLES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ecore_plus_logicPackage.CUSTOM_ROW_CREATION_APPROACH__DEPENDANT_VARIABLES:
