...
public class GroupByRowCreationApproachImpl extends RowCreationApproachImpl implements GroupByRowCreationApproach {
	...
	public EList<EAttribute> getGroupByCubeColumnNames() {
		if (groupByCubeColumnNames == null) {
			groupByCubeColumnNames = new EObjectResolvingEList<EAttribute>(EAttribute.class, this, Ecore_plus_logicPackage.GROUP_BY_ROW_CREATION_APPROACH__GROUP_BY_CUBE_COLUMN_NAMES);
		}
		...
		if (groupByColumns != null && groupByColumns.eIsProxy()) {
			...
			if (groupByColumns != oldGroupByColumns) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore_plus_logicPackage.GROUP_BY_ROW_CREATION_APPROACH__GROUP_BY_COLUMNS, oldGroupByColumns, groupByColumns));
			}
		}
	...
	public void setGroupByColumns(EAttribute newGroupByColumns) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.GROUP_BY_ROW_CREATION_APPROACH__GROUP_BY_COLUMNS, oldGroupByColumns, groupByColumns));
	}
