 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.computation.model.ecore_plus_logic.impl.AggregateFunctionImpl#getFunctionSpec <em>Function Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregateFunctionImpl extends FunctionImpl implements AggregateFunction {
	...
	protected EClass eStaticClass() {
		return Ecore_plus_logicPackage.Literals.AGGREGATE_FUNCTION;
	}
		...
		if (functionSpec != null && functionSpec.eIsProxy()) {
			...
			if (functionSpec != oldFunctionSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore_plus_logicPackage.AGGREGATE_FUNCTION__FUNCTION_SPEC, oldFunctionSpec, functionSpec));
			}
		}
		return functionSpec;
	}
	...
	public void setFunctionSpec(AggregateFunctionSpec newFunctionSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore_plus_logicPackage.AGGREGATE_FUNCTION__FUNCTION_SPEC, oldFunctionSpec, functionSpec));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ecore_plus_logicPackage.AGGREGATE_FUNCTION__FUNCTION_SPEC:
