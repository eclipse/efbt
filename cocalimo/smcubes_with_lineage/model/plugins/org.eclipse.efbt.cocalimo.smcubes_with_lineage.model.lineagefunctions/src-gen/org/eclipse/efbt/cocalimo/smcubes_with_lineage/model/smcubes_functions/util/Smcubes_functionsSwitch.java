 ...
 * @generated
 */
public class Smcubes_functionsSwitch<T> extends Switch<T>
{
	/**
	 ...
	 * @generated
	 */
	public Smcubes_functionsSwitch()
	{
	...
	{
		switch (classifierID) {
			case Smcubes_functionsPackage.MEMBER_PARAMETER: {
			...
			case Smcubes_functionsPackage.VALUE_PARAMETER: {
