...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.FunctionSpecModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionSpecModuleItemProvider extends ModuleItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionsPackage.Literals.FUNCTION_SPEC_MODULE__FUNCTION_SPECS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.FUNCTION_SPEC_MODULE__FUNCTION_SPECS,
				 FunctionsFactory.eINSTANCE.createFunctionSpec()));

		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.FUNCTION_SPEC_MODULE__FUNCTION_SPECS,
				 FunctionsFactory.eINSTANCE.createAggregateFunctionSpec()));

		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.FUNCTION_SPEC_MODULE__FUNCTION_SPECS,
				 FunctionsFactory.eINSTANCE.createBasicFunctionSpec()));
	}
