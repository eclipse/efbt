 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.AggregateColumnFunctionImpl#getAggregateFunction <em>Aggregate Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregateColumnFunctionImpl extends ColumnFunctionImpl implements AggregateColumnFunction {
	...
	protected EClass eStaticClass() {
		return FunctionsPackage.Literals.AGGREGATE_COLUMN_FUNCTION;
	}
	...
	public NotificationChain basicSetAggregateFunction(AggregateFunction newAggregateFunction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionsPackage.AGGREGATE_COLUMN_FUNCTION__AGGREGATE_FUNCTION, oldAggregateFunction, newAggregateFunction);
	...
	public void setAggregateFunction(AggregateFunction newAggregateFunction) {
		if (newAggregateFunction != aggregateFunction) {
			...
			if (aggregateFunction != null)
				msgs = ((InternalEObject)aggregateFunction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionsPackage.AGGREGATE_COLUMN_FUNCTION__AGGREGATE_FUNCTION, null, msgs);
			if (newAggregateFunction != null)
				msgs = ((InternalEObject)newAggregateFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionsPackage.AGGREGATE_COLUMN_FUNCTION__AGGREGATE_FUNCTION, null, msgs);
			msgs = basicSetAggregateFunction(newAggregateFunction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.AGGREGATE_COLUMN_FUNCTION__AGGREGATE_FUNCTION, newAggregateFunction, newAggregateFunction));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionsPackage.AGGREGATE_COLUMN_FUNCTION__AGGREGATE_FUNCTION:
