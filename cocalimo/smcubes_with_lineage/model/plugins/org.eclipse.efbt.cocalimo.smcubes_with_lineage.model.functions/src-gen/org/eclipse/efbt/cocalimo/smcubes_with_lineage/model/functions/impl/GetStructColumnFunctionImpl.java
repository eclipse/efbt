 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.GetStructColumnFunctionImpl#getColumnInStruct <em>Column In Struct</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.GetStructColumnFunctionImpl#getCubeColumn <em>Cube Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetStructColumnFunctionImpl extends ColumnFunctionImpl implements GetStructColumnFunction {
	...
	protected EClass eStaticClass() {
		return FunctionsPackage.Literals.GET_STRUCT_COLUMN_FUNCTION;
	}
		...
		if (columnInStruct != null && columnInStruct.eIsProxy()) {
			...
			if (columnInStruct != oldColumnInStruct) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__COLUMN_IN_STRUCT, oldColumnInStruct, columnInStruct));
			}
		}
	...
	public void setColumnInStruct(VARIABLE newColumnInStruct) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__COLUMN_IN_STRUCT, oldColumnInStruct, columnInStruct));
	}
	...
	public CubeColumn getCubeColumn() {
		if (cubeColumn != null && cubeColumn.eIsProxy()) {
			...
			if (cubeColumn != oldCubeColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__CUBE_COLUMN, oldCubeColumn, cubeColumn));
			}
		}
		return cubeColumn;
	}
	...
	public void setCubeColumn(CubeColumn newCubeColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__CUBE_COLUMN, oldCubeColumn, cubeColumn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__COLUMN_IN_STRUCT:
				if (resolve) return getColumnInStruct();
				return basicGetColumnInStruct();
			case FunctionsPackage.GET_STRUCT_COLUMN_FUNCTION__CUBE_COLUMN:
