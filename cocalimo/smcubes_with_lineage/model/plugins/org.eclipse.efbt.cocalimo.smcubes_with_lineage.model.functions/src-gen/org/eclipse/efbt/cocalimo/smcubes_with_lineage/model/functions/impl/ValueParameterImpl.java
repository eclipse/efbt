 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.ValueParameterImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.ValueParameterImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueParameterImpl extends ParameterImpl implements ValueParameter {
	...
	protected EClass eStaticClass() {
		return FunctionsPackage.Literals.VALUE_PARAMETER;
	}
	...
	public void setDataType(FACET_VALUE_TYPE newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.VALUE_PARAMETER__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.VALUE_PARAMETER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionsPackage.VALUE_PARAMETER__DATA_TYPE:
				return getDataType();
			case FunctionsPackage.VALUE_PARAMETER__VALUE:
				return getValue();
		}
