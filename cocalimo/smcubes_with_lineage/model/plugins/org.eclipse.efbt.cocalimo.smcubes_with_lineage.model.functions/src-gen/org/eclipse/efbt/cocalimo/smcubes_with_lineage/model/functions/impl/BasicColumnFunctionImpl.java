 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.BasicColumnFunctionImpl#getBasicFunction <em>Basic Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicColumnFunctionImpl extends ColumnFunctionImpl implements BasicColumnFunction {
	...
	protected EClass eStaticClass() {
		return FunctionsPackage.Literals.BASIC_COLUMN_FUNCTION;
	}
	...
	public NotificationChain basicSetBasicFunction(BasicFunction newBasicFunction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionsPackage.BASIC_COLUMN_FUNCTION__BASIC_FUNCTION, oldBasicFunction, newBasicFunction);
	...
	public void setBasicFunction(BasicFunction newBasicFunction) {
		if (newBasicFunction != basicFunction) {
			...
			if (basicFunction != null)
				msgs = ((InternalEObject)basicFunction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionsPackage.BASIC_COLUMN_FUNCTION__BASIC_FUNCTION, null, msgs);
			if (newBasicFunction != null)
				msgs = ((InternalEObject)newBasicFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionsPackage.BASIC_COLUMN_FUNCTION__BASIC_FUNCTION, null, msgs);
			msgs = basicSetBasicFunction(newBasicFunction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.BASIC_COLUMN_FUNCTION__BASIC_FUNCTION, newBasicFunction, newBasicFunction));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionsPackage.BASIC_COLUMN_FUNCTION__BASIC_FUNCTION:
