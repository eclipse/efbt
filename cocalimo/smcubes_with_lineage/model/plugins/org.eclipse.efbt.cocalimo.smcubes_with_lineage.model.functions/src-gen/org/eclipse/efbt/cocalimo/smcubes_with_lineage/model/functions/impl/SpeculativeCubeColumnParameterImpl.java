 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.SpeculativeCubeColumnParameterImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.functions.impl.SpeculativeCubeColumnParameterImpl#getCube <em>Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpeculativeCubeColumnParameterImpl extends ParameterImpl implements SpeculativeCubeColumnParameter {
	...
	protected EClass eStaticClass() {
		return FunctionsPackage.Literals.SPECULATIVE_CUBE_COLUMN_PARAMETER;
	}
		...
		if (column != null && column.eIsProxy()) {
			...
			if (column != oldColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FunctionsPackage.SPECULATIVE_CUBE_COLUMN_PARAMETER__COLUMN, oldColumn, column));
			}
		}
		return column;
	}
	...
	public void setColumn(VARIABLE newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.SPECULATIVE_CUBE_COLUMN_PARAMETER__COLUMN, oldColumn, column));
	}
	...
	public FreeBirdToolsCube getCube() {
		if (cube != null && cube.eIsProxy()) {
			...
			if (cube != oldCube) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FunctionsPackage.SPECULATIVE_CUBE_COLUMN_PARAMETER__CUBE, oldCube, cube));
			}
		}
		return cube;
	}
	...
	public void setCube(FreeBirdToolsCube newCube) {
		...
		cube = newCube;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionsPackage.SPECULATIVE_CUBE_COLUMN_PARAMETER__CUBE, oldCube, cube));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FunctionsPackage.SPECULATIVE_CUBE_COLUMN_PARAMETER__COLUMN:
				if (resolve) return getColumn();
				return basicGetColumn();
			case FunctionsPackage.SPECULATIVE_CUBE_COLUMN_PARAMETER__CUBE:
