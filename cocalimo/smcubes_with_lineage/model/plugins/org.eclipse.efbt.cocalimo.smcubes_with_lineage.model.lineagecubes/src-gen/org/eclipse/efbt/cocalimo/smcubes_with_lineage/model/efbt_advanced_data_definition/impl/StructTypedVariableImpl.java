...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Struct Typed Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.efbt_advanced_data_definition.impl.StructTypedVariableImpl#getCubeType <em>Cube Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructTypedVariableImpl extends AdvancedTypedVariableImpl implements StructTypedVariable
{
	/**
	 ...
	 * @generated
	 */
	protected StructTypedVariableImpl()
	{
		super();
	}
	...
	{
		return Efbt_advanced_data_definitionPackage.Literals.STRUCT_TYPED_VARIABLE;
	}
		...
		if (cubeType != null && cubeType.eIsProxy()) {
			...
			if (cubeType != oldCubeType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Efbt_advanced_data_definitionPackage.STRUCT_TYPED_VARIABLE__CUBE_TYPE, oldCubeType, cubeType));
			}
		}
		return cubeType;
	}
	...
	public void setCubeType(BaseCube newCubeType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Efbt_advanced_data_definitionPackage.STRUCT_TYPED_VARIABLE__CUBE_TYPE, oldCubeType, cubeType));
	}
	...
	{
		switch (featureID) {
			case Efbt_advanced_data_definitionPackage.STRUCT_TYPED_VARIABLE__CUBE_TYPE:
