...
import org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.cubes.impl.DerivedCubeImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Base View Cube</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes_with_lineage.model.incremental_cubes.impl.BaseViewCubeImpl#getUltimateBaseCube <em>Ultimate Base Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseViewCubeImpl extends DerivedCubeImpl implements BaseViewCube
{
	/**
	...
	{
		return Incremental_cubesPackage.Literals.BASE_VIEW_CUBE;
	}
		...
		if (ultimateBaseCube != null && ultimateBaseCube.eIsProxy()) {
			...
			if (ultimateBaseCube != oldUltimateBaseCube) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Incremental_cubesPackage.BASE_VIEW_CUBE__ULTIMATE_BASE_CUBE, oldUltimateBaseCube, ultimateBaseCube));
			}
		}
	...
	public void setUltimateBaseCube(BaseCube newUltimateBaseCube)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Incremental_cubesPackage.BASE_VIEW_CUBE__ULTIMATE_BASE_CUBE, oldUltimateBaseCube, ultimateBaseCube));
	}
	...
	{
		switch (featureID) {
			case Incremental_cubesPackage.BASE_VIEW_CUBE__ULTIMATE_BASE_CUBE:
