...
public class Cell_transformation_logicPackageImpl extends EPackageImpl implements Cell_transformation_logicPackage
{
	 ...
	 * @generated
	 */
	public EReference getDerivedCubeData_RowCreationApproachForCube()
	{
	...
	{
		return (EReference)derivedCubeDataEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents()
	{
		...
		createEReference(derivedCubeDataEClass, DERIVED_CUBE_DATA__ROW_CREATION_APPROACH_FOR_CUBE);
	...
	public void initializePackageContents()
	{
		...
		initEReference(getDerivedCubeData_RowCreationApproachForCube(), theRow_transformation_logicPackage.getRowCreationApproachForCube(), null, "rowCreationApproachForCube", null, 0, 1, DerivedCubeData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations()
	{
		...
		addAnnotation
		  (getDerivedCubeData_RowCreationApproachForCube(),
		   source,
		   new String[]
		   {
			   "kind", "attribute",
