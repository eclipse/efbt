...
public interface Row_transformation_logicFactory extends EFactory
{
	 ...
	 * @generated
	 */
	Row_transformation_logicFactory eINSTANCE = org.eclipse.efbt.lineage.attributelineage.model.row_transformation_logic.impl.Row_transformation_logicFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Base Row Structure</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Base Row Structure</em>'.
	 * @generated
	 */
	BaseRowStructure createBaseRowStructure();
	...
	/**
	 * Returns a new object of class '<em>Row Creation Approach For Cube</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Row Creation Approach For Cube</em>'.
	 * @generated
	 */
	RowCreationApproachForCube createRowCreationApproachForCube();
