...
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.ExclusiveGateway;
...
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.FlowNode;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.Gateway;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.InclusiveGateway;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.ParallelGateway;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.ScriptTask;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.SequenceFlow;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.ServiceTask;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.SubProcess;
import org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.Task;
...
public class Bpmn_litePackageImpl extends EPackageImpl implements Bpmn_litePackage {
	 ...
	 * @see org.eclipse.efbt.cocalimo.logical_transformations.model.bpmn_lite.Bpmn_litePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getScriptTask_OutputLayer(), theData_meta_modelPackage.getGeneratedEntity(), null, "outputLayer", null, 0, 1, ScriptTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(userTaskEClass, UserTask.class, "UserTask", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUserTask_Entity(), theData_meta_modelPackage.getBasicEntity(), null, "entity", null, 0, 1, UserTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
