...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.logical_transformations.model.logical_transformations.E2ETestScope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Logical_transformationsPackage.Literals.E2E_TEST_SCOPE__SCENARIOS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Logical_transformationsPackage.Literals.E2E_TEST_SCOPE__LAYER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Logical_transformationsPackage.Literals.E2E_TEST_SCOPE__SCRIPT_TASK,
				 true,
				 false,
				 true,
				 null,
