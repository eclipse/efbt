...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.logical_transformations.model.logical_transformations.Test} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Logical_transformationsPackage.Literals.TEST__INPUT_DATA,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Logical_transformationsPackage.Literals.TEST__EXPECTED_RESULT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Logical_transformationsPackage.Literals.TEST__SCOPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Logical_transformationsPackage.Literals.TEST__SCOPE,
				 Logical_transformationsFactory.eINSTANCE.createTestScope()));

		newChildDescriptors.add
			(createChildParameter
				(Logical_transformationsPackage.Literals.TEST__SCOPE,
				 Logical_transformationsFactory.eINSTANCE.createUnitTestScope()));

		newChildDescriptors.add
			(createChildParameter
				(Logical_transformationsPackage.Literals.TEST__SCOPE,
				 Logical_transformationsFactory.eINSTANCE.createE2ETestScope()));
	}
