 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.input_data.impl.CellImpl#getCellID <em>Cell ID</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.input_data.impl.CellImpl#getColumn <em>Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellImpl extends MinimalEObjectImpl.Container implements Cell {
	...
	protected EClass eStaticClass() {
		return Input_dataPackage.Literals.CELL;
	}
	...
	public void setCellID(String newCellID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Input_dataPackage.CELL__CELL_ID, oldCellID, cellID));
	}
	...
	public VARIABLE getColumn() {
		if (column != null && column.eIsProxy()) {
			...
			if (column != oldColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Input_dataPackage.CELL__COLUMN, oldColumn, column));
			}
		}
		return column;
	}
	...
	public void setColumn(VARIABLE newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Input_dataPackage.CELL__COLUMN, oldColumn, column));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Input_dataPackage.CELL__CELL_ID:
				return getCellID();
			case Input_dataPackage.CELL__COLUMN:
