 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.input_data.impl.RowDataImpl#getRowID <em>Row ID</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.input_data.impl.RowDataImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RowDataImpl extends MinimalEObjectImpl.Container implements RowData {
	...
	protected EClass eStaticClass() {
		return Input_dataPackage.Literals.ROW_DATA;
	}
	...
	public void setRowID(String newRowID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Input_dataPackage.ROW_DATA__ROW_ID, oldRowID, rowID));
	}
	...
	public EList<Cell> getCells() {
		if (cells == null) {
			cells = new EObjectContainmentEList<Cell>(Cell.class, this, Input_dataPackage.ROW_DATA__CELLS);
		}
		return cells;
	}
