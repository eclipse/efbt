 ...
 * @generated
 */
public class Column_structured_dataSwitch<T> extends Switch<T>
{
	/**
	 ...
	 * @generated
	 */
	public Column_structured_dataSwitch()
	{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case Column_structured_dataPackage.CELL:
			{
			...
			{
				ColumnStructuredData columnStructuredData = (ColumnStructuredData)theEObject;
				T result = caseColumnStructuredData(columnStructuredData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Column_structured_dataPackage.COLUMN_STRUCTURED_DATA_MODULE:
			{
				ColumnStructuredDataModule columnStructuredDataModule = (ColumnStructuredDataModule)theEObject;
				T result = caseColumnStructuredDataModule(columnStructuredDataModule);
				if (result == null) result = caseModule(columnStructuredDataModule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Column_structured_dataPackage.ROW_DATA:
			{
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Column Structured Data Module</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Column Structured Data Module</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColumnStructuredDataModule(ColumnStructuredDataModule object)
	{
		return null;
	}
