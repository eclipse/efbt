 ...
 * @generated
 */
public class Cocalimo_smcubes_core_extensionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Cocalimo_smcubes_core_extensionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Cocalimo_smcubes_core_extensionPackage.DOMAIN_MODULE: {
			...
			case Cocalimo_smcubes_core_extensionPackage.MEMBER_HIERARCHY_MODULE: {
			...
			case Cocalimo_smcubes_core_extensionPackage.MEMBER_MODULE: {
			...
			case Cocalimo_smcubes_core_extensionPackage.VARIABLE_MODULE: {
			...
			case Cocalimo_smcubes_core_extensionPackage.SUB_DOMAIN_MODULE: {
			...
			case Cocalimo_smcubes_core_extensionPackage.SM_CUBES_CORE_MODEL: {
...
} //Cocalimo_smcubes_core_extensionSwitch
