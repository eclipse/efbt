 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extension.impl.ReportTableModuleImpl#getReportTables <em>Report Tables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportTableModuleImpl extends ModuleImpl implements ReportTableModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extensionPackage.Literals.REPORT_TABLE_MODULE;
	}
	...
	public EList<TABLE> getReportTables() {
		if (reportTables == null) {
			reportTables = new EObjectContainmentEList<TABLE>(TABLE.class, this, Cocalimo_smcubes_extensionPackage.REPORT_TABLE_MODULE__REPORT_TABLES);
		}
		return reportTables;
	}
