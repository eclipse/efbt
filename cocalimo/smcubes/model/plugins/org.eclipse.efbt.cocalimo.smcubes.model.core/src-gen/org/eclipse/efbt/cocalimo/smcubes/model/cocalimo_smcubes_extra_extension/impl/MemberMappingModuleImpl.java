 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.MemberMappingModuleImpl#getMemberMappings <em>Member Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberMappingModuleImpl extends ModuleImpl implements MemberMappingModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extra_extensionPackage.Literals.MEMBER_MAPPING_MODULE;
	}
	...
	public EList<MEMBER_MAPPING> getMemberMappings() {
		if (memberMappings == null) {
			memberMappings = new EObjectContainmentEList<MEMBER_MAPPING>(MEMBER_MAPPING.class, this, Cocalimo_smcubes_extra_extensionPackage.MEMBER_MAPPING_MODULE__MEMBER_MAPPINGS);
		}
