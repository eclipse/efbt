 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extension.impl.ReportCellImpl#getCombination <em>Combination</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extension.impl.ReportCellImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportCellImpl extends MinimalEObjectImpl.Container implements ReportCell {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extensionPackage.Literals.REPORT_CELL;
	}
		...
		if (combination != null && combination.eIsProxy()) {
			...
			if (combination != oldCombination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Cocalimo_smcubes_extensionPackage.REPORT_CELL__COMBINATION, oldCombination, combination));
			}
		}
		return combination;
	}
	...
	public void setCombination(COMBINATION newCombination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cocalimo_smcubes_extensionPackage.REPORT_CELL__COMBINATION, oldCombination, combination));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cocalimo_smcubes_extensionPackage.REPORT_CELL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cocalimo_smcubes_extensionPackage.REPORT_CELL__COMBINATION:
