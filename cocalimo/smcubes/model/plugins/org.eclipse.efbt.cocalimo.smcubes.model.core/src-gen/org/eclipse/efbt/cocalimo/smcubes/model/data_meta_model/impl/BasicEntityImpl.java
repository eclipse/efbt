 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.data_meta_model.impl.BasicEntityImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.data_meta_model.impl.BasicEntityImpl#getSuperClass <em>Super Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicEntityImpl extends EntityImpl implements BasicEntity {
	...
	protected EClass eStaticClass() {
		return Data_meta_modelPackage.Literals.BASIC_ENTITY;
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, Data_meta_modelPackage.BASIC_ENTITY__ATTRIBUTES);
		}
		return attributes;
	}
		...
		if (superClass != null && superClass.eIsProxy()) {
			...
			if (superClass != oldSuperClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Data_meta_modelPackage.BASIC_ENTITY__SUPER_CLASS, oldSuperClass, superClass));
			}
		}
		return superClass;
	}
	...
	public void setSuperClass(BasicEntity newSuperClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data_meta_modelPackage.BASIC_ENTITY__SUPER_CLASS, oldSuperClass, superClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Data_meta_modelPackage.BASIC_ENTITY__SUPER_CLASS:
