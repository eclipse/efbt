...
import org.eclipse.efbt.cocalimo.smcubes.model.data_meta_model.impl.ConceptImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getDomain_id <em>Domain id</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getMaintenance_agency_id <em>Maintenance agency id</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getPrimary_concept <em>Primary concept</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getVariable_id <em>Variable id</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.core.impl.VARIABLEImpl#getDisplayName <em>Display Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VARIABLEImpl extends ConceptImpl implements VARIABLE {
	/**
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__CODE, oldCode, code));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__DESCRIPTION, oldDescription, description));
	}
	...
	public DOMAIN getDomain_id() {
		if (domain_id != null && domain_id.eIsProxy()) {
			...
			if (domain_id != oldDomain_id) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.VARIABLE__DOMAIN_ID, oldDomain_id, domain_id));
			}
		}
		return domain_id;
	}
	...
	public void setDomain_id(DOMAIN newDomain_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__DOMAIN_ID, oldDomain_id, domain_id));
	}
	...
	public MAINTENANCE_AGENCY getMaintenance_agency_id() {
		if (maintenance_agency_id != null && maintenance_agency_id.eIsProxy()) {
			...
			if (maintenance_agency_id != oldMaintenance_agency_id) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.VARIABLE__MAINTENANCE_AGENCY_ID, oldMaintenance_agency_id, maintenance_agency_id));
			}
		}
	...
	public void setMaintenance_agency_id(MAINTENANCE_AGENCY newMaintenance_agency_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__MAINTENANCE_AGENCY_ID, oldMaintenance_agency_id, maintenance_agency_id));
	}
	...
	public void setPrimary_concept(String newPrimary_concept) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__PRIMARY_CONCEPT, oldPrimary_concept, primary_concept));
	}
	...
	public void setVariable_id(String newVariable_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__VARIABLE_ID, oldVariable_id, variable_id));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.VARIABLE__CODE:
				return getCode();
			case CorePackage.VARIABLE__DESCRIPTION:
				return getDescription();
			case CorePackage.VARIABLE__DOMAIN_ID:
				if (resolve) return getDomain_id();
				return basicGetDomain_id();
			case CorePackage.VARIABLE__MAINTENANCE_AGENCY_ID:
				if (resolve) return getMaintenance_agency_id();
				return basicGetMaintenance_agency_id();
			case CorePackage.VARIABLE__PRIMARY_CONCEPT:
				return getPrimary_concept();
			case CorePackage.VARIABLE__VARIABLE_ID:
				return getVariable_id();
			case CorePackage.VARIABLE__NAME:
				return getName();
			case CorePackage.VARIABLE__DISPLAY_NAME:
