 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.CellPositionModuleImpl#getReportTables <em>Report Tables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellPositionModuleImpl extends ModuleImpl implements CellPositionModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extra_extensionPackage.Literals.CELL_POSITION_MODULE;
	}
	...
	public EList<CELL_POSITION> getReportTables() {
		if (reportTables == null) {
			reportTables = new EObjectContainmentEList<CELL_POSITION>(CELL_POSITION.class, this, Cocalimo_smcubes_extra_extensionPackage.CELL_POSITION_MODULE__REPORT_TABLES);
		}
		return reportTables;
	}
