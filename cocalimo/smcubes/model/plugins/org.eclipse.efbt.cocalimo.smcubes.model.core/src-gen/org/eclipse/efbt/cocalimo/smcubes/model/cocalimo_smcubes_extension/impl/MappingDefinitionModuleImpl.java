 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extension.impl.MappingDefinitionModuleImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingDefinitionModuleImpl extends ModuleImpl implements MappingDefinitionModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extensionPackage.Literals.MAPPING_DEFINITION_MODULE;
	}
	...
	public EList<MAPPING_DEFINITION> getMappings() {
		if (mappings == null) {
			mappings = new EObjectContainmentEList<MAPPING_DEFINITION>(MAPPING_DEFINITION.class, this, Cocalimo_smcubes_extensionPackage.MAPPING_DEFINITION_MODULE__MAPPINGS);
		}
		return mappings;
	}
