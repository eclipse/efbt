 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.AxisOrdinateModuleImpl#getAxis_ordinates <em>Axis ordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AxisOrdinateModuleImpl extends ModuleImpl implements AxisOrdinateModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extra_extensionPackage.Literals.AXIS_ORDINATE_MODULE;
	}
	...
	public EList<AXIS_ORDINATE> getAxis_ordinates() {
		if (axis_ordinates == null) {
			axis_ordinates = new EObjectContainmentEList<AXIS_ORDINATE>(AXIS_ORDINATE.class, this, Cocalimo_smcubes_extra_extensionPackage.AXIS_ORDINATE_MODULE__AXIS_ORDINATES);
		}
