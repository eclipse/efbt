 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.CubeMappingModuleImpl#getCubeMappings <em>Cube Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CubeMappingModuleImpl extends ModuleImpl implements CubeMappingModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extra_extensionPackage.Literals.CUBE_MAPPING_MODULE;
	}
	...
	public EList<CUBE_MAPPING> getCubeMappings() {
		if (cubeMappings == null) {
			cubeMappings = new EObjectContainmentEList<CUBE_MAPPING>(CUBE_MAPPING.class, this, Cocalimo_smcubes_extra_extensionPackage.CUBE_MAPPING_MODULE__CUBE_MAPPINGS);
		}
		return cubeMappings;
	}
