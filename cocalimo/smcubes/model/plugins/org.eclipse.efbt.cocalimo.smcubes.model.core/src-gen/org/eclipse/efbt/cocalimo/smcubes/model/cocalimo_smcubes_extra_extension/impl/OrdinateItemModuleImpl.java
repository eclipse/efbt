 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.OrdinateItemModuleImpl#getOrdinateItems <em>Ordinate Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrdinateItemModuleImpl extends ModuleImpl implements OrdinateItemModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extra_extensionPackage.Literals.ORDINATE_ITEM_MODULE;
	}
	...
	public EList<ORDINATE_ITEM> getOrdinateItems() {
		if (ordinateItems == null) {
			ordinateItems = new EObjectContainmentEList<ORDINATE_ITEM>(ORDINATE_ITEM.class, this, Cocalimo_smcubes_extra_extensionPackage.ORDINATE_ITEM_MODULE__ORDINATE_ITEMS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cocalimo_smcubes_extra_extensionPackage.ORDINATE_ITEM_MODULE__ORDINATE_ITEMS:
