 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extension.impl.TableCellModuleImpl#getTableCells <em>Table Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableCellModuleImpl extends ModuleImpl implements TableCellModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extensionPackage.Literals.TABLE_CELL_MODULE;
	}
	...
	public EList<TABLE_CELL> getTableCells() {
		if (tableCells == null) {
			tableCells = new EObjectContainmentEList<TABLE_CELL>(TABLE_CELL.class, this, Cocalimo_smcubes_extensionPackage.TABLE_CELL_MODULE__TABLE_CELLS);
		}
		return tableCells;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cocalimo_smcubes_extensionPackage.TABLE_CELL_MODULE__TABLE_CELLS:
