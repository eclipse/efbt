 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.CubeModuleImpl#getCubes <em>Cubes</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.CubeModuleImpl#getCubeStructures <em>Cube Structures</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extra_extension.impl.CubeModuleImpl#getCubeStructureItems <em>Cube Structure Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CubeModuleImpl extends ModuleImpl implements CubeModule {
	...
	protected EClass eStaticClass() {
		return Cocalimo_smcubes_extra_extensionPackage.Literals.CUBE_MODULE;
	}
	...
	public EList<CUBE> getCubes() {
		if (cubes == null) {
			cubes = new EObjectContainmentEList<CUBE>(CUBE.class, this, Cocalimo_smcubes_extra_extensionPackage.CUBE_MODULE__CUBES);
		}
		return cubes;
	}
	...
	public EList<CUBE_STRUCTURE> getCubeStructures() {
		if (cubeStructures == null) {
			cubeStructures = new EObjectContainmentEList<CUBE_STRUCTURE>(CUBE_STRUCTURE.class, this, Cocalimo_smcubes_extra_extensionPackage.CUBE_MODULE__CUBE_STRUCTURES);
		}
	...
	public EList<CUBE_STRUCTURE_ITEM> getCubeStructureItems() {
		if (cubeStructureItems == null) {
			cubeStructureItems = new EObjectContainmentEList<CUBE_STRUCTURE_ITEM>(CUBE_STRUCTURE_ITEM.class, this, Cocalimo_smcubes_extra_extensionPackage.CUBE_MODULE__CUBE_STRUCTURE_ITEMS);
		}
