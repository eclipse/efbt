...
public class Bpmn_litePackageImpl extends EPackageImpl implements Bpmn_litePackage {
	 ...
	 * @see org.eclipse.efbt.cocalimo.smcubes.model.bpmn_lite.Bpmn_litePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getServiceTask_RequiredAttributes() {
	 ...
	 */
	@Override
	public EReference getServiceTask_ScenarioSet() {
	...
	public void createPackageContents() {
		...
		createEReference(serviceTaskEClass, SERVICE_TASK__REQUIRED_ATTRIBUTES);
		createEReference(serviceTaskEClass, SERVICE_TASK__ENRICHED_ATTRIBUTE);
		createEReference(serviceTaskEClass, SERVICE_TASK__SCENARIO_SET);
	...
	public void initializePackageContents() {
		...
		initEReference(getServiceTask_RequiredAttributes(), theData_definitionPackage.getCUBE_STRUCTURE_ITEM(), null, "requiredAttributes", null, 0, -1, ServiceTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getServiceTask_EnrichedAttribute(), theData_definitionPackage.getCUBE_STRUCTURE_ITEM(), null, "enrichedAttribute", null, 0, 1, ServiceTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getServiceTask_ScenarioSet(), theScenariosPackage.getScenarioSet(), null, "scenarioSet", null, 0, 1, ServiceTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
