 ...
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.aorta_smcubes.impl.AortaSMCubesModelImpl#getRegFunctionalityTestDefinitions <em>Reg Functionality Test Definitions</em>}</li>
...
public class AortaSMCubesModelImpl extends MinimalEObjectImpl.Container implements AortaSMCubesModel {
	 ...
	 * @ordered
	 */
	protected TestDefinitionModule regFunctionalityTestDefinitions;
	 ...
	 */
	@Override
	public TestDefinitionModule getRegFunctionalityTestDefinitions() {
		if (regFunctionalityTestDefinitions != null && regFunctionalityTestDefinitions.eIsProxy()) {
			...
			regFunctionalityTestDefinitions = (TestDefinitionModule)eResolveProxy(oldRegFunctionalityTestDefinitions);
			if (regFunctionalityTestDefinitions != oldRegFunctionalityTestDefinitions) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__REG_FUNCTIONALITY_TEST_DEFINITIONS, oldRegFunctionalityTestDefinitions, regFunctionalityTestDefinitions));
			}
		}
	 ...
	 * @generated
	 */
	public TestDefinitionModule basicGetRegFunctionalityTestDefinitions() {
		return regFunctionalityTestDefinitions;
	}
	 ...
	 */
	@Override
	public void setRegFunctionalityTestDefinitions(TestDefinitionModule newRegFunctionalityTestDefinitions) {
		TestDefinitionModule oldRegFunctionalityTestDefinitions = regFunctionalityTestDefinitions;
		regFunctionalityTestDefinitions = newRegFunctionalityTestDefinitions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__REG_FUNCTIONALITY_TEST_DEFINITIONS, oldRegFunctionalityTestDefinitions, regFunctionalityTestDefinitions));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__REG_FUNCTIONALITY_TEST_DEFINITIONS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__TASK_MODULES:
				...
				return;
			case Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__REG_FUNCTIONALITY_TEST_DEFINITIONS:
				setRegFunctionalityTestDefinitions((TestDefinitionModule)newValue);
				return;
			case Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__NAME:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__TASK_MODULES:
				...
				return;
			case Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__REG_FUNCTIONALITY_TEST_DEFINITIONS:
				setRegFunctionalityTestDefinitions((TestDefinitionModule)null);
				return;
			case Aorta_smcubesPackage.AORTA_SM_CUBES_MODEL__NAME:
