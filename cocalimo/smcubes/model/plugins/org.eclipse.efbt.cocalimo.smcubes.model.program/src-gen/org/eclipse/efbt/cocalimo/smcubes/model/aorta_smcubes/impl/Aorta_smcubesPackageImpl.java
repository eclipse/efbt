...
public class Aorta_smcubesPackageImpl extends EPackageImpl implements Aorta_smcubesPackage {
	 ...
	 */
	@Override
	public EReference getAortaSMCubesModel_RegFunctionalityTestDefinitions() {
	...
	public void createPackageContents() {
		...
		createEReference(aortaSMCubesModelEClass, AORTA_SM_CUBES_MODEL__REG_FUNCTIONALITY_TEST_DEFINITIONS);
	...
	public void initializePackageContents() {
		...
		initEReference(getAortaSMCubesModel_RegFunctionalityTestDefinitions(), this.getTestDefinitionModule(), null, "regFunctionalityTestDefinitions", null, 0, 1, AortaSMCubesModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
