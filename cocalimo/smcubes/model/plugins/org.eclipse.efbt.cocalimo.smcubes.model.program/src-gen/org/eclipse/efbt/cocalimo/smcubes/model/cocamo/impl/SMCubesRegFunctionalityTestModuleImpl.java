 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.cocamo.impl.SMCubesRegFunctionalityTestModuleImpl#getRegFunctionalityTests <em>Reg Functionality Tests</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SMCubesRegFunctionalityTestModuleImpl extends TestModuleImpl implements SMCubesRegFunctionalityTestModule
{
	...
	{
		return CocamoPackage.Literals.SM_CUBES_REG_FUNCTIONALITY_TEST_MODULE;
	}
	...
	public EList<SMCubesRegFunctionalityTest> getRegFunctionalityTests()
	{
		if (regFunctionalityTests == null) {
			regFunctionalityTests = new EObjectContainmentEList<SMCubesRegFunctionalityTest>(SMCubesRegFunctionalityTest.class, this, CocamoPackage.SM_CUBES_REG_FUNCTIONALITY_TEST_MODULE__REG_FUNCTIONALITY_TESTS);
		}
