 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.program.impl.SMCubesBDDTestImpl#getInputData <em>Input Data</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.program.impl.SMCubesBDDTestImpl#getExpectedResults <em>Expected Results</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SMCubesBDDTestImpl extends BDDTestImpl implements SMCubesBDDTest {
	...
	protected EClass eStaticClass() {
		return ProgramPackage.Literals.SM_CUBES_BDD_TEST;
	}
	...
	public NotificationChain basicSetInputData(SMCubesTestInputData newInputData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProgramPackage.SM_CUBES_BDD_TEST__INPUT_DATA, oldInputData, newInputData);
	...
	public void setInputData(SMCubesTestInputData newInputData) {
		if (newInputData != inputData) {
			...
			if (inputData != null)
				msgs = ((InternalEObject)inputData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProgramPackage.SM_CUBES_BDD_TEST__INPUT_DATA, null, msgs);
			if (newInputData != null)
				msgs = ((InternalEObject)newInputData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProgramPackage.SM_CUBES_BDD_TEST__INPUT_DATA, null, msgs);
			msgs = basicSetInputData(newInputData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProgramPackage.SM_CUBES_BDD_TEST__INPUT_DATA, newInputData, newInputData));
	}
	...
	public NotificationChain basicSetExpectedResults(SMCubesReportResults newExpectedResults, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProgramPackage.SM_CUBES_BDD_TEST__EXPECTED_RESULTS, oldExpectedResults, newExpectedResults);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExpectedResults(SMCubesReportResults newExpectedResults) {
		if (newExpectedResults != expectedResults) {
			...
			if (expectedResults != null)
				msgs = ((InternalEObject)expectedResults).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProgramPackage.SM_CUBES_BDD_TEST__EXPECTED_RESULTS, null, msgs);
			if (newExpectedResults != null)
				msgs = ((InternalEObject)newExpectedResults).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProgramPackage.SM_CUBES_BDD_TEST__EXPECTED_RESULTS, null, msgs);
			msgs = basicSetExpectedResults(newExpectedResults, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProgramPackage.SM_CUBES_BDD_TEST__EXPECTED_RESULTS, newExpectedResults, newExpectedResults));
	}
