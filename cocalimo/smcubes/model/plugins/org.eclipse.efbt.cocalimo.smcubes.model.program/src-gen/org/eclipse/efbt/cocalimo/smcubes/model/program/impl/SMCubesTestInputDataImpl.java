 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.program.impl.SMCubesTestInputDataImpl#getSmcubes_inputdata <em>Smcubes inputdata</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SMCubesTestInputDataImpl extends TestInputDataImpl implements SMCubesTestInputData {
	...
	protected EClass eStaticClass() {
		return ProgramPackage.Literals.SM_CUBES_TEST_INPUT_DATA;
	}
	...
	public EList<BaseColumnStructuredData> getSmcubes_inputdata() {
		if (smcubes_inputdata == null) {
			smcubes_inputdata = new EObjectContainmentEList<BaseColumnStructuredData>(BaseColumnStructuredData.class, this, ProgramPackage.SM_CUBES_TEST_INPUT_DATA__SMCUBES_INPUTDATA);
		}
