...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes.model.efbt_data_definition.CubeModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CubeModuleItemProvider extends ModuleItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Efbt_data_definitionPackage.Literals.CUBE_MODULE__CUBES);
			childrenFeatures.add(Efbt_data_definitionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURES);
			childrenFeatures.add(Efbt_data_definitionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURE_ITEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Efbt_data_definitionPackage.Literals.CUBE_MODULE__CUBES,
				 Data_definitionFactory.eINSTANCE.createCUBE()));

		newChildDescriptors.add
			(createChildParameter
				(Efbt_data_definitionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURES,
				 Data_definitionFactory.eINSTANCE.createCUBE_STRUCTURE()));

		newChildDescriptors.add
			(createChildParameter
				(Efbt_data_definitionPackage.Literals.CUBE_MODULE__CUBE_STRUCTURE_ITEMS,
