...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes.model.vtl_transformation.TRANSFORMATION} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TRANSFORMATIONItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTransformation_idPropertyDescriptor(object);
	 ...
	 * @generated
	 */
	protected void addTransformation_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TRANSFORMATION_transformation_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TRANSFORMATION_transformation_id_feature", "_UI_TRANSFORMATION_type"),
				 Vtl_transformationPackage.Literals.TRANSFORMATION__TRANSFORMATION_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Vtl_transformationPackage.Literals.TRANSFORMATION__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TRANSFORMATION_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TRANSFORMATION_expression_feature", "_UI_TRANSFORMATION_type"),
				 Vtl_transformationPackage.Literals.TRANSFORMATION__EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Vtl_transformationPackage.Literals.TRANSFORMATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Vtl_transformationPackage.Literals.TRANSFORMATION__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMaintenance_agency_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TRANSFORMATION_maintenance_agency_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TRANSFORMATION_maintenance_agency_id_feature", "_UI_TRANSFORMATION_type"),
				 Vtl_transformationPackage.Literals.TRANSFORMATION__MAINTENANCE_AGENCY_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDisplayNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TRANSFORMATION_displayName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TRANSFORMATION_displayName_feature", "_UI_TRANSFORMATION_type"),
				 Vtl_transformationPackage.Literals.TRANSFORMATION__DISPLAY_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
