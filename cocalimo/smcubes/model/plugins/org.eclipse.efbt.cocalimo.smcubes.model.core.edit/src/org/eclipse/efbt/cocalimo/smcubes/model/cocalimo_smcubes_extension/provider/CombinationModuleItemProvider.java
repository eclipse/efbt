...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes.model.cocalimo_smcubes_extension.CombinationModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CombinationModuleItemProvider extends ModuleItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Cocalimo_smcubes_extensionPackage.Literals.COMBINATION_MODULE__COMBINATIONS);
			childrenFeatures.add(Cocalimo_smcubes_extensionPackage.Literals.COMBINATION_MODULE__COMBINATION_ITEMS);
			childrenFeatures.add(Cocalimo_smcubes_extensionPackage.Literals.COMBINATION_MODULE__CUBE_TO_COMBINATION_LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Cocalimo_smcubes_extensionPackage.Literals.COMBINATION_MODULE__COMBINATIONS,
				 Data_definitionFactory.eINSTANCE.createCOMBINATION()));

		newChildDescriptors.add
			(createChildParameter
				(Cocalimo_smcubes_extensionPackage.Literals.COMBINATION_MODULE__COMBINATION_ITEMS,
				 Data_definitionFactory.eINSTANCE.createCOMBINATION_ITEM()));

		newChildDescriptors.add
			(createChildParameter
				(Cocalimo_smcubes_extensionPackage.Literals.COMBINATION_MODULE__CUBE_TO_COMBINATION_LINKS,
