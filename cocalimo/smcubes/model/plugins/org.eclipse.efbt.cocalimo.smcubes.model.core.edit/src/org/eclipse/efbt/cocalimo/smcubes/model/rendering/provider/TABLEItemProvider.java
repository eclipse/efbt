/**
 */
package org.eclipse.efbt.cocalimo.smcubes.model.rendering.provider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes.model.rendering.TABLE} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_code_feature", "_UI_TABLE_type"),
				 RenderingPackage.Literals.TABLE__CODE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RenderingPackage.Literals.TABLE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMaintenance_agency_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_maintenance_agency_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_maintenance_agency_id_feature", "_UI_TABLE_type"),
				 RenderingPackage.Literals.TABLE__MAINTENANCE_AGENCY_ID,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RenderingPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTable_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_table_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_table_id_feature", "_UI_TABLE_type"),
				 RenderingPackage.Literals.TABLE__TABLE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValid_fromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_valid_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_valid_from_feature", "_UI_TABLE_type"),
				 RenderingPackage.Literals.TABLE__VALID_FROM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValid_toPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_valid_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_valid_to_feature", "_UI_TABLE_type"),
				 RenderingPackage.Literals.TABLE__VALID_TO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_version_feature", "_UI_TABLE_type"),
				 RenderingPackage.Literals.TABLE__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
