...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes.model.data_definition.FRAMEWORK} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FRAMEWORK_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FRAMEWORK_code_feature", "_UI_FRAMEWORK_type"),
				 Data_definitionPackage.Literals.FRAMEWORK__CODE,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FRAMEWORK_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FRAMEWORK_description_feature", "_UI_FRAMEWORK_type"),
				 Data_definitionPackage.Literals.FRAMEWORK__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFramework_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FRAMEWORK_framework_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FRAMEWORK_framework_id_feature", "_UI_FRAMEWORK_type"),
				 Data_definitionPackage.Literals.FRAMEWORK__FRAMEWORK_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMaintenance_agency_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FRAMEWORK_maintenance_agency_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FRAMEWORK_maintenance_agency_id_feature", "_UI_FRAMEWORK_type"),
				 Data_definitionPackage.Literals.FRAMEWORK__MAINTENANCE_AGENCY_ID,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FRAMEWORK_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FRAMEWORK_name_feature", "_UI_FRAMEWORK_type"),
				 Data_definitionPackage.Literals.FRAMEWORK__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
