 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.testing.impl.InputDataImpl#getSourceCubeData <em>Source Cube Data</em>}</li>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.testing.impl.InputDataImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputDataImpl extends MinimalEObjectImpl.Container implements InputData {
	...
	protected EClass eStaticClass() {
		return TestingPackage.Literals.INPUT_DATA;
	}
	...
	public EList<CubeData> getSourceCubeData() {
		if (sourceCubeData == null) {
			sourceCubeData = new EObjectContainmentEList<CubeData>(CubeData.class, this, TestingPackage.INPUT_DATA__SOURCE_CUBE_DATA);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.INPUT_DATA__NAME, oldName, name));
	}
