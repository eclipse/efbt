 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.cocalimo.smcubes.model.testing.impl.CellWithEnumeratedValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellWithEnumeratedValueImpl extends CellImpl implements CellWithEnumeratedValue {
	...
	protected EClass eStaticClass() {
		return TestingPackage.Literals.CELL_WITH_ENUMERATED_VALUE;
	}
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestingPackage.CELL_WITH_ENUMERATED_VALUE__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(MEMBER newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.CELL_WITH_ENUMERATED_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestingPackage.CELL_WITH_ENUMERATED_VALUE__VALUE:
