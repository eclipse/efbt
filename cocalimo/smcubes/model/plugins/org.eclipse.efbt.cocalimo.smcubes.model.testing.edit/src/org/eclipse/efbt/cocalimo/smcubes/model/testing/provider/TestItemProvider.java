...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes.model.testing.Test} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReportResultsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Report Results feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReportResultsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Test_reportResults_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Test_reportResults_feature", "_UI_Test_type"),
				 TestingPackage.Literals.TEST__REPORT_RESULTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addScenarioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Test_scenario_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Test_scenario_feature", "_UI_Test_type"),
				 TestingPackage.Literals.TEST__SCENARIO,
				 true,
				 false,
				 true,
				 null,
