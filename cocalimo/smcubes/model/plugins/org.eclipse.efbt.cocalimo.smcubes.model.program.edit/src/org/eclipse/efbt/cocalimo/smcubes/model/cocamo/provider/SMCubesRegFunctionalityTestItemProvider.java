...
/**
 * This is the item provider adapter for a {@link org.eclipse.efbt.cocalimo.smcubes.model.cocamo.SMCubesRegFunctionalityTest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SMCubesRegFunctionalityTestItemProvider extends RegFunctionalityTestItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SMCubesRegFunctionalityTest_expectedResults_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SMCubesRegFunctionalityTest_expectedResults_feature", "_UI_SMCubesRegFunctionalityTest_type"),
				 CocamoPackage.Literals.SM_CUBES_REG_FUNCTIONALITY_TEST__EXPECTED_RESULTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CocamoPackage.Literals.SM_CUBES_REG_FUNCTIONALITY_TEST__INPUT_DATA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CocamoPackage.Literals.SM_CUBES_REG_FUNCTIONALITY_TEST__INPUT_DATA,
