...
public class Column_transformation_logicAdapterFactory extends AdapterFactoryImpl
{
	...
	protected Column_transformation_logicSwitch<Adapter> modelSwitch =
		new Column_transformation_logicSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseStandardBasicColumnFunction(StandardBasicColumnFunction object)
			{
				return createStandardBasicColumnFunctionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.lineage.common.model.column_transformation_logic.StandardBasicColumnFunction <em>Standard Basic Column Function</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStandardBasicColumnFunctionAdapter()
	{
		return null;
	}
