 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.lineage.common.model.lineagefunctions.impl.MemberParameterImpl#getParam <em>Param</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberParameterImpl extends ParameterImpl implements MemberParameter
{
	...
	{
		return LineagefunctionsPackage.Literals.MEMBER_PARAMETER;
	}
		...
		if (param != null && param.eIsProxy())
		{
			...
			if (param != oldParam)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LineagefunctionsPackage.MEMBER_PARAMETER__PARAM, oldParam, param));
			}
		}
		return param;
	}
	...
	public void setParam(MEMBER newParam)
	{
		...
		param = newParam;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LineagefunctionsPackage.MEMBER_PARAMETER__PARAM, oldParam, param));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case LineagefunctionsPackage.MEMBER_PARAMETER__PARAM:
