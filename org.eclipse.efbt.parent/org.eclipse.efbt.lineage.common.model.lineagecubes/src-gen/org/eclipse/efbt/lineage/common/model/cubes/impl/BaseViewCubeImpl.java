/**
 */
package org.eclipse.efbt.lineage.common.model.cubes.impl;

import org.eclipse.efbt.lineage.common.model.cubes.BaseViewCube;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.lineage.common.model.cubes.impl.BaseViewCubeImpl#getUltimateBaseCube <em>Ultimate Base Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseViewCubeImpl extends DerivedCubeImpl implements BaseViewCube
{
	...
	{
		return CubesPackage.Literals.BASE_VIEW_CUBE;
	}
		...
		if (ultimateBaseCube != null && ultimateBaseCube.eIsProxy())
		{
			...
			if (ultimateBaseCube != oldUltimateBaseCube)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CubesPackage.BASE_VIEW_CUBE__ULTIMATE_BASE_CUBE, oldUltimateBaseCube, ultimateBaseCube));
			}
		}
	...
	public void setUltimateBaseCube(FreeBirdToolsCube newUltimateBaseCube)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CubesPackage.BASE_VIEW_CUBE__ULTIMATE_BASE_CUBE, oldUltimateBaseCube, ultimateBaseCube));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case CubesPackage.BASE_VIEW_CUBE__ULTIMATE_BASE_CUBE:
