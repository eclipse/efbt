 ...
 */
public class ESONWithChirpmodelInjectorProvider extends EFactoryInjectorProvider {
	...
	protected Injector internalCreateInjector() {
        ...
        if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/chirp_program")) {
