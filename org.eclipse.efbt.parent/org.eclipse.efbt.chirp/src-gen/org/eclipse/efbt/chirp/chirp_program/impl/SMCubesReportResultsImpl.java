...
import org.eclipse.efbt.testing.common.model.test.impl.ResultImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.chirp.chirp_program.impl.SMCubesReportResultsImpl#getReportCells <em>Report Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SMCubesReportResultsImpl extends ResultImpl implements SMCubesReportResults
{
	...
	{
		return Chirp_programPackage.Literals.SM_CUBES_REPORT_RESULTS;
	}
	...
	public EList<ReportCellValue> getReportCells()
	{
		if (reportCells == null)
		{
			reportCells = new EObjectContainmentEList<ReportCellValue>(ReportCellValue.class, this, Chirp_programPackage.SM_CUBES_REPORT_RESULTS__REPORT_CELLS);
		}
		return reportCells;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Chirp_programPackage.SM_CUBES_REPORT_RESULTS__REPORT_CELLS:
