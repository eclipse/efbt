...
import org.eclipse.efbt.clan.model.clan.SMCubesTestInputData;
...
/**
 * InputDataExporter is responsible for exporting the input data of clan tests
...
public class InputDataExporter {
	...
	/**
	 * Given an clan Program model instance, this method exports the input test
