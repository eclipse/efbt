...
import org.eclipse.efbt.data_structures.smcubes.model.data_definition.CUBE_RELATIONSHIP;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getCube_relationship_id <em>Cube relationship id</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#isEstablishes_integrity <em>Establishes integrity</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getForeign_cube_id <em>Foreign cube id</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getForeign_cube_variable_code <em>Foreign cube variable code</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getMaintenance_agency_id <em>Maintenance agency id</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getPrimary_cube_id <em>Primary cube id</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getPrimary_cube_variable_id <em>Primary cube variable id</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getValid_from <em>Valid from</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getValid_to <em>Valid to</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.CUBE_RELATIONSHIPImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
