/**
 */
package org.eclipse.efbt.data_structures.smcubes.model.efbt_mapping.util;

import org.eclipse.efbt.data_structures.smcubes.model.efbt_mapping.*;
...
public class Efbt_mappingAdapterFactory extends AdapterFactoryImpl
{
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.data_structures.smcubes.model.efbt_mapping.MappingDefinitionModule <em>Mapping Definition Module</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.data_structures.smcubes.model.efbt_mapping.CubeMappingModule <em>Cube Mapping Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.data_structures.smcubes.model.efbt_mapping.MemberMappingModule <em>Member Mapping Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.efbt.data_structures.smcubes.model.efbt_mapping.VariableMappingModule <em>Variable Mapping Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
