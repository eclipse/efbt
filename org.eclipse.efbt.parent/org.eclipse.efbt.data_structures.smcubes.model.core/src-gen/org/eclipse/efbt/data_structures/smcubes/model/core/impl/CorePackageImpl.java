...
import org.eclipse.efbt.data_structures.smcubes.model.data_definition.impl.Data_definitionPackageImpl;
...
public class CorePackageImpl extends EPackageImpl implements CorePackage
{
	 ...
	 * @see org.eclipse.efbt.data_structures.smcubes.model.core.CorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents()
	{
		...
		initEClass(domainEClass, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, "DOMAIN", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDOMAIN_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDOMAIN_Data_type(), this.getFACET_VALUE_TYPE(), "data_type", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDOMAIN_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDOMAIN_Domain_id(), ecorePackage.getEString(), "domain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDOMAIN_Facet_id(), this.getFACET_COLLECTION(), null, "facet_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDOMAIN_Is_enumerated(), ecorePackage.getEBoolean(), "is_enumerated", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDOMAIN_Is_reference(), ecorePackage.getEBoolean(), "is_reference", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDOMAIN_Maintenance_agency_id(), this.getMAINTENANCE_AGENCY(), null, "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDOMAIN_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.DOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(faceT_COLLECTIONEClass, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_COLLECTION.class, "FACET_COLLECTION", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFACET_COLLECTION_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_COLLECTION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFACET_COLLECTION_Facet_id(), ecorePackage.getEString(), "facet_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_COLLECTION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFACET_COLLECTION_Facet_value_type(), this.getFACET_VALUE_TYPE(), "facet_value_type", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_COLLECTION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFACET_COLLECTION_Maintenance_agency_id(), this.getFACET_COLLECTION(), null, "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_COLLECTION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFACET_COLLECTION_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_COLLECTION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(faceT_ENUMERATIONEClass, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_ENUMERATION.class, "FACET_ENUMERATION", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFACET_ENUMERATION_Facet_id(), this.getFACET_COLLECTION(), null, "facet_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFACET_ENUMERATION_Facet_type(), this.getfacet_type(), null, "facet_type", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFACET_ENUMERATION_Observation_value(), ecorePackage.getEString(), "observation_value", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(maintenancE_AGENCYEClass, org.eclipse.efbt.data_structures.smcubes.model.core.MAINTENANCE_AGENCY.class, "MAINTENANCE_AGENCY", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMAINTENANCE_AGENCY_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MAINTENANCE_AGENCY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMAINTENANCE_AGENCY_Maintenance_agency_id(), ecorePackage.getEString(), "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MAINTENANCE_AGENCY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMAINTENANCE_AGENCY_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MAINTENANCE_AGENCY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(memberEClass, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER.class, "MEMBER", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMEMBER_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_Domain_id(), this.getDOMAIN(), null, "domain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_Maintenance_agency_id(), this.getMAINTENANCE_AGENCY(), null, "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_Member_id(), ecorePackage.getEString(), "member_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(membeR_HIERARCHYEClass, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY.class, "MEMBER_HIERARCHY", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMEMBER_HIERARCHY_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_HIERARCHY_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_HIERARCHY_Domain_id(), this.getDOMAIN(), null, "domain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMEMBER_HIERARCHY_Member_hierarchy_id(), ecorePackage.getEString(), "member_hierarchy_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_HIERARCHY_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(membeR_HIERARCHY_NODEEClass, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, "MEMBER_HIERARCHY_NODE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMEMBER_HIERARCHY_NODE_Comparator(), ecorePackage.getEString(), "comparator", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_HIERARCHY_NODE_Level(), ecorePackage.getEInt(), "level", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_HIERARCHY_NODE_Member_hierarchy_id(), this.getMEMBER_HIERARCHY(), null, "member_hierarchy_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_HIERARCHY_NODE_Member_id(), this.getMEMBER(), null, "member_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_HIERARCHY_NODE_Operator(), ecorePackage.getEString(), "operator", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMEMBER_HIERARCHY_NODE_Parent_member_id(), this.getMEMBER(), null, "parent_member_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_HIERARCHY_NODE_Valid_from(), ecorePackage.getEDate(), "valid_from", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMEMBER_HIERARCHY_NODE_Valid_to(), ecorePackage.getEDate(), "valid_to", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.MEMBER_HIERARCHY_NODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(subdomainEClass, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, "SUBDOMAIN", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSUBDOMAIN_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSUBDOMAIN_Domain_id(), this.getDOMAIN(), null, "domain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSUBDOMAIN_Facet_id(), this.getFACET_COLLECTION(), null, "facet_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_Is_listed(), ecorePackage.getEBoolean(), "is_listed", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_Is_natural(), ecorePackage.getEBoolean(), "is_natural", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSUBDOMAIN_Maintenance_agency_id(), this.getMAINTENANCE_AGENCY(), null, "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_Subdomain_id(), ecorePackage.getEString(), "subdomain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(subdomaiN_ENUMERATIONEClass, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN_ENUMERATION.class, "SUBDOMAIN_ENUMERATION", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSUBDOMAIN_ENUMERATION_Member_id(), this.getMEMBER(), null, "member_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_ENUMERATION_Order(), ecorePackage.getEInt(), "order", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSUBDOMAIN_ENUMERATION_Subdomain_id(), this.getSUBDOMAIN(), null, "subdomain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_ENUMERATION_Valid_from(), ecorePackage.getEDate(), "valid_from", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSUBDOMAIN_ENUMERATION_Valid_to(), ecorePackage.getEDate(), "valid_to", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.SUBDOMAIN_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variableEClass, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, "VARIABLE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVARIABLE_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_Domain_id(), this.getDOMAIN(), null, "domain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_Maintenance_agency_id(), this.getMAINTENANCE_AGENCY(), null, "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_Primary_concept(), ecorePackage.getEString(), "primary_concept", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_Variable_id(), ecorePackage.getEString(), "variable_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variablE_SETEClass, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET.class, "VARIABLE_SET", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVARIABLE_SET_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_SET_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_SET_Maintenance_agency_id(), this.getMAINTENANCE_AGENCY(), null, "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_SET_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_SET_Variable_set_id(), ecorePackage.getEString(), "variable_set_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variablE_SET_ENUMERATIONEClass, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, "VARIABLE_SET_ENUMERATION", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVARIABLE_SET_ENUMERATION_Is_flow(), ecorePackage.getEBoolean(), "is_flow", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_SET_ENUMERATION_Order(), ecorePackage.getEInt(), "order", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_SET_ENUMERATION_Subdomain_id(), this.getSUBDOMAIN(), null, "subdomain_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_SET_ENUMERATION_Valid_from(), ecorePackage.getEDate(), "valid_from", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVARIABLE_SET_ENUMERATION_Valid_to(), ecorePackage.getEDate(), "valid_to", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_SET_ENUMERATION_Variable_id(), this.getVARIABLE(), null, "variable_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVARIABLE_SET_ENUMERATION_Variable_set_id(), this.getVARIABLE_SET(), null, "variable_set_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.core.VARIABLE_SET_ENUMERATION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.class, "FACET_VALUE_TYPE");
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.BIG_INTEGER);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.BOOLEAN);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.DATE_TIME);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.DAY_MONTH_DAY_MONTH);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.DECIMAL);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.DOUBLE);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.DURATION);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.FLOAT);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.GREGORIAN_DAY);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.GREGORIAN_MONTH);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.GREGORIAN_YEAR);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.INTEGER);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.LONG);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.SHORT);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.STRING);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.TIME);
		addEEnumLiteral(faceT_VALUE_TYPEEEnum, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.URI);

		// Initialize data types
		initEDataType(faceT_VALUE_TYPEObjectEDataType, org.eclipse.efbt.data_structures.smcubes.model.core.FACET_VALUE_TYPE.class, "FACET_VALUE_TYPEObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations()
	{
		...
		addAnnotation
		  (getSUBDOMAIN_ENUMERATION_Subdomain_id(),
		   source,
		   new String[]
		   {
			   "kind", "attribute",
