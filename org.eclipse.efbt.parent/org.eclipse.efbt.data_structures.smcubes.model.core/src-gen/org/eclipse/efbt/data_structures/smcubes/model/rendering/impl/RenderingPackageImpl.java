...
import org.eclipse.efbt.data_structures.smcubes.model.rendering.RenderingFactory;
...
public class RenderingPackageImpl extends EPackageImpl implements RenderingPackage
{
	 ...
	 * @see org.eclipse.efbt.data_structures.smcubes.model.rendering.RenderingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents()
	{
		...
		initEClass(axisEClass, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, "AXIS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAXIS_Axis_id(), ecorePackage.getEString(), "axis_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_Is_open_axis(), ecorePackage.getEBooleanObject(), "is_open_axis", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_Order(), ecorePackage.getEInt(), "order", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_Orientation(), ecorePackage.getEString(), "orientation", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAXIS_Table_id(), this.getTABLE(), null, "table_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(axiS_ORDINATEEClass, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, "AXIS_ORDINATE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAXIS_ORDINATE_Axis_id(), this.getAXIS(), null, "axis_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Axis_ordinate_id(), ecorePackage.getEString(), "axis_ordinate_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Is_abstract_header(), ecorePackage.getEBooleanObject(), "is_abstract_header", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Level(), ecorePackage.getEInt(), "level", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Order(), ecorePackage.getEInt(), "order", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAXIS_ORDINATE_Parent_axis_ordinate_id(), this.getAXIS_ORDINATE(), null, "parent_axis_ordinate_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAXIS_ORDINATE_Path(), ecorePackage.getEString(), "path", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.AXIS_ORDINATE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(celL_POSITIONEClass, org.eclipse.efbt.data_structures.smcubes.model.rendering.CELL_POSITION.class, "CELL_POSITION", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCELL_POSITION_Axis_ordinate_id(), this.getAXIS_ORDINATE(), null, "axis_ordinate_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.CELL_POSITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCELL_POSITION_Cell_id(), this.getTABLE_CELL(), null, "cell_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.CELL_POSITION.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(ordinatE_ITEMEClass, org.eclipse.efbt.data_structures.smcubes.model.rendering.ORDINATE_ITEM.class, "ORDINATE_ITEM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getORDINATE_ITEM_Axis_ordinate_id(), this.getAXIS_ORDINATE(), null, "axis_ordinate_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.ORDINATE_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getORDINATE_ITEM_Is_starting_member_included(), ecorePackage.getEBooleanObject(), "is_starting_member_included", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.ORDINATE_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getORDINATE_ITEM_Member_hierarchy_id(), theCorePackage.getMEMBER_HIERARCHY(), null, "member_hierarchy_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.ORDINATE_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getORDINATE_ITEM_Member_id(), theCorePackage.getMEMBER(), null, "member_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.ORDINATE_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getORDINATE_ITEM_Starting_member_id(), theCorePackage.getMEMBER(), null, "starting_member_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.ORDINATE_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getORDINATE_ITEM_Variable_id(), theCorePackage.getVARIABLE(), null, "variable_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.ORDINATE_ITEM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tableEClass, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, "TABLE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTABLE_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTABLE_Description(), ecorePackage.getEString(), "description", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTABLE_Maintenance_agency_id(), theCorePackage.getMAINTENANCE_AGENCY(), null, "maintenance_agency_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTABLE_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTABLE_Table_id(), ecorePackage.getEString(), "table_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTABLE_Valid_from(), ecorePackage.getEDate(), "valid_from", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTABLE_Valid_to(), ecorePackage.getEDate(), "valid_to", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTABLE_Version(), ecorePackage.getEString(), "version", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tablE_CELLEClass, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE_CELL.class, "TABLE_CELL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTABLE_CELL_Cell_id(), ecorePackage.getEString(), "cell_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE_CELL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTABLE_CELL_Combination_id(), theData_definitionPackage.getCOMBINATION(), null, "combination_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE_CELL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTABLE_CELL_Is_shaded(), ecorePackage.getEBooleanObject(), "is_shaded", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE_CELL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTABLE_CELL_Table_id(), this.getTABLE(), null, "table_id", null, 0, 1, org.eclipse.efbt.data_structures.smcubes.model.rendering.TABLE_CELL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
