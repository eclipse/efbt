 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.core.impl.FACET_COLLECTIONImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.core.impl.FACET_COLLECTIONImpl#getFacet_id <em>Facet id</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.core.impl.FACET_COLLECTIONImpl#getFacet_value_type <em>Facet value type</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.core.impl.FACET_COLLECTIONImpl#getMaintenance_agency_id <em>Maintenance agency id</em>}</li>
 *   <li>{@link org.eclipse.efbt.data_structures.smcubes.model.core.impl.FACET_COLLECTIONImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FACET_COLLECTIONImpl extends MinimalEObjectImpl.Container implements FACET_COLLECTION
{
	 ...
	 * @ordered
	 */
	protected FACET_COLLECTION maintenance_agency_id;
	 ...
	 */
	@Override
	public FACET_COLLECTION getMaintenance_agency_id()
	{
		if (maintenance_agency_id != null && maintenance_agency_id.eIsProxy())
		{
			...
			maintenance_agency_id = (FACET_COLLECTION)eResolveProxy(oldMaintenance_agency_id);
	 ...
	 * @generated
	 */
	public FACET_COLLECTION basicGetMaintenance_agency_id()
	{
		return maintenance_agency_id;
	}
	 ...
	 */
	@Override
	public void setMaintenance_agency_id(FACET_COLLECTION newMaintenance_agency_id)
	{
		FACET_COLLECTION oldMaintenance_agency_id = maintenance_agency_id;
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case CorePackage.FACET_COLLECTION__FACET_VALUE_TYPE:
				...
				return;
			case CorePackage.FACET_COLLECTION__MAINTENANCE_AGENCY_ID:
				setMaintenance_agency_id((FACET_COLLECTION)newValue);
				return;
			case CorePackage.FACET_COLLECTION__NAME:
	...
	public void eUnset(int featureID)
	{
		switch (featureID)
		{
			...
			case CorePackage.FACET_COLLECTION__FACET_VALUE_TYPE:
				...
				return;
			case CorePackage.FACET_COLLECTION__MAINTENANCE_AGENCY_ID:
				setMaintenance_agency_id((FACET_COLLECTION)null);
				return;
			case CorePackage.FACET_COLLECTION__NAME:
