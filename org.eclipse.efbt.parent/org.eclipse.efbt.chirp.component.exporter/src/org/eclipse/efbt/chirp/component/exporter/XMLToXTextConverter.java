...
package org.eclipse.efbt.chirp.component.exporter;
 ...
 * the Chirp XText grammar.
 * 
 * Note that the Chirp XText grammar is generated from the Ecore model
...
public class XMLToXTextConverter {
	...
	public void convertXMLToXtext(String inputpath, String outputPath) throws IOException {
		...
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/chirp_program", Chirp_programPackage.eINSTANCE);
		...
		ChirpStandaloneSetup setup = new ChirpStandaloneSetup();
		...
		URI domainsProgramURI = URI.createFileURI(
				inputpath + "domains.chirp_program");
		URI inputDataStructuresProgramURI = URI.createFileURI(
				inputpath + "inputDataStructures.chirp_program");
