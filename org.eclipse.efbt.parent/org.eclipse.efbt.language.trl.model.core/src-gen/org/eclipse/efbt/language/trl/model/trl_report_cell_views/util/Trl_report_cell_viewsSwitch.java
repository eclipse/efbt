 ...
 * @generated
 */
public class Trl_report_cell_viewsSwitch<T> extends Switch<T>
{
	/**
	 ...
	 * @generated
	 */
	public Trl_report_cell_viewsSwitch()
	{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case Trl_report_cell_viewsPackage.REPORT_CELL_VIEW:
			{
			...
			case Trl_report_cell_viewsPackage.REPORT_CELL_VIEW_MODULE:
			{
				ReportCellViewModule reportCellViewModule = (ReportCellViewModule)theEObject;
				T result = caseReportCellViewModule(reportCellViewModule);
				if (result == null) result = caseModule(reportCellViewModule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Report Cell View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Report Cell View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReportCellView(ReportCellView object)
	{
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Report Cell View Module</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Report Cell View Module</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReportCellViewModule(ReportCellViewModule object)
	{
		return null;
	}
