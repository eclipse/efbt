 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.transformation.impl.VersionedComponentsSetImpl#getCubeSchemaModules <em>Cube Schema Modules</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.transformation.impl.VersionedComponentsSetImpl#getDatasetTransformationModules <em>Dataset Transformation Modules</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.transformation.impl.VersionedComponentsSetImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.transformation.impl.VersionedComponentsSetImpl#getReportCellViewModules <em>Report Cell View Modules</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.transformation.impl.VersionedComponentsSetImpl#getLicense <em>License</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionedComponentsSetImpl extends MinimalEObjectImpl.Container implements VersionedComponentsSet
{
	 ...
	 * @ordered
	 */
	protected EList<VersionedFunctionalModuleLogic> datasetTransformationModules;
	 ...
	 */
	@Override
	public EList<VersionedFunctionalModuleLogic> getDatasetTransformationModules()
	{
		if (datasetTransformationModules == null)
		{
			datasetTransformationModules = new EObjectResolvingEList<VersionedFunctionalModuleLogic>(VersionedFunctionalModuleLogic.class, this, TransformationPackage.VERSIONED_COMPONENTS_SET__DATASET_TRANSFORMATION_MODULES);
		}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case TransformationPackage.VERSIONED_COMPONENTS_SET__DATASET_TRANSFORMATION_MODULES:
				...
				getDatasetTransformationModules().addAll((Collection<? extends VersionedFunctionalModuleLogic>)newValue);
				return;
			case TransformationPackage.VERSIONED_COMPONENTS_SET__NAME:
