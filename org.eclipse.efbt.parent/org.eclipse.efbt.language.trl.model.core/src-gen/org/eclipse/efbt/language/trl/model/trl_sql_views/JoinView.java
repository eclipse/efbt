 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.JoinView#getWhereClause <em>Where Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.JoinView#getRenames <em>Renames</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.JoinView#getIgnores <em>Ignores</em>}</li>
 * </ul>
 *
 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getJoinView()
...
public interface JoinView extends SQLView
{
	 ...
	 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getJoinView_WhereClause()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.trl.model.trl_sql_views.JoinView#getWhereClause <em>Where Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getJoinView_Renames()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link org.eclipse.efbt.language.trl.model.trl_sql_views.IgnoreColumn}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getJoinView_Ignores()
	 * @model containment="true"
