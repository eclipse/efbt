 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.DeltaAccumulationImpl#getUltimateSourceCube <em>Ultimate Source Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeltaAccumulationImpl extends SQLViewImpl implements DeltaAccumulation
{
	...
	{
		return Trl_sql_viewsPackage.Literals.DELTA_ACCUMULATION;
	}
		...
		if (ultimateSourceCube != null && ultimateSourceCube.eIsProxy())
		{
			...
			if (ultimateSourceCube != oldUltimateSourceCube)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Trl_sql_viewsPackage.DELTA_ACCUMULATION__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
			}
		}
	...
	public void setUltimateSourceCube(FreeBirdToolsCube newUltimateSourceCube)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.DELTA_ACCUMULATION__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Trl_sql_viewsPackage.DELTA_ACCUMULATION__ULTIMATE_SOURCE_CUBE:
