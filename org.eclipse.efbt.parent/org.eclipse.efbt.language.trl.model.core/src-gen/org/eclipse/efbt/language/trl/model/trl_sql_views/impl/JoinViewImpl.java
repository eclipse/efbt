 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.JoinViewImpl#getWhereClause <em>Where Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.JoinViewImpl#getRenames <em>Renames</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.JoinViewImpl#getIgnores <em>Ignores</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinViewImpl extends SQLViewImpl implements JoinView
{
	...
	{
		return Trl_sql_viewsPackage.Literals.JOIN_VIEW;
	}
	...
	public NotificationChain basicSetWhereClause(WhereClause newWhereClause, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, oldWhereClause, newWhereClause);
	...
	public void setWhereClause(WhereClause newWhereClause)
	{
		if (newWhereClause != whereClause)
		{
			...
			if (whereClause != null)
				msgs = ((InternalEObject)whereClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, null, msgs);
			if (newWhereClause != null)
				msgs = ((InternalEObject)newWhereClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, null, msgs);
			msgs = basicSetWhereClause(newWhereClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE, newWhereClause, newWhereClause));
	}
	...
	public EList<RenameAs> getRenames()
	{
		if (renames == null)
		{
			renames = new EObjectContainmentEList<RenameAs>(RenameAs.class, this, Trl_sql_viewsPackage.JOIN_VIEW__RENAMES);
		}
		return renames;
	}
	...
	public EList<IgnoreColumn> getIgnores()
	{
		if (ignores == null)
		{
			ignores = new EObjectContainmentEList<IgnoreColumn>(IgnoreColumn.class, this, Trl_sql_viewsPackage.JOIN_VIEW__IGNORES);
		}
		return ignores;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Trl_sql_viewsPackage.JOIN_VIEW__WHERE_CLAUSE:
				return basicSetWhereClause(null, msgs);
			case Trl_sql_viewsPackage.JOIN_VIEW__RENAMES:
				return ((InternalEList<?>)getRenames()).basicRemove(otherEnd, msgs);
			case Trl_sql_viewsPackage.JOIN_VIEW__IGNORES:
