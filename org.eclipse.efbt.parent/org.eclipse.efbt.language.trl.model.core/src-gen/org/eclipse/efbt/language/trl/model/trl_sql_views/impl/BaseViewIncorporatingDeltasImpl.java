 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.BaseViewIncorporatingDeltasImpl#getUltimateSourceCube <em>Ultimate Source Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseViewIncorporatingDeltasImpl extends SQLViewImpl implements BaseViewIncorporatingDeltas
{
	...
	{
		return Trl_sql_viewsPackage.Literals.BASE_VIEW_INCORPORATING_DELTAS;
	}
		...
		if (ultimateSourceCube != null && ultimateSourceCube.eIsProxy())
		{
			...
			if (ultimateSourceCube != oldUltimateSourceCube)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Trl_sql_viewsPackage.BASE_VIEW_INCORPORATING_DELTAS__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
			}
		}
	...
	public void setUltimateSourceCube(FreeBirdToolsCube newUltimateSourceCube)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.BASE_VIEW_INCORPORATING_DELTAS__ULTIMATE_SOURCE_CUBE, oldUltimateSourceCube, ultimateSourceCube));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Trl_sql_viewsPackage.BASE_VIEW_INCORPORATING_DELTAS__ULTIMATE_SOURCE_CUBE:
