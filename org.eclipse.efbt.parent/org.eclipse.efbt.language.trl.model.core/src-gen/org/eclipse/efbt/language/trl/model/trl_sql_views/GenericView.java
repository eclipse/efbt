 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.GenericView#getSelectClause <em>Select Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.GenericView#getWhereClause <em>Where Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.GenericView#getGroupByClause <em>Group By Clause</em>}</li>
 * </ul>
 *
 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getGenericView()
...
public interface GenericView extends SQLView
{
	 ...
	 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getGenericView_SelectClause()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.trl.model.trl_sql_views.GenericView#getSelectClause <em>Select Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getGenericView_WhereClause()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.trl.model.trl_sql_views.GenericView#getWhereClause <em>Where Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.efbt.language.trl.model.trl_sql_views.Trl_sql_viewsPackage#getGenericView_GroupByClause()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.efbt.language.trl.model.trl_sql_views.GenericView#getGroupByClause <em>Group By Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
