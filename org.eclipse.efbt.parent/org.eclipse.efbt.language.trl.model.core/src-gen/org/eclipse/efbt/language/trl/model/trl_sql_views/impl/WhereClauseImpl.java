 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.WhereClauseImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhereClauseImpl extends MinimalEObjectImpl.Container implements WhereClause
{
	...
	{
		return Trl_sql_viewsPackage.Literals.WHERE_CLAUSE;
	}
	...
	public NotificationChain basicSetFunction(BooleanFunction newFunction, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.WHERE_CLAUSE__FUNCTION, oldFunction, newFunction);
	...
	public void setFunction(BooleanFunction newFunction)
	{
		if (newFunction != function)
		{
			...
			if (function != null)
				msgs = ((InternalEObject)function).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.WHERE_CLAUSE__FUNCTION, null, msgs);
			if (newFunction != null)
				msgs = ((InternalEObject)newFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.WHERE_CLAUSE__FUNCTION, null, msgs);
			msgs = basicSetFunction(newFunction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.WHERE_CLAUSE__FUNCTION, newFunction, newFunction));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Trl_sql_viewsPackage.WHERE_CLAUSE__FUNCTION:
