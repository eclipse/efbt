 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.IgnoreColumnImpl#getColumnToIgnore <em>Column To Ignore</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.IgnoreColumnImpl#getCube <em>Cube</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IgnoreColumnImpl extends MinimalEObjectImpl.Container implements IgnoreColumn
{
	...
	{
		return Trl_sql_viewsPackage.Literals.IGNORE_COLUMN;
	}
		...
		if (columnToIgnore != null && columnToIgnore.eIsProxy())
		{
			...
			if (columnToIgnore != oldColumnToIgnore)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Trl_sql_viewsPackage.IGNORE_COLUMN__COLUMN_TO_IGNORE, oldColumnToIgnore, columnToIgnore));
			}
		}
	...
	public void setColumnToIgnore(VARIABLE newColumnToIgnore)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.IGNORE_COLUMN__COLUMN_TO_IGNORE, oldColumnToIgnore, columnToIgnore));
	}
	...
	public FreeBirdToolsCube getCube()
	{
		if (cube != null && cube.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Trl_sql_viewsPackage.IGNORE_COLUMN__CUBE, oldCube, cube));
			}
		}
		return cube;
	}
	...
	public void setCube(FreeBirdToolsCube newCube)
	{
		...
		cube = newCube;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.IGNORE_COLUMN__CUBE, oldCube, cube));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Trl_sql_viewsPackage.IGNORE_COLUMN__COLUMN_TO_IGNORE:
				if (resolve) return getColumnToIgnore();
				return basicGetColumnToIgnore();
			case Trl_sql_viewsPackage.IGNORE_COLUMN__CUBE:
