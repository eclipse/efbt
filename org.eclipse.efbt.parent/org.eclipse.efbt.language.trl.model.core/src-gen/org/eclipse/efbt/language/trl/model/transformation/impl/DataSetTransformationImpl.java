...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Set Transformation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.transformation.impl.DataSetTransformationImpl#getCube <em>Cube</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.transformation.impl.DataSetTransformationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataSetTransformationImpl extends MinimalEObjectImpl.Container implements DataSetTransformation
{
		...
		if (cube != null && cube.eIsProxy())
		{
			...
			if (cube != oldCube)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TransformationPackage.DATA_SET_TRANSFORMATION__CUBE, oldCube, cube));
			}
		}
		return cube;
	}
	...
	public void setCube(DerivedCube newCube)
	{
		...
		cube = newCube;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.DATA_SET_TRANSFORMATION__CUBE, oldCube, cube));
	}
	...
	public void setName(String newName)
	{
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.DATA_SET_TRANSFORMATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case TransformationPackage.DATA_SET_TRANSFORMATION__CUBE:
				...
				return basicGetCube();
			case TransformationPackage.DATA_SET_TRANSFORMATION__NAME:
				return getName();
		}
