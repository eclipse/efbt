 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.GenericViewImpl#getSelectClause <em>Select Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.GenericViewImpl#getWhereClause <em>Where Clause</em>}</li>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.GenericViewImpl#getGroupByClause <em>Group By Clause</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenericViewImpl extends SQLViewImpl implements GenericView
{
	...
	{
		return Trl_sql_viewsPackage.Literals.GENERIC_VIEW;
	}
	...
	public NotificationChain basicSetSelectClause(SelectClause newSelectClause, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.GENERIC_VIEW__SELECT_CLAUSE, oldSelectClause, newSelectClause);
	...
	public void setSelectClause(SelectClause newSelectClause)
	{
		if (newSelectClause != selectClause)
		{
			...
			if (selectClause != null)
				msgs = ((InternalEObject)selectClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.GENERIC_VIEW__SELECT_CLAUSE, null, msgs);
			if (newSelectClause != null)
				msgs = ((InternalEObject)newSelectClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.GENERIC_VIEW__SELECT_CLAUSE, null, msgs);
			msgs = basicSetSelectClause(newSelectClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.GENERIC_VIEW__SELECT_CLAUSE, newSelectClause, newSelectClause));
	}
	...
	public NotificationChain basicSetWhereClause(WhereClause newWhereClause, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.GENERIC_VIEW__WHERE_CLAUSE, oldWhereClause, newWhereClause);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWhereClause(WhereClause newWhereClause)
	{
		if (newWhereClause != whereClause)
		{
			NotificationChain msgs = null;
			if (whereClause != null)
				msgs = ((InternalEObject)whereClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.GENERIC_VIEW__WHERE_CLAUSE, null, msgs);
			if (newWhereClause != null)
				msgs = ((InternalEObject)newWhereClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.GENERIC_VIEW__WHERE_CLAUSE, null, msgs);
			msgs = basicSetWhereClause(newWhereClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.GENERIC_VIEW__WHERE_CLAUSE, newWhereClause, newWhereClause));
	}
	...
	public NotificationChain basicSetGroupByClause(GroupByClause newGroupByClause, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.GENERIC_VIEW__GROUP_BY_CLAUSE, oldGroupByClause, newGroupByClause);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGroupByClause(GroupByClause newGroupByClause)
	{
		if (newGroupByClause != groupByClause)
		{
			...
			if (groupByClause != null)
				msgs = ((InternalEObject)groupByClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.GENERIC_VIEW__GROUP_BY_CLAUSE, null, msgs);
			if (newGroupByClause != null)
				msgs = ((InternalEObject)newGroupByClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Trl_sql_viewsPackage.GENERIC_VIEW__GROUP_BY_CLAUSE, null, msgs);
			msgs = basicSetGroupByClause(newGroupByClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.GENERIC_VIEW__GROUP_BY_CLAUSE, newGroupByClause, newGroupByClause));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Trl_sql_viewsPackage.GENERIC_VIEW__SELECT_CLAUSE:
				return basicSetSelectClause(null, msgs);
			case Trl_sql_viewsPackage.GENERIC_VIEW__WHERE_CLAUSE:
				return basicSetWhereClause(null, msgs);
			case Trl_sql_viewsPackage.GENERIC_VIEW__GROUP_BY_CLAUSE:
