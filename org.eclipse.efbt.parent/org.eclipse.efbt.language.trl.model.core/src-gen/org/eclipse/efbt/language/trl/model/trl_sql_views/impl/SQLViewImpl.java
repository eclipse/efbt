...
import org.eclipse.efbt.language.trl.model.transformation.impl.DataSetTransformationImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.language.trl.model.trl_sql_views.impl.SQLViewImpl#getVTL_Code <em>VTL Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SQLViewImpl extends DataSetTransformationImpl implements SQLView
{
	...
	{
		return Trl_sql_viewsPackage.Literals.SQL_VIEW;
	}
	...
	public void setVTL_Code(String newVTL_Code)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Trl_sql_viewsPackage.SQL_VIEW__VTL_CODE, oldVTL_Code, vtL_Code));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Trl_sql_viewsPackage.SQL_VIEW__VTL_CODE:
				return getVTL_Code();
		}
