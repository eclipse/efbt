...
rm -rf bird/birdseed_creator/results/generations_transformations_csv/ae_generation_rules_ldm/*
rm -rf bird/birdseed_creator/results/generations_transformations_csv/finrep_generation_rules_ldm/*
rm -rf bird/birdseed_creator/results/regdna/ae_generation_rules_ldm/*
rm -rf bird/birdseed_creator/results/regdna/finrep_generation_rules_ldm/*
