...
from birdseed_creator.src.entry_points.sddmodel_to_datamodel_finrep_il import RunSDDModelToDataModelFinrepIL 
...
class GenerateGenerationRulesFinrepIL:
...
if __name__ == '__main__':
    ...
    RunSDDModelToDataModelFinrepIL().run(context,sdd_context)
    GenerateGenerationRulesFinrepIL().run(context,sdd_context)
