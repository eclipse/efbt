 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.regdna.model.regdna.impl.RequirementsSectionLinkWithTextImpl#getLinkedRuleSection <em>Linked Rule Section</em>}</li>
 *   <li>{@link org.eclipse.efbt.regdna.model.regdna.impl.RequirementsSectionLinkWithTextImpl#getLinkText <em>Link Text</em>}</li>
 *   <li>{@link org.eclipse.efbt.regdna.model.regdna.impl.RequirementsSectionLinkWithTextImpl#getSubsection <em>Subsection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementsSectionLinkWithTextImpl extends RequirementsSectionImpl implements RequirementsSectionLinkWithText {
	...
	protected EClass eStaticClass() {
		return regdnaPackage.eINSTANCE.getRequirementsSectionLinkWithText();
	}
		...
		if (linkedRuleSection != null && linkedRuleSection.eIsProxy()) {
			...
			if (linkedRuleSection != oldLinkedRuleSection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, oldLinkedRuleSection, linkedRuleSection));
			}
		}
	...
	public NotificationChain basicSetLinkedRuleSection(TitledRequirementsSection newLinkedRuleSection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, oldLinkedRuleSection, newLinkedRuleSection);
	...
	public void setLinkedRuleSection(TitledRequirementsSection newLinkedRuleSection) {
		if (newLinkedRuleSection != linkedRuleSection) {
			...
			if (linkedRuleSection != null)
				msgs = ((InternalEObject)linkedRuleSection).eInverseRemove(this, regdnaPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, TitledRequirementsSection.class, msgs);
			if (newLinkedRuleSection != null)
				msgs = ((InternalEObject)newLinkedRuleSection).eInverseAdd(this, regdnaPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, TitledRequirementsSection.class, msgs);
			msgs = basicSetLinkedRuleSection(newLinkedRuleSection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, newLinkedRuleSection, newLinkedRuleSection));
	}
	...
	public void setLinkText(String newLinkText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINK_TEXT, oldLinkText, linkText));
	}
	...
	public void setSubsection(String newSubsection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__SUBSECTION, oldSubsection, subsection));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION:
				if (linkedRuleSection != null)
					msgs = ((InternalEObject)linkedRuleSection).eInverseRemove(this, regdnaPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, TitledRequirementsSection.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINK_TEXT:
				return getLinkText();
			case regdnaPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__SUBSECTION:
