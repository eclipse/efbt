 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.regdna.model.regdna.impl.RequirementsModuleImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link org.eclipse.efbt.regdna.model.regdna.impl.RequirementsModuleImpl#getAllowedtypes <em>Allowedtypes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementsModuleImpl extends ModuleImpl implements RequirementsModule {
	...
	protected EClass eStaticClass() {
		return regdnaPackage.eINSTANCE.getRequirementsModule();
	}
	...
	public EList<TitledRequirementsSection> getRules() {
		if (rules == null) {
			rules = new EObjectContainmentEList<TitledRequirementsSection>(TitledRequirementsSection.class, this, regdnaPackage.REQUIREMENTS_MODULE__RULES);
		}
		return rules;
	}
	...
	public NotificationChain basicSetAllowedtypes(AllowedTypes newAllowedtypes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, regdnaPackage.REQUIREMENTS_MODULE__ALLOWEDTYPES, oldAllowedtypes, newAllowedtypes);
	...
	public void setAllowedtypes(AllowedTypes newAllowedtypes) {
		if (newAllowedtypes != allowedtypes) {
			...
			if (allowedtypes != null)
				msgs = ((InternalEObject)allowedtypes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - regdnaPackage.REQUIREMENTS_MODULE__ALLOWEDTYPES, null, msgs);
			if (newAllowedtypes != null)
				msgs = ((InternalEObject)newAllowedtypes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - regdnaPackage.REQUIREMENTS_MODULE__ALLOWEDTYPES, null, msgs);
			msgs = basicSetAllowedtypes(newAllowedtypes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, regdnaPackage.REQUIREMENTS_MODULE__ALLOWEDTYPES, newAllowedtypes, newAllowedtypes));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case regdnaPackage.REQUIREMENTS_MODULE__RULES:
				return ((InternalEList<?>)getRules()).basicRemove(otherEnd, msgs);
			case regdnaPackage.REQUIREMENTS_MODULE__ALLOWEDTYPES:
