 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.regdna.model.regdna.impl.RequirementTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementTypeImpl extends MinimalEObjectImpl.Container implements RequirementType {
	...
	protected EClass eStaticClass() {
		return regdnaPackage.eINSTANCE.getRequirementType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, regdnaPackage.REQUIREMENT_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case regdnaPackage.REQUIREMENT_TYPE__NAME:
				return getName();
		}
