 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.regdna.model.regdna.impl.ELPublicOperationImpl#getCalledPrivateOperations <em>Called Private Operations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ELPublicOperationImpl extends ELOperationImpl implements ELPublicOperation {
	...
	protected EClass eStaticClass() {
		return regdnaPackage.eINSTANCE.getELPublicOperation();
	}
	...
	public EList<ELPrivateOperation> getCalledPrivateOperations() {
		if (calledPrivateOperations == null) {
			calledPrivateOperations = new EObjectResolvingEList<ELPrivateOperation>(ELPrivateOperation.class, this, regdnaPackage.EL_PUBLIC_OPERATION__CALLED_PRIVATE_OPERATIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case regdnaPackage.EL_PUBLIC_OPERATION__CALLED_PRIVATE_OPERATIONS:
