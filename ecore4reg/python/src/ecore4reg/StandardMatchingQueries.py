...
class StandardMatchingQueries(object):
    ...
    def query1(self, fileDirectory, inScopeFileDirectory):
        ...
        inputLayerEnums_resource = rset.get_resource(
            URI(fileDirectory + os.sep + "input_layer_enums.ecore"))
        ...
        outputLayerEnums_resource = rset.get_resource(
            URI(fileDirectory + os.sep + "output_layer_enums.ecore"))
        ...
        inputLayerEntities_resource = rset.get_resource(
            URI(fileDirectory + os.sep + "input_layer_entities.ecore"))
        ...
        outputLayerEntities_resource = rset.get_resource(
            URI(fileDirectory + os.sep + "output_layer_entities.ecore"))
    ...
    def createInputLayerToOutputLayerMatches(self, fileDirectory):
        ...
        f2 = open(fileDirectory + os.sep +
                  'uniqueMatches.csv', "a",  encoding='utf-8')
