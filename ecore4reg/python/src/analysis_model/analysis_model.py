"""Definition of meta model 'analysis_model'."""
...
name = 'analysis_model'
nsURI = 'http://www.eclipse.org/efbt/analysis_model'
nsPrefix = 'analysis_model'
...
class VTLGeneratedOutputlayer(EObject, metaclass=MetaEClass):
    ...
    def __init__(self, *, dependant_intermediate_layers=None, VTLForOutputLayerAndIntemedateLayerCombinations=None, outputLayer=None, name=None):
        # if kwargs:
        #    raise AttributeError('unexpected arguments: {}'.format(kwargs))
...
class VTLForSelectionLayer(EObject, metaclass=MetaEClass):
    ...
    def __init__(self, *, selectionLayer=None, outputLayer=None, intermediateLayer=None, name=None):
        # if kwargs:
        #    raise AttributeError('unexpected arguments: {}'.format(kwargs))
...
class VTLForView(EObject, metaclass=MetaEClass):
    ...
    def __init__(self, *, view=None, vtl=None, name=None):
        # if kwargs:
        #    raise AttributeError('unexpected arguments: {}'.format(kwargs))
...
class MappingDefinitionModule(Module):
...
class CubeMappingModule(Module):
...
class MemberMappingModule(Module):
...
class VariableMappingModule(Module):
...
class AxisOrdinateModule(Module):
...
class CellPositionModule(Module):
...
class OrdinateItemModule(Module):
...
class ReportTableModule(Module):
