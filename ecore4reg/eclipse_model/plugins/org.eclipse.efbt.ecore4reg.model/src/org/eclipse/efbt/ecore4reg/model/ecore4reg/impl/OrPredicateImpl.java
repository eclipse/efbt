 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.OrPredicateImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrPredicateImpl extends PredicateImpl implements OrPredicate {
	...
	protected EClass eStaticClass() {
		return Ecore4regPackage.eINSTANCE.getOrPredicate();
	}
	...
	public EList<Predicate> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Predicate>(Predicate.class, this, Ecore4regPackage.OR_PREDICATE__OPERANDS);
		}
		return operands;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ecore4regPackage.OR_PREDICATE__OPERANDS:
