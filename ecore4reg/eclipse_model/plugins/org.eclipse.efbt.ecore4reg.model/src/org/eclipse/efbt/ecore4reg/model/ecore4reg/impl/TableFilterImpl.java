 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.TableFilterImpl#getAttribute1 <em>Attribute1</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.TableFilterImpl#getComparitor <em>Comparitor</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.TableFilterImpl#getMember <em>Member</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.TableFilterImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableFilterImpl extends MinimalEObjectImpl.Container implements TableFilter {
		...
		if (attribute1 != null && attribute1.eIsProxy()) {
			...
			if (attribute1 != oldAttribute1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.TABLE_FILTER__ATTRIBUTE1, oldAttribute1, attribute1));
			}
		}
		return attribute1;
	}
	...
	public void setAttribute1(ELAttribute newAttribute1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TABLE_FILTER__ATTRIBUTE1, oldAttribute1, attribute1));
	}
	...
	public void setComparitor(Comparitor newComparitor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TABLE_FILTER__COMPARITOR, oldComparitor, comparitor));
	}
	...
	public ELEnumLiteral getMember() {
		if (member != null && member.eIsProxy()) {
			...
			if (member != oldMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.TABLE_FILTER__MEMBER, oldMember, member));
			}
		}
		return member;
	}
	...
	public void setMember(ELEnumLiteral newMember) {
		...
		member = newMember;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TABLE_FILTER__MEMBER, oldMember, member));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TABLE_FILTER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ecore4regPackage.TABLE_FILTER__ATTRIBUTE1:
				if (resolve) return getAttribute1();
				return basicGetAttribute1();
			case Ecore4regPackage.TABLE_FILTER__COMPARITOR:
				return getComparitor();
			case Ecore4regPackage.TABLE_FILTER__MEMBER:
				if (resolve) return getMember();
				return basicGetMember();
			case Ecore4regPackage.TABLE_FILTER__VALUE:
				return getValue();
		}
