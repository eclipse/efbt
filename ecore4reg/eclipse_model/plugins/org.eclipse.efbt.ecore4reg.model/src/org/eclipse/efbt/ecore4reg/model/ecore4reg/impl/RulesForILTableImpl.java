 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.RulesForILTableImpl#getRulesForTablePart <em>Rules For Table Part</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.RulesForILTableImpl#getInputLayerTable <em>Input Layer Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RulesForILTableImpl extends MinimalEObjectImpl.Container implements RulesForILTable {
	...
	protected EClass eStaticClass() {
		return Ecore4regPackage.eINSTANCE.getRulesForILTable();
	}
	...
	public EList<RuleForILTablePart> getRulesForTablePart() {
		if (rulesForTablePart == null) {
			rulesForTablePart = new EObjectContainmentEList<RuleForILTablePart>(RuleForILTablePart.class, this, Ecore4regPackage.RULES_FOR_IL_TABLE__RULES_FOR_TABLE_PART);
		}
		...
		if (inputLayerTable != null && inputLayerTable.eIsProxy()) {
			...
			if (inputLayerTable != oldInputLayerTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.RULES_FOR_IL_TABLE__INPUT_LAYER_TABLE, oldInputLayerTable, inputLayerTable));
			}
		}
	...
	public void setInputLayerTable(ELClass newInputLayerTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.RULES_FOR_IL_TABLE__INPUT_LAYER_TABLE, oldInputLayerTable, inputLayerTable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ecore4regPackage.RULES_FOR_IL_TABLE__RULES_FOR_TABLE_PART:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Ecore4regPackage.RULES_FOR_IL_TABLE__INPUT_LAYER_TABLE:
