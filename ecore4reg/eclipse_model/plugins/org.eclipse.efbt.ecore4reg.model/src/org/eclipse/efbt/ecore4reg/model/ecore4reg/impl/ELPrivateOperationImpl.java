 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.ELPrivateOperationImpl#getEParameters <em>EParameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ELPrivateOperationImpl extends ELOperationImpl implements ELPrivateOperation {
	...
	protected EClass eStaticClass() {
		return Ecore4regPackage.eINSTANCE.getELPrivateOperation();
	}
	...
	public EList<ELParameter> getEParameters() {
		if (eParameters == null) {
			eParameters = new EObjectContainmentEList<ELParameter>(ELParameter.class, this, Ecore4regPackage.EL_PRIVATE_OPERATION__EPARAMETERS);
		}
		return eParameters;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ecore4regPackage.EL_PRIVATE_OPERATION__EPARAMETERS:
