 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.model.ecore4reg.impl.OperationTagImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationTagImpl extends TagImpl implements OperationTag {
	...
	protected EClass eStaticClass() {
		return Ecore4regPackage.eINSTANCE.getOperationTag();
	}
		...
		if (operation != null && operation.eIsProxy()) {
			...
			if (operation != oldOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.OPERATION_TAG__OPERATION, oldOperation, operation));
			}
		}
		return operation;
	}
	...
	public void setOperation(ELOperation newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.OPERATION_TAG__OPERATION, oldOperation, operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ecore4regPackage.OPERATION_TAG__OPERATION:
